...
public partial class JUN26 {
    ...
    /// equipmentView
    /// </summary>
    public static EquipmentView equipmentView
    {
        get => HttpData.Get<EquipmentView>("equipmentView")!;
        set => HttpData["equipmentView"] = value;
    }

    /// <summary>
    /// Page class for Equipment
    /// </summary>
    public class EquipmentView : EquipmentViewBase
    {
        // Constructor
        public EquipmentView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public EquipmentView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class EquipmentViewBase : Equipment
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "equipmentView";
        ...
        public EquipmentViewBase()
        {
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["Equipment_ID"] = keys[0];
            } else {
                RecordKeys["Equipment_ID"] = RouteValues.TryGetValue("Equipment_ID", out obj) && obj != null ? UrlDecode(obj) : Get("Equipment_ID"); // DN
            }
        ...
        // Page name
        public string PageName => "EquipmentView";
        ...
        // Constructor
        public EquipmentViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("Equipment_ID", out v) && !Empty(v)) { // DN
                Equipment_ID.QueryValue = UrlDecode(v); // DN
                RecordKeys["Equipment_ID"] = Equipment_ID.QueryValue;
            } else if (Get("Equipment_ID", out sv)) {
                Equipment_ID.QueryValue = sv.ToString();
                RecordKeys["Equipment_ID"] = Equipment_ID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                Equipment_ID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["Equipment_ID"] = Equipment_ID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "EquipmentList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("EquipmentList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fEquipmentview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
