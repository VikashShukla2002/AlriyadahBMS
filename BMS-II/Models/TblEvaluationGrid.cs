...
public partial class JUN26 {
    ...
    /// tblEvaluationGrid
    /// </summary>
    public static TblEvaluationGrid tblEvaluationGrid
    {
        get => HttpData.Get<TblEvaluationGrid>("tblEvaluationGrid")!;
        set => HttpData["tblEvaluationGrid"] = value;
    }

    /// <summary>
    /// Page class for tblEvaluation
    /// </summary>
    public class TblEvaluationGrid : TblEvaluationGridBase
    {
        // Constructor
        public TblEvaluationGrid() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class TblEvaluationGridBase : TblEvaluation
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblEvaluationGrid";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "ftblEvaluationgrid";
        ...
        // Page name
        public string PageName => "TblEvaluationGrid";
        ...
        public async Task SetupRow()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(tblEvaluationGrid.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(tblEvaluationGrid.RowCount) + "_tblEvaluation");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(tblEvaluationGrid.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && tblEvaluationGrid.RowType == RowType.Add || IsEdit && tblEvaluationGrid.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadDefaultValues() {
            ...
            Assigned_int_Package_Id.DefaultValue = Assigned_int_Package_Id.GetDefault(); // DN
            Assigned_int_Package_Id.OldValue = Assigned_int_Package_Id.DefaultValue;
            Scores_S1.DefaultValue = Scores_S1.GetDefault(); // DN
            Scores_S1.OldValue = Scores_S1.DefaultValue;
