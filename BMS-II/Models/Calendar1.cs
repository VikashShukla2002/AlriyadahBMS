...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static Calendar1 calendar1
    {
        get => HttpData.Resolve<Calendar1>("Calendar1");
        set => HttpData["Calendar1"] = value;
    }

    /// <summary>
    /// Table class for Calendar1
    /// </summary>
    public class Calendar1 : DbTable, IQueryFactory
    {
        ...
        public Calendar1()
        {
            ...
            Name = "Calendar1";
            Type = "REPORT";
            UpdateTable = "Calendar"; // Calendar update table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new (this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar1", "Id", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            Fields.Add("Id", Id);
            ...
            _Title = new (this, "x__Title", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar1", "_Title", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            ...
            Start = new (this, "x_Start", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar1", "Start", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            ...
            End = new (this, "x_End", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar1", "End", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            Fields.Add("End", End);
            ...
            AllDay = new (this, "x_AllDay", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar1", "AllDay", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            AllDay.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(AllDay, "Calendar1", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(AllDay, "Calendar1", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(AllDay, "Calendar1", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Description = new (this, "x_Description", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar1", "Description", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            ...
            _Url = new (this, "x__Url", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar1", "_Url", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            Fields.Add("Url", _Url);
            ...
            ClassNames = new (this, "x_ClassNames", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar1", "ClassNames", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            ...
            Display = new (this, "x_Display", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar1", "Display", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            ...
            BackgroundColor = new (this, "x_BackgroundColor", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar1", "BackgroundColor", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar1", "str_Username", "CustomMsg"),
                SourceTableVar = "Calendar",
                IsUpload = false
            };
