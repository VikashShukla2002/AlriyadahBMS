...
public partial class JUN26 {
    ...
    /// auditTrailView
    /// </summary>
    public static AuditTrailView auditTrailView
    {
        get => HttpData.Get<AuditTrailView>("auditTrailView")!;
        set => HttpData["auditTrailView"] = value;
    }

    /// <summary>
    /// Page class for AuditTrail
    /// </summary>
    public class AuditTrailView : AuditTrailViewBase
    {
        // Constructor
        public AuditTrailView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AuditTrailView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AuditTrailViewBase : AuditTrail
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "auditTrailView";
        ...
        // Page name
        public string PageName => "AuditTrailView";
        ...
        // Constructor
        public AuditTrailViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fAuditTrailview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
