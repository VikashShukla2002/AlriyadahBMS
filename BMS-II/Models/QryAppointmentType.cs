...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static QryAppointmentType qryAppointmentType
    {
        get => HttpData.Resolve<QryAppointmentType>("qryAppointmentType");
        set => HttpData["qryAppointmentType"] = value;
    }

    /// <summary>
    /// Table class for qryAppointmentType
    /// </summary>
    public class QryAppointmentType : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public QryAppointmentType()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryAppointmentType";
            Name = "qryAppointmentType";
            Type = "VIEW";
            UpdateTable = "dbo.qryAppointmentType"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            int_PackageID = new (this, "x_int_PackageID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryAppointmentType", "int_PackageID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Package_Name = new (this, "x_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryAppointmentType", "Package_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_AppType = new (this, "x_int_AppType", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryAppointmentType", "int_AppType", "CustomMsg"),
                IsUpload = false
            };
            ...
            Service_Description = new (this, "x_Service_Description", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryAppointmentType", "Service_Description", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryAppointmentType", "Price", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryAppointmentType";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "QryAppointmentTypeView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryAppointmentTypeEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryAppointmentTypeAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryAppointmentTypeView",
                Config.ApiAddAction => "QryAppointmentTypeAdd",
                Config.ApiEditAction => "QryAppointmentTypeEdit",
                Config.ApiDeleteAction => "QryAppointmentTypeDelete",
                Config.ApiListAction => "QryAppointmentTypeList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryAppointmentTypeList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryAppointmentTypeView", parm);
            else
                url = KeyUrl("QryAppointmentTypeView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryAppointmentTypeAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryAppointmentTypeAdd?" + parm;
            else
                url = "QryAppointmentTypeAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryAppointmentTypeEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryAppointmentTypeList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryAppointmentTypeAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryAppointmentTypeList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryAppointmentTypeDelete")); // DN
        ...
        {
            string pageName = "QryAppointmentTypeList";
