...
public partial class JUN26 {
    ...
    /// tblStaffAdd
    /// </summary>
    public static TblStaffAdd tblStaffAdd
    {
        get => HttpData.Get<TblStaffAdd>("tblStaffAdd")!;
        set => HttpData["tblStaffAdd"] = value;
    }

    /// <summary>
    /// Page class for tblStaff
    /// </summary>
    public class TblStaffAdd : TblStaffAddBase
    {
        // Constructor
        public TblStaffAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblStaffAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TblStaffAddBase : TblStaff
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblStaffAdd";
        ...
        // Page name
        public string PageName => "TblStaffAdd";
        ...
        // Constructor
        public TblStaffAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("TblStaffList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        string returnUrl = "";
                        returnUrl = "TblStaffList";
                        if (GetPageName(returnUrl) == "TblStaffList")
                            returnUrl = AddMasterUrl(ListUrl); // List page, return to List page with correct master key if necessary
                        else if (GetPageName(returnUrl) == "TblStaffView")
        ...
        protected void LoadDefaultValues() {
            User_Role.DefaultValue = User_Role.GetDefault(); // DN
            User_Role.OldValue = User_Role.DefaultValue;
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                User_Role.CurrentValue = User_Role.GetDefault();
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // str_Address
                str_Address.SetDbValue(rsnew, str_Address.CurrentValue);
                ...
                // str_Home_Phone
                str_Home_Phone.SetDbValue(rsnew, str_Home_Phone.CurrentValue);
                ...
                // User_Role
                User_Role.SetDbValue(rsnew, User_Role.CurrentValue);

                // UserlevelID
                UserlevelID.SetDbValue(rsnew, UserlevelID.CurrentValue);

                // Activated
                Activated.SetDbValue(rsnew, ConvertToBool(Activated.CurrentValue));

                // Supervisor_Username
                Supervisor_Username.SetDbValue(rsnew, Supervisor_Username.CurrentValue);

                // str_Staff_Username
                str_Staff_Username.SetDbValue(rsnew, str_Staff_Username.CurrentValue);
                ...
                // int_Nationality
                int_Nationality.SetDbValue(rsnew, int_Nationality.CurrentValue);
            ...
            if (insertRow) {
                try {
                    ...
                    rsnew["int_Staff_Id"] = int_Staff_Id.CurrentValue!;
                } catch (Exception e) {
                    if (Config.Debug)
                        throw;
                    FailureMessage = e.Message;
