...
public partial class JUN26 {
    /// <summary>
    /// qryLmsStudentEnrolment
    /// </summary>
    [MaybeNull]
    public static QryLmsStudentEnrolment qryLmsStudentEnrolment
    {
        get => HttpData.Resolve<QryLmsStudentEnrolment>("qryLMS_Student_Enrolment");
        set => HttpData["qryLMS_Student_Enrolment"] = value;
    }

    /// <summary>
    /// Table class for qryLMS_Student_Enrolment
    /// </summary>
    public class QryLmsStudentEnrolment : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public QryLmsStudentEnrolment()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryLMS_Student_Enrolment";
            Name = "qryLMS_Student_Enrolment";
            Type = "VIEW";
            UpdateTable = "dbo.qryLMS_Student_Enrolment"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            status = new (this, "x_status", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "status", "CustomMsg"),
                IsUpload = false
            };
            ...
            enrol = new (this, "x_enrol", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "enrol", "CustomMsg"),
                IsUpload = false
            };
            ...
            courseid = new (this, "x_courseid", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "courseid", "CustomMsg"),
                IsUpload = false
            };
            ...
            fullname = new (this, "x_fullname", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "fullname", "CustomMsg"),
                IsUpload = false
            };
            ...
            idnumber = new (this, "x_idnumber", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "idnumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            _username = new (this, "x__username", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "_username", "CustomMsg"),
                IsUpload = false
            };
            ...
            _email = new (this, "x__email", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "_email", "CustomMsg"),
                IsUpload = false
            };
            ...
            groupid = new (this, "x_groupid", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "groupid", "CustomMsg"),
                IsUpload = false
            };
            ...
            _name = new (this, "x__name", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "_name", "CustomMsg"),
                IsUpload = false
            };
            ...
            Gender = new (this, "x_Gender", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryLMS_Student_Enrolment", "Gender", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryLMS_Student_Enrolment";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "QryLmsStudentEnrolmentList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "QryLmsStudentEnrolmentView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryLmsStudentEnrolmentEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryLmsStudentEnrolmentAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryLmsStudentEnrolmentView",
                Config.ApiAddAction => "QryLmsStudentEnrolmentAdd",
                Config.ApiEditAction => "QryLmsStudentEnrolmentEdit",
                Config.ApiDeleteAction => "QryLmsStudentEnrolmentDelete",
                Config.ApiListAction => "QryLmsStudentEnrolmentList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryLmsStudentEnrolmentList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryLmsStudentEnrolmentView", parm);
            else
                url = KeyUrl("QryLmsStudentEnrolmentView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryLmsStudentEnrolmentAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryLmsStudentEnrolmentAdd?" + parm;
            else
                url = "QryLmsStudentEnrolmentAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryLmsStudentEnrolmentEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryLmsStudentEnrolmentList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryLmsStudentEnrolmentAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryLmsStudentEnrolmentList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryLmsStudentEnrolmentDelete")); // DN
        ...
        {
            string pageName = "QryLmsStudentEnrolmentList";
