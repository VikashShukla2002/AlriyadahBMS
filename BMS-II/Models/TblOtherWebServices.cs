...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static TblOtherWebServices tblOtherWebServices
    {
        get => HttpData.Resolve<TblOtherWebServices>("tblOtherWebServices");
        set => HttpData["tblOtherWebServices"] = value;
    }

    /// <summary>
    /// Table class for tblOtherWebServices
    /// </summary>
    public class TblOtherWebServices : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> OTWEB_ID;

        public readonly DbField<SqlDbType> Website;

        public readonly DbField<SqlDbType> Link;
        ...
        // Constructor
        public TblOtherWebServices()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "tblOtherWebServices";
            Name = "tblOtherWebServices";
            Type = "TABLE";
            UpdateTable = "dbo.tblOtherWebServices"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // OTWEB_ID
            OTWEB_ID = new (this, "x_OTWEB_ID", 3, SqlDbType.Int) {
                Name = "OTWEB_ID",
                Expression = "[OTWEB_ID]",
                BasicSearchExpression = "CAST([OTWEB_ID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[OTWEB_ID]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("tblOtherWebServices", "OTWEB_ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("OTWEB_ID", OTWEB_ID);

            // Website
            Website = new (this, "x_Website", 203, SqlDbType.NText) {
                Name = "Website",
                Expression = "[Website]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Website]",
                DateTimeFormat = -1,
                VirtualExpression = "[Website]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("tblOtherWebServices", "Website", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Website", Website);

            // Link
            Link = new (this, "x_Link", 200, SqlDbType.VarChar) {
                Name = "Link",
                Expression = "[Link]",
                BasicSearchExpression = "[Link]",
                DateTimeFormat = -1,
                VirtualExpression = "[Link]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblOtherWebServices", "Link", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_username = new (this, "x_str_username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblOtherWebServices", "str_username", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_password = new (this, "x_str_password", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblOtherWebServices", "str_password", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.tblOtherWebServices";
            set => _sqlFrom = value;
        }
        ...
        public async Task<int> InsertAsync(object data)
        {
            ...
            try {
                ...
                OTWEB_ID.SetDbValue(lastInsertedId);
                result = 1;
            } catch (Exception e) {
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                OTWEB_ID.DbValue = row["OTWEB_ID"]; // Set DB value only
                Website.DbValue = row["Website"]; // Set DB value only
                Link.DbValue = row["Link"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[OTWEB_ID] = @OTWEB_ID@";
        ...
        public string GetRecordFilter(Dictionary<string, object>? row = null, bool current = false)
        {
            ...
            val = row?.TryGetValue("OTWEB_ID", out result) ?? false
                ? result
                : !Empty(OTWEB_ID.OldValue) && !current ? OTWEB_ID.OldValue : OTWEB_ID.CurrentValue;
            if (!IsNumeric(val))
                return "0=1"; // Invalid key
            if (val == null)
                return "0=1"; // Invalid key
            keyFilter = keyFilter.Replace("@OTWEB_ID@", AdjustSql(val, DbId)); // Replace key value
            return keyFilter;
        }
        ...
        public Dictionary<string, object>? GetRowFilterAsDictionary(IDictionary<string, object>? row = null)
        {
            ...
            val = row?.TryGetValue("OTWEB_ID", out result) ?? false
                ? result
                : !Empty(OTWEB_ID.OldValue) ? OTWEB_ID.OldValue : OTWEB_ID.CurrentValue;
            if (!IsNumeric(val))
                return null; // Invalid key
            if (Empty(val))
                return null; // Invalid key
            keyFilter.Add("OTWEB_ID", val); // Add key value
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "TblOtherWebServicesList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "TblOtherWebServicesView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TblOtherWebServicesEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TblOtherWebServicesAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TblOtherWebServicesView",
                Config.ApiAddAction => "TblOtherWebServicesAdd",
                Config.ApiEditAction => "TblOtherWebServicesEdit",
                Config.ApiDeleteAction => "TblOtherWebServicesDelete",
                Config.ApiListAction => "TblOtherWebServicesList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TblOtherWebServicesList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TblOtherWebServicesView", parm);
            else
                url = KeyUrl("TblOtherWebServicesView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TblOtherWebServicesAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TblOtherWebServicesAdd?" + parm;
            else
                url = "TblOtherWebServicesAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TblOtherWebServicesEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TblOtherWebServicesList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TblOtherWebServicesAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TblOtherWebServicesList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("TblOtherWebServicesDelete")); // DN
        ...
        {
            string json = "";
            json += "\"OTWEB_ID\":" + ConvertToJson(OTWEB_ID.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        public string KeyUrl(string url, string parm = "") { // DN
            if (!IsNull(OTWEB_ID.CurrentValue)) {
                url += "/" + OTWEB_ID.CurrentValue;
            } else {
        ...
        public string GetKey(bool current = false)
        {
            ...
            string val;
            val = current ? ConvertToString(OTWEB_ID.CurrentValue) ?? "" : ConvertToString(OTWEB_ID.OldValue) ?? "";
            if (Empty(val))
                return String.Empty;
            keys.Add(val);
        ...
        public string GetKey(IDictionary<string, object> row)
        {
            List<string> keys = new ();
            object? val = null, result;
            val = row?.TryGetValue("OTWEB_ID", out result) ?? false ? ConvertToString(result) : null;
            if (Empty(val))
        ...
        public void SetKey(string key, bool current = false)
        {
            ...
            if (keys.Length == 1) {
                if (current) {
                    OTWEB_ID.CurrentValue = keys[0];
                } else {
                    OTWEB_ID.OldValue = keys[0];
                }
            }
        }
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("OTWEB_ID", out object? v0)) { // OTWEB_ID // DN
                    key = UrlDecode(v0); // DN
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    OTWEB_ID.CurrentValue = keys;
                else
                    OTWEB_ID.OldValue = keys;
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            OTWEB_ID.SetDbValue(dr["OTWEB_ID"]);
            Website.SetDbValue(dr["Website"]);
            Link.SetDbValue(dr["Link"]);
        ...
        {
            string pageName = "TblOtherWebServicesList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // OTWEB_ID
            OTWEB_ID.SetupEditAttributes();
            OTWEB_ID.EditValue = OTWEB_ID.CurrentValue;
            OTWEB_ID.ViewCustomAttributes = "";
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(Website);
                        doc.ExportCaption(str_username);
                        doc.ExportCaption(str_password);
                    } else {
                        doc.ExportCaption(OTWEB_ID);
                        doc.ExportCaption(Link);
                        doc.ExportCaption(str_username);
                        doc.ExportCaption(str_password);
                    }
                    doc.EndExportRow();
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(Website);
                            await doc.ExportField(str_username);
                            await doc.ExportField(str_password);
                        } else {
                            await doc.ExportField(OTWEB_ID);
                            await doc.ExportField(Link);
                            await doc.ExportField(str_username);
                            await doc.ExportField(str_password);
                        }
