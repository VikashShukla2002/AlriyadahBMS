...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static LmsCourseDetails lmsCourseDetails
    {
        get => HttpData.Resolve<LmsCourseDetails>("LMS_Course_Details");
        set => HttpData["LMS_Course_Details"] = value;
    }

    /// <summary>
    /// Table class for LMS_Course_Details
    /// </summary>
    public class LmsCourseDetails : DbTable, IQueryFactory
    {
        ...
        public LmsCourseDetails()
        {
            ...
            TableVar = "LMS_Course_Details";
            Name = "LMS_Course_Details";
            Type = "VIEW";
            UpdateTable = "dbo.LMS_Course_Details"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            category = new (this, "x_category", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "category", "CustomMsg"),
                IsUpload = false
            };
            ...
            sortorder = new (this, "x_sortorder", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "sortorder", "CustomMsg"),
                IsUpload = false
            };
            ...
            fullname = new (this, "x_fullname", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "fullname", "CustomMsg"),
                IsUpload = false
            };
            ...
            shortname = new (this, "x_shortname", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "shortname", "CustomMsg"),
                IsUpload = false
            };
            ...
            idnumber = new (this, "x_idnumber", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "idnumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            summaryformat = new (this, "x_summaryformat", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "summaryformat", "CustomMsg"),
                IsUpload = false
            };
            ...
            format = new (this, "x_format", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "format", "CustomMsg"),
                IsUpload = false
            };
            ...
            showgrades = new (this, "x_showgrades", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "showgrades", "CustomMsg"),
                IsUpload = false
            };
            ...
            newsitems = new (this, "x_newsitems", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "newsitems", "CustomMsg"),
                IsUpload = false
            };
            ...
            startdate = new (this, "x_startdate", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "startdate", "CustomMsg"),
                IsUpload = false
            };
            ...
            enddate = new (this, "x_enddate", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "enddate", "CustomMsg"),
                IsUpload = false
            };
            ...
            _lang = new (this, "x__lang", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Details", "_lang", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.LMS_Course_Details";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "LmsCourseDetailsView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "LmsCourseDetailsEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "LmsCourseDetailsAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "LmsCourseDetailsView",
                Config.ApiAddAction => "LmsCourseDetailsAdd",
                Config.ApiEditAction => "LmsCourseDetailsEdit",
                Config.ApiDeleteAction => "LmsCourseDetailsDelete",
                Config.ApiListAction => "LmsCourseDetailsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "LmsCourseDetailsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("LmsCourseDetailsView", parm);
            else
                url = KeyUrl("LmsCourseDetailsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "LmsCourseDetailsAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "LmsCourseDetailsAdd?" + parm;
            else
                url = "LmsCourseDetailsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("LmsCourseDetailsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsCourseDetailsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("LmsCourseDetailsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsCourseDetailsList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("LmsCourseDetailsDelete")); // DN
        ...
        {
            string pageName = "LmsCourseDetailsList";
