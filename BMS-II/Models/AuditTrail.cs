...
public partial class JUN26 {
    ...
    {
        get => HttpData.Resolve<AuditTrail>("AuditTrail");
        set => HttpData["AuditTrail"] = value;
    }

    /// <summary>
    /// Table class for AuditTrail
    /// </summary>
    public class AuditTrail : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> _DateTime;

        public readonly DbField<SqlDbType> Script;

        public readonly DbField<SqlDbType> _User;

        public readonly DbField<SqlDbType> _Action;

        public readonly DbField<SqlDbType> _Table;

        public readonly DbField<SqlDbType> _Field;

        public readonly DbField<SqlDbType> KeyValue;

        public readonly DbField<SqlDbType> OldValue;

        public readonly DbField<SqlDbType> NewValue;
        ...
        public AuditTrail()
        {
            ...
            Name = "AuditTrail";
            Type = "TABLE";
            UpdateTable = "dbo.AuditTrail"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // DateTime
            _DateTime = new (this, "x__DateTime", 135, SqlDbType.DateTime) {
                Name = "DateTime",
                Expression = "[DateTime]",
                BasicSearchExpression = CastDateFieldForLike("[DateTime]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[DateTime]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("AuditTrail", "_DateTime", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("DateTime", _DateTime);

            // Script
            Script = new (this, "x_Script", 202, SqlDbType.NVarChar) {
                Name = "Script",
                Expression = "[Script]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Script]",
                DateTimeFormat = -1,
                VirtualExpression = "[Script]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("AuditTrail", "Script", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Script", Script);

            // User
            _User = new (this, "x__User", 202, SqlDbType.NVarChar) {
                Name = "User",
                Expression = "[User]",
                UseBasicSearch = true,
                BasicSearchExpression = "[User]",
                DateTimeFormat = -1,
                VirtualExpression = "[User]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("AuditTrail", "_User", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("User", _User);

            // Action
            _Action = new (this, "x__Action", 202, SqlDbType.NVarChar) {
                Name = "Action",
                Expression = "[Action]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Action]",
                DateTimeFormat = -1,
                VirtualExpression = "[Action]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("AuditTrail", "_Action", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Action", _Action);

            // Table
            _Table = new (this, "x__Table", 202, SqlDbType.NVarChar) {
                Name = "Table",
                Expression = "[Table]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Table]",
                DateTimeFormat = -1,
                VirtualExpression = "[Table]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("AuditTrail", "_Table", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Table", _Table);

            // Field
            _Field = new (this, "x__Field", 202, SqlDbType.NVarChar) {
                Name = "Field",
                Expression = "[Field]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Field]",
                DateTimeFormat = -1,
                VirtualExpression = "[Field]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("AuditTrail", "_Field", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Field", _Field);
            ...
            KeyValue = new (this, "x_KeyValue", 203, SqlDbType.NText) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("AuditTrail", "KeyValue", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("KeyValue", KeyValue);
            ...
            OldValue = new (this, "x_OldValue", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("AuditTrail", "OldValue", "CustomMsg"),
                IsUpload = false
            };
            ...
            NewValue = new (this, "x_NewValue", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("AuditTrail", "NewValue", "CustomMsg"),
                IsUpload = false
            };
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                _DateTime.DbValue = row["DateTime"]; // Set DB value only
                Script.DbValue = row["Script"]; // Set DB value only
                _User.DbValue = row["User"]; // Set DB value only
                _Action.DbValue = row["Action"]; // Set DB value only
                _Table.DbValue = row["Table"]; // Set DB value only
                _Field.DbValue = row["Field"]; // Set DB value only
                KeyValue.DbValue = row["KeyValue"]; // Set DB value only
                OldValue.DbValue = row["OldValue"]; // Set DB value only
                NewValue.DbValue = row["NewValue"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "AuditTrailView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "AuditTrailEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "AuditTrailAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "AuditTrailView",
                Config.ApiAddAction => "AuditTrailAdd",
                Config.ApiEditAction => "AuditTrailEdit",
                Config.ApiDeleteAction => "AuditTrailDelete",
                Config.ApiListAction => "AuditTrailList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "AuditTrailList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("AuditTrailView", parm);
            else
                url = KeyUrl("AuditTrailView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "AuditTrailAdd";
        ...
        {
            string url = "";
            url = KeyUrl("AuditTrailEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("AuditTrailList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("AuditTrailAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("AuditTrailList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("AuditTrailDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            Id.SetDbValue(dr["Id"]);
            _DateTime.SetDbValue(dr["DateTime"]);
            Script.SetDbValue(dr["Script"]);
            _User.SetDbValue(dr["User"]);
            _Action.SetDbValue(dr["Action"]);
            _Table.SetDbValue(dr["Table"]);
            _Field.SetDbValue(dr["Field"]);
            KeyValue.SetDbValue(dr["KeyValue"]);
            OldValue.SetDbValue(dr["OldValue"]);
            NewValue.SetDbValue(dr["NewValue"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "AuditTrailList";
