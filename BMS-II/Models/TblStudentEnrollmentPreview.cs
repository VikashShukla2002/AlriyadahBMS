...
public partial class JUN26 {
    /// <summary>
    /// tblStudentEnrollmentPreview
    /// </summary>
    public static TblStudentEnrollmentPreview tblStudentEnrollmentPreview
    {
        get => HttpData.Get<TblStudentEnrollmentPreview>("tblStudentEnrollmentPreview")!;
        set => HttpData["tblStudentEnrollmentPreview"] = value;
    }

    /// <summary>
    /// Page class for tblStudentEnrollment
    /// </summary>
    public class TblStudentEnrollmentPreview : TblStudentEnrollmentPreviewBase
    {
        // Constructor
        public TblStudentEnrollmentPreview(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblStudentEnrollmentPreview() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TblStudentEnrollmentPreviewBase : TblStudentEnrollment
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblStudentEnrollmentPreview";
        ...
        // Constructor
        public TblStudentEnrollmentPreviewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TblStudentEnrollmentPreview";
        ...
        // Constructor
        public TblStudentEnrollmentPreviewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void HideFieldsForAddEdit() {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                tblStudentEnrollmentPreview?.PageRender();
            }
                return PageResult();
            }
