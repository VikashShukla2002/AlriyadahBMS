...
public partial class JUN26 {
    /// <summary>
    /// rptqryInvoiceItemPricesList
    /// </summary>
    public static RptqryInvoiceItemPricesList rptqryInvoiceItemPricesList
    {
        get => HttpData.Get<RptqryInvoiceItemPricesList>("rptqryInvoiceItemPricesList")!;
        set => HttpData["rptqryInvoiceItemPricesList"] = value;
    }

    /// <summary>
    /// Page class for rptqryInvoiceItemPrices
    /// </summary>
    public class RptqryInvoiceItemPricesList : RptqryInvoiceItemPricesListBase
    {
        // Constructor
        public RptqryInvoiceItemPricesList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RptqryInvoiceItemPricesList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RptqryInvoiceItemPricesListBase : RptqryInvoiceItemPrices
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "rptqryInvoiceItemPrices";

        // Page object name
        public string PageObjName = "rptqryInvoiceItemPricesList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "frptqryInvoiceItemPriceslist";
        ...
        // Constructor
        public RptqryInvoiceItemPricesListBase()
        {
            // CSS class name as context
            TableVar = "rptqryInvoiceItemPrices";
            ...
            // Table object (rptqryInvoiceItemPrices)
            if (rptqryInvoiceItemPrices == null || rptqryInvoiceItemPrices is RptqryInvoiceItemPrices)
                rptqryInvoiceItemPrices = this;

            // Initialize URLs
            AddUrl = "RptqryInvoiceItemPricesAdd";
            ...
            MultiDeleteUrl = "RptqryInvoiceItemPricesDelete";
            MultiUpdateUrl = "RptqryInvoiceItemPricesUpdate";
        ...
        // Page name
        public string PageName => "RptqryInvoiceItemPricesList";
        ...
        // Constructor
        public RptqryInvoiceItemPricesListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "RptqryInvoiceItemPricesView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "frptqryInvoiceItemPricesgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                rptqryInvoiceItemPricesList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            if (Config.SearchFilterOption == "Server")
                savedFilterList = await Profile.GetSearchFilters(CurrentUserName(), "frptqryInvoiceItemPricessrch");
        ...
        protected async Task<object?> ProcessFilterList() {
            if (Post("ajax") == "savefilters") {
                ...
                await Profile.SetSearchFilters(CurrentUserName(), "frptqryInvoiceItemPricessrch", filters);
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"frptqryInvoiceItemPriceslist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"frptqryInvoiceItemPriceslist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<div class=\"btn-group\"><div class=\"form-check\"><input type=\"checkbox\" name=\"key\" id=\"key\" class=\"form-check-input\" data-ew-action=\"select-all-keys\" form=\"frptqryInvoiceItemPriceslist\"><label class=\"form-check-label\" for=\"key\">" + Language.Phrase("SelectAll") + "</label></div></div>";
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"frptqryInvoiceItemPricessrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"frptqryInvoiceItemPricessrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"frptqryInvoiceItemPriceslist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_rptqryInvoiceItemPrices");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(rptqryInvoiceItemPricesList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(rptqryInvoiceItemPricesList.RowCount) + "_rptqryInvoiceItemPrices");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(rptqryInvoiceItemPricesList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && rptqryInvoiceItemPricesList.RowType == RowType.Add || IsEdit && rptqryInvoiceItemPricesList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" form=\"frptqryInvoiceItemPriceslist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToExcel") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToExcel", true)) + "\">" + Language.Phrase("ExportToExcel") + "</a>";
            } else if (SameText(type, "word")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" form=\"frptqryInvoiceItemPriceslist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToWord") + "</button>";
                else
                    return "<a href=\"" + exportUrl + "\" class=\"btn btn-default ew-export-link ew-word\" title=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToWord", true)) + "\">" + Language.Phrase("ExportToWord") + "</a>";
            } else if (SameText(type, "pdf")) {
                if (custom)
                    return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" data-caption=\"" + HtmlEncode(Language.Phrase("ExportToPdf", true)) + "\" form=\"frptqryInvoiceItemPriceslist\" data-url=\"" + exportUrl + "\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" + Language.Phrase("ExportToPDF") + "</button>";
                else
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"frptqryInvoiceItemPricessrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
