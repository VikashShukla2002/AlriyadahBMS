...
public partial class JUN26 {
    /// <summary>
    /// dshbdAssessmentv1List
    /// </summary>
    public static DshbdAssessmentv1List dshbdAssessmentv1List
    {
        get => HttpData.Get<DshbdAssessmentv1List>("dshbdAssessmentv1List")!;
        set => HttpData["dshbdAssessmentv1List"] = value;
    }

    /// <summary>
    /// Page class for dshbdAssessmentv1
    /// </summary>
    public class DshbdAssessmentv1List : DshbdAssessmentv1ListBase
    {
        // Constructor
        public DshbdAssessmentv1List(Controller controller) : base(controller)
        {
        }

        // Constructor
        public DshbdAssessmentv1List() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class DshbdAssessmentv1ListBase : DshbdAssessmentv1
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "dshbdAssessmentv1";

        // Page object name
        public string PageObjName = "dshbdAssessmentv1List";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fdshbdAssessmentv1list";
        ...
        // Constructor
        public DshbdAssessmentv1ListBase()
        {
            // CSS class name as context
            TableVar = "dshbdAssessmentv1";
            ...
            // Table object (dshbdAssessmentv1)
            if (dshbdAssessmentv1 == null || dshbdAssessmentv1 is DshbdAssessmentv1)
                dshbdAssessmentv1 = this;

            // Initialize URLs
            AddUrl = "DshbdAssessmentv1Add";
            ...
            MultiDeleteUrl = "DshbdAssessmentv1Delete";
            MultiUpdateUrl = "DshbdAssessmentv1Update";
        ...
        // Page name
        public string PageName => "DshbdAssessmentv1List";
        ...
        // Constructor
        public DshbdAssessmentv1ListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "DshbdAssessmentv1View" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fdshbdAssessmentv1grid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                dshbdAssessmentv1List?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            if (Config.SearchFilterOption == "Server")
                savedFilterList = await Profile.GetSearchFilters(CurrentUserName(), "fdshbdAssessmentv1srch");
            ...
            filters.Merge(JObject.Parse(AssessmentDone.AdvancedSearch.ToJson())); // Field Assessment Done
            ...
            filters.Merge(JObject.Parse(DLType.AdvancedSearch.ToJson())); // Field DL Type
            filters.Merge(JObject.Parse(AssessmentScore.AdvancedSearch.ToJson())); // Field Assessment Score
        ...
        protected async Task<object?> ProcessFilterList() {
            if (Post("ajax") == "savefilters") {
                ...
                await Profile.SetSearchFilters(CurrentUserName(), "fdshbdAssessmentv1srch", filters);
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Assessment Done
            if (filter?.TryGetValue("x_AssessmentDone", out sv) ?? false) {
                AssessmentDone.AdvancedSearch.SearchValue = sv;
                AssessmentDone.AdvancedSearch.SearchOperator = filter["z_AssessmentDone"];
                AssessmentDone.AdvancedSearch.SearchCondition = filter["v_AssessmentDone"];
                AssessmentDone.AdvancedSearch.SearchValue2 = filter["y_AssessmentDone"];
                AssessmentDone.AdvancedSearch.SearchOperator2 = filter["w_AssessmentDone"];
                AssessmentDone.AdvancedSearch.Save();
            }
            ...
            // Field DL Type
            if (filter?.TryGetValue("x_DLType", out sv) ?? false) {
                DLType.AdvancedSearch.SearchValue = sv;
                DLType.AdvancedSearch.SearchOperator = filter["z_DLType"];
                DLType.AdvancedSearch.SearchCondition = filter["v_DLType"];
                DLType.AdvancedSearch.SearchValue2 = filter["y_DLType"];
                DLType.AdvancedSearch.SearchOperator2 = filter["w_DLType"];
                DLType.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(AssessmentDone);
            searchFlds.Add(str_Username);
            searchFlds.Add(AbsherApptNbr);
            searchFlds.Add(DLType);
            searchFlds.Add(AssessmentScore);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(AssessmentDone, ctrl); // Assessment Done
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fdshbdAssessmentv1list\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fdshbdAssessmentv1list\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<div class=\"btn-group\"><div class=\"form-check\"><input type=\"checkbox\" name=\"key\" id=\"key\" class=\"form-check-input\" data-ew-action=\"select-all-keys\" form=\"fdshbdAssessmentv1list\"><label class=\"form-check-label\" for=\"key\">" + Language.Phrase("SelectAll") + "</label></div></div>";
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fdshbdAssessmentv1srch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fdshbdAssessmentv1srch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fdshbdAssessmentv1list\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_dshbdAssessmentv1");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(dshbdAssessmentv1List.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(dshbdAssessmentv1List.RowCount) + "_dshbdAssessmentv1");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(dshbdAssessmentv1List.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && dshbdAssessmentv1List.RowType == RowType.Add || IsEdit && dshbdAssessmentv1List.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            AssessmentDone.SetDbValue(row["Assessment Done"]);
            str_Username.SetDbValue(row["str_Username"]);
            AbsherApptNbr.SetDbValue(row["AbsherApptNbr"]);
            DLType.SetDbValue(row["DL Type"]);
            AssessmentScore.SetDbValue(row["Assessment Score"]);
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Assessment Done", AssessmentDone.DefaultValue ?? DbNullValue); // DN
            row.Add("str_Username", str_Username.DefaultValue ?? DbNullValue); // DN
            row.Add("AbsherApptNbr", AbsherApptNbr.DefaultValue ?? DbNullValue); // DN
            row.Add("DL Type", DLType.DefaultValue ?? DbNullValue); // DN
            row.Add("Assessment Score", AssessmentScore.DefaultValue ?? DbNullValue); // DN
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Assessment Done
                AssessmentDone.ViewValue = ConvertToString(AssessmentDone.CurrentValue); // DN
                AssessmentDone.ViewCustomAttributes = "";
                ...
                // DL Type
                DLType.ViewValue = ConvertToString(DLType.CurrentValue); // DN
                ...
                // Assessment Done
                AssessmentDone.HrefValue = "";
                AssessmentDone.TooltipValue = "";
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fdshbdAssessmentv1srch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
