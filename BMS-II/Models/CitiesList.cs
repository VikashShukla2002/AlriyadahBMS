...
public partial class JUN26 {
    ...
    /// citiesList
    /// </summary>
    public static CitiesList citiesList
    {
        get => HttpData.Get<CitiesList>("citiesList")!;
        set => HttpData["citiesList"] = value;
    }

    /// <summary>
    /// Page class for Cities
    /// </summary>
    public class CitiesList : CitiesListBase
    {
        // Constructor
        public CitiesList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CitiesList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CitiesListBase : Cities
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "Cities";

        // Page object name
        public string PageObjName = "citiesList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fCitieslist";
        ...
        public CitiesListBase()
        {
            ...
            // Table object (cities)
            if (cities == null || cities is Cities)
                cities = this;
            ...
            MultiDeleteUrl = "CitiesDelete";
            MultiUpdateUrl = "CitiesUpdate";
        ...
        // Page name
        public string PageName => "CitiesList";
        ...
        {
            City.SetVisibility();
            Arabic_City_Name.SetVisibility();
            Province_ID.SetVisibility();
            Province.SetVisibility();
            Arabic_Province_Name.SetVisibility();
            Initials.SetVisibility();
            Population.SetVisibility();
            Population_2004.SetVisibility();
            Population_2010.SetVisibility();
            Population_2022.SetVisibility();
        }

        // Constructor
        public CitiesListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "CitiesView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public async Task<string> GetFilterList()
        {
            ...
            if (Config.SearchFilterOption == "Server")
                savedFilterList = await Profile.GetSearchFilters(CurrentUserName(), "fCitiessrch");

            // Initialize
            var filters = new JObject(); // DN
            filters.Merge(JObject.Parse(City.AdvancedSearch.ToJson())); // Field City
            filters.Merge(JObject.Parse(Arabic_City_Name.AdvancedSearch.ToJson())); // Field Arabic_City_Name
            filters.Merge(JObject.Parse(Province_ID.AdvancedSearch.ToJson())); // Field Province_ID
            filters.Merge(JObject.Parse(Province.AdvancedSearch.ToJson())); // Field Province
            filters.Merge(JObject.Parse(Arabic_Province_Name.AdvancedSearch.ToJson())); // Field Arabic_Province_Name
            filters.Merge(JObject.Parse(Initials.AdvancedSearch.ToJson())); // Field Initials
            filters.Merge(JObject.Parse(Population.AdvancedSearch.ToJson())); // Field Population
            filters.Merge(JObject.Parse(Population_2004.AdvancedSearch.ToJson())); // Field Population_2004
            filters.Merge(JObject.Parse(Population_2010.AdvancedSearch.ToJson())); // Field Population_2010
            filters.Merge(JObject.Parse(Population_2022.AdvancedSearch.ToJson())); // Field Population_2022
        ...
        protected async Task<object?> ProcessFilterList() {
            if (Post("ajax") == "savefilters") {
                ...
                await Profile.SetSearchFilters(CurrentUserName(), "fCitiessrch", filters);
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Arabic_City_Name
            if (filter?.TryGetValue("x_Arabic_City_Name", out sv) ?? false) {
                Arabic_City_Name.AdvancedSearch.SearchValue = sv;
                Arabic_City_Name.AdvancedSearch.SearchOperator = filter["z_Arabic_City_Name"];
                Arabic_City_Name.AdvancedSearch.SearchCondition = filter["v_Arabic_City_Name"];
                Arabic_City_Name.AdvancedSearch.SearchValue2 = filter["y_Arabic_City_Name"];
                Arabic_City_Name.AdvancedSearch.SearchOperator2 = filter["w_Arabic_City_Name"];
                Arabic_City_Name.AdvancedSearch.Save();
            }

            // Field Province_ID
            if (filter?.TryGetValue("x_Province_ID", out sv) ?? false) {
                Province_ID.AdvancedSearch.SearchValue = sv;
                Province_ID.AdvancedSearch.SearchOperator = filter["z_Province_ID"];
                Province_ID.AdvancedSearch.SearchCondition = filter["v_Province_ID"];
                Province_ID.AdvancedSearch.SearchValue2 = filter["y_Province_ID"];
                Province_ID.AdvancedSearch.SearchOperator2 = filter["w_Province_ID"];
                Province_ID.AdvancedSearch.Save();
            }

            // Field Province
            if (filter?.TryGetValue("x_Province", out sv) ?? false) {
                Province.AdvancedSearch.SearchValue = sv;
                Province.AdvancedSearch.SearchOperator = filter["z_Province"];
                Province.AdvancedSearch.SearchCondition = filter["v_Province"];
                Province.AdvancedSearch.SearchValue2 = filter["y_Province"];
                Province.AdvancedSearch.SearchOperator2 = filter["w_Province"];
                Province.AdvancedSearch.Save();
            }

            // Field Arabic_Province_Name
            if (filter?.TryGetValue("x_Arabic_Province_Name", out sv) ?? false) {
                Arabic_Province_Name.AdvancedSearch.SearchValue = sv;
                Arabic_Province_Name.AdvancedSearch.SearchOperator = filter["z_Arabic_Province_Name"];
                Arabic_Province_Name.AdvancedSearch.SearchCondition = filter["v_Arabic_Province_Name"];
                Arabic_Province_Name.AdvancedSearch.SearchValue2 = filter["y_Arabic_Province_Name"];
                Arabic_Province_Name.AdvancedSearch.SearchOperator2 = filter["w_Arabic_Province_Name"];
                Arabic_Province_Name.AdvancedSearch.Save();
            }

            // Field Initials
            if (filter?.TryGetValue("x_Initials", out sv) ?? false) {
                Initials.AdvancedSearch.SearchValue = sv;
                Initials.AdvancedSearch.SearchOperator = filter["z_Initials"];
                Initials.AdvancedSearch.SearchCondition = filter["v_Initials"];
                Initials.AdvancedSearch.SearchValue2 = filter["y_Initials"];
                Initials.AdvancedSearch.SearchOperator2 = filter["w_Initials"];
                Initials.AdvancedSearch.Save();
            }

            // Field Population
            if (filter?.TryGetValue("x_Population", out sv) ?? false) {
                Population.AdvancedSearch.SearchValue = sv;
                Population.AdvancedSearch.SearchOperator = filter["z_Population"];
                Population.AdvancedSearch.SearchCondition = filter["v_Population"];
                Population.AdvancedSearch.SearchValue2 = filter["y_Population"];
                Population.AdvancedSearch.SearchOperator2 = filter["w_Population"];
                Population.AdvancedSearch.Save();
            }

            // Field Population_2004
            if (filter?.TryGetValue("x_Population_2004", out sv) ?? false) {
                Population_2004.AdvancedSearch.SearchValue = sv;
                Population_2004.AdvancedSearch.SearchOperator = filter["z_Population_2004"];
                Population_2004.AdvancedSearch.SearchCondition = filter["v_Population_2004"];
                Population_2004.AdvancedSearch.SearchValue2 = filter["y_Population_2004"];
                Population_2004.AdvancedSearch.SearchOperator2 = filter["w_Population_2004"];
                Population_2004.AdvancedSearch.Save();
            }

            // Field Population_2010
            if (filter?.TryGetValue("x_Population_2010", out sv) ?? false) {
                Population_2010.AdvancedSearch.SearchValue = sv;
                Population_2010.AdvancedSearch.SearchOperator = filter["z_Population_2010"];
                Population_2010.AdvancedSearch.SearchCondition = filter["v_Population_2010"];
                Population_2010.AdvancedSearch.SearchValue2 = filter["y_Population_2010"];
                Population_2010.AdvancedSearch.SearchOperator2 = filter["w_Population_2010"];
                Population_2010.AdvancedSearch.Save();
            }

            // Field Population_2022
            if (filter?.TryGetValue("x_Population_2022", out sv) ?? false) {
                Population_2022.AdvancedSearch.SearchValue = sv;
                Population_2022.AdvancedSearch.SearchOperator = filter["z_Population_2022"];
                Population_2022.AdvancedSearch.SearchCondition = filter["v_Population_2022"];
                Population_2022.AdvancedSearch.SearchValue2 = filter["y_Population_2022"];
                Population_2022.AdvancedSearch.SearchOperator2 = filter["w_Population_2022"];
                Population_2022.AdvancedSearch.Save();
            }
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(City);
            searchFlds.Add(Arabic_City_Name);
            searchFlds.Add(Province);
            searchFlds.Add(Arabic_Province_Name);
            searchFlds.Add(Initials);
        ...
        protected void SetupSortOrder() {
            ...
            if (Get("order", out StringValues sv)) {
                ...
                UpdateSort(Arabic_City_Name, ctrl); // Arabic_City_Name
                UpdateSort(Province_ID, ctrl); // Province_ID
                UpdateSort(Province, ctrl); // Province
                UpdateSort(Arabic_Province_Name, ctrl); // Arabic_Province_Name
                UpdateSort(Initials, ctrl); // Initials
                UpdateSort(Population, ctrl); // Population
                UpdateSort(Population_2004, ctrl); // Population_2004
                UpdateSort(Population_2010, ctrl); // Population_2010
                UpdateSort(Population_2022, ctrl); // Population_2022
        ...
        protected void ResetCommand() {
            ...
            if (Command.ToLower().StartsWith("reset")) {
                ...
                if (SameText(Command, "resetsort")) {
                    ...
                    City.Sort = "";
                    Arabic_City_Name.Sort = "";
                    Province_ID.Sort = "";
                    Province.Sort = "";
                    Arabic_Province_Name.Sort = "";
                    Initials.Sort = "";
                    Population.Sort = "";
                    Population_2004.Sort = "";
                    Population_2010.Sort = "";
                    Population_2022.Sort = "";
                }
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fCitieslist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fCitieslist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<div class=\"btn-group\"><div class=\"form-check\"><input type=\"checkbox\" name=\"key\" id=\"key\" class=\"form-check-input\" data-ew-action=\"select-all-keys\" form=\"fCitieslist\"><label class=\"form-check-label\" for=\"key\">" + Language.Phrase("SelectAll") + "</label></div></div>";
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fCitiessrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fCitiessrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fCitieslist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(citiesList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(citiesList.RowCount) + "_Cities");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(citiesList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && citiesList.RowType == RowType.Add || IsEdit && citiesList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        public async Task LoadRowValues(Dictionary<string, object>? row)
        {
            ...
            Arabic_City_Name.SetDbValue(row["Arabic_City_Name"]);
            Province_ID.SetDbValue(row["Province_ID"]);
            Province.SetDbValue(row["Province"]);
            Arabic_Province_Name.SetDbValue(row["Arabic_Province_Name"]);
            Initials.SetDbValue(row["Initials"]);
            Population.SetDbValue(row["Population"]);
            Population_2004.SetDbValue(row["Population_2004"]);
            Population_2010.SetDbValue(row["Population_2010"]);
            Population_2022.SetDbValue(row["Population_2022"]);
        }
        ...
        protected Dictionary<string, object> NewRow() {
            ...
            row.Add("Arabic_City_Name", Arabic_City_Name.DefaultValue ?? DbNullValue); // DN
            row.Add("Province_ID", Province_ID.DefaultValue ?? DbNullValue); // DN
            row.Add("Province", Province.DefaultValue ?? DbNullValue); // DN
            row.Add("Arabic_Province_Name", Arabic_Province_Name.DefaultValue ?? DbNullValue); // DN
            row.Add("Initials", Initials.DefaultValue ?? DbNullValue); // DN
            row.Add("Population", Population.DefaultValue ?? DbNullValue); // DN
            row.Add("Population_2004", Population_2004.DefaultValue ?? DbNullValue); // DN
            row.Add("Population_2010", Population_2010.DefaultValue ?? DbNullValue); // DN
            row.Add("Population_2022", Population_2022.DefaultValue ?? DbNullValue); // DN
            return row;
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                // Arabic_City_Name
                Arabic_City_Name.ViewValue = ConvertToString(Arabic_City_Name.CurrentValue); // DN
                Arabic_City_Name.ViewCustomAttributes = "";

                // Province_ID
                Province_ID.ViewValue = Province_ID.CurrentValue;
                Province_ID.ViewValue = FormatNumber(Province_ID.ViewValue, Province_ID.FormatPattern);
                Province_ID.ViewCustomAttributes = "";

                // Province
                Province.ViewValue = ConvertToString(Province.CurrentValue); // DN
                Province.ViewCustomAttributes = "";

                // Arabic_Province_Name
                Arabic_Province_Name.ViewValue = ConvertToString(Arabic_Province_Name.CurrentValue); // DN
                Arabic_Province_Name.ViewCustomAttributes = "";

                // Initials
                Initials.ViewValue = ConvertToString(Initials.CurrentValue); // DN
                Initials.ViewCustomAttributes = "";

                // Population
                Population.ViewValue = Population.CurrentValue;
                Population.ViewValue = FormatNumber(Population.ViewValue, Population.FormatPattern);
                Population.ViewCustomAttributes = "";

                // Population_2004
                Population_2004.ViewValue = Population_2004.CurrentValue;
                Population_2004.ViewValue = FormatNumber(Population_2004.ViewValue, Population_2004.FormatPattern);
                Population_2004.ViewCustomAttributes = "";

                // Population_2010
                Population_2010.ViewValue = Population_2010.CurrentValue;
                Population_2010.ViewValue = FormatNumber(Population_2010.ViewValue, Population_2010.FormatPattern);
                Population_2010.ViewCustomAttributes = "";

                // Population_2022
                Population_2022.ViewValue = Population_2022.CurrentValue;
                Population_2022.ViewValue = FormatNumber(Population_2022.ViewValue, Population_2022.FormatPattern);
                Population_2022.ViewCustomAttributes = "";
                ...
                // Arabic_City_Name
                Arabic_City_Name.HrefValue = "";
                Arabic_City_Name.TooltipValue = "";

                // Province_ID
                Province_ID.HrefValue = "";
                Province_ID.TooltipValue = "";

                // Province
                Province.HrefValue = "";
                Province.TooltipValue = "";

                // Arabic_Province_Name
                Arabic_Province_Name.HrefValue = "";
                Arabic_Province_Name.TooltipValue = "";

                // Initials
                Initials.HrefValue = "";
                Initials.TooltipValue = "";

                // Population
                Population.HrefValue = "";
                Population.TooltipValue = "";

                // Population_2004
                Population_2004.HrefValue = "";
                Population_2004.TooltipValue = "";

                // Population_2010
                Population_2010.HrefValue = "";
                Population_2010.TooltipValue = "";

                // Population_2022
                Population_2022.HrefValue = "";
                Population_2022.TooltipValue = "";
            }
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fCitiessrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
