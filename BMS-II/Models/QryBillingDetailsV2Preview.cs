...
public partial class JUN26 {
    /// <summary>
    /// qryBillingDetailsV2Preview
    /// </summary>
    public static QryBillingDetailsV2Preview qryBillingDetailsV2Preview
    {
        get => HttpData.Get<QryBillingDetailsV2Preview>("qryBillingDetailsV2Preview")!;
        set => HttpData["qryBillingDetailsV2Preview"] = value;
    }

    /// <summary>
    /// Page class for qryBillingDetails_v2
    /// </summary>
    public class QryBillingDetailsV2Preview : QryBillingDetailsV2PreviewBase
    {
        // Constructor
        public QryBillingDetailsV2Preview(Controller controller) : base(controller)
        {
        }

        // Constructor
        public QryBillingDetailsV2Preview() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class QryBillingDetailsV2PreviewBase : QryBillingDetailsV2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "qryBillingDetailsV2Preview";
        ...
        // Constructor
        public QryBillingDetailsV2PreviewBase()
        {
            // Initialize
            CurrentPage = this;
            ...
            // Table object (qryBillingDetailsV2)
            if (qryBillingDetailsV2 == null || qryBillingDetailsV2 is QryBillingDetailsV2)
                qryBillingDetailsV2 = this;
        ...
        // Page name
        public string PageName => "QryBillingDetailsV2Preview";
        ...
        // Constructor
        public QryBillingDetailsV2PreviewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void HideFieldsForAddEdit() {
            ...
            SetupOtherOptions();
                ...
                string defaultSort = str_Username.Expression + " ASC" + ", " + Payment_Number.Expression + " ASC"; // Default sort // DN
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                qryBillingDetailsV2Preview?.PageRender();
            }
                return PageResult();
            }
            ...
            public void SetupSortOrder()
            {
                ...
                if (SameText(Get("cmd"), "resetsort")) {
                    ...
                    date_Paid.Sort = "";
                    Amount_Paid.Sort = "";
                    running_payments.Sort = "";
                    running_balance.Sort = "";
                    date_Created.Sort = "";
                    date_Modified.Sort = "";
                ...
                if (!Empty(CurrentOrder)) {
                    ...
                    UpdateSort(Amount_Paid, ctrl); // Amount_Paid
                    UpdateSort(running_payments, ctrl); // running_payments
                    UpdateSort(running_balance, ctrl); // running_balance
            ...
            protected string MasterKeyUrl() {
                ...
                if (masterTblVar == "tblBillingInfo") {
                    url = "" + Config.TableShowMaster + "=tblBillingInfo&" + ForeignKeyUrl("fk_NationalID", NationalID.QueryValue) + "";
                }
                return url;
            }
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("QryBillingDetailsV2List")), "", TableVar, true);
