...
public partial class JUN26 {
    ...
    /// calendar2Delete
    /// </summary>
    public static Calendar2Delete calendar2Delete
    {
        get => HttpData.Get<Calendar2Delete>("calendar2Delete")!;
        set => HttpData["calendar2Delete"] = value;
    }

    /// <summary>
    /// Page class for Calendar2
    /// </summary>
    public class Calendar2Delete : Calendar2DeleteBase
    {
        // Constructor
        public Calendar2Delete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public Calendar2Delete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class Calendar2DeleteBase : Calendar2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "calendar2Delete";
        ...
        // Page name
        public string PageName => "Calendar2Delete";
        ...
        // Constructor
        public Calendar2DeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("Calendar2List"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("Calendar2List"); // Return to list
                }
            }
