...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static DshbdPay dshbdPay
    {
        get => HttpData.Resolve<DshbdPay>("dshbdPay");
        set => HttpData["dshbdPay"] = value;
    }

    /// <summary>
    /// Table class for dshbdPay
    /// </summary>
    public class DshbdPay : DbTable, IQueryFactory
    {
        ...
        public DshbdPay()
        {
            ...
            Name = "dshbdPay";
            Type = "VIEW";
            UpdateTable = "dbo.dshbdPay"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            int_Payment_Method = new (this, "x_int_Payment_Method", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdPay", "int_Payment_Method", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Student_ID = new (this, "x_int_Student_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdPay", "int_Student_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdPay", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdPay", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            AmountPaid = new (this, "x_AmountPaid", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdPay", "AmountPaid", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdPay", "Price", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Paid = new (this, "x_date_Paid", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdPay", "date_Paid", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_ApprovalCode = new (this, "x_str_ApprovalCode", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdPay", "str_ApprovalCode", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "DshbdPayView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "DshbdPayEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "DshbdPayAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "DshbdPayView",
                Config.ApiAddAction => "DshbdPayAdd",
                Config.ApiEditAction => "DshbdPayEdit",
                Config.ApiDeleteAction => "DshbdPayDelete",
                Config.ApiListAction => "DshbdPayList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "DshbdPayList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("DshbdPayView", parm);
            else
                url = KeyUrl("DshbdPayView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "DshbdPayAdd";
        ...
        {
            string url = "";
            url = KeyUrl("DshbdPayEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("DshbdPayList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("DshbdPayAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("DshbdPayList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("DshbdPayDelete")); // DN
        ...
        public async Task RenderEditRow()
        {
            ...
            int_Payment_Method.EditValue = int_Payment_Method.CurrentValue; // DN
            ...
            if (!AmountPaid.Raw)
                AmountPaid.CurrentValue = HtmlDecode(AmountPaid.CurrentValue);
            AmountPaid.EditValue = HtmlEncode(AmountPaid.CurrentValue);
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM dbo.dshbdPay";
