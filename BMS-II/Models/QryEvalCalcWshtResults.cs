...
public partial class JUN26 {
    /// <summary>
    /// qryEvalCalcWshtResults
    /// </summary>
    [MaybeNull]
    public static QryEvalCalcWshtResults qryEvalCalcWshtResults
    {
        get => HttpData.Resolve<QryEvalCalcWshtResults>("qryEvalCalcWsht_Results");
        set => HttpData["qryEvalCalcWsht_Results"] = value;
    }

    /// <summary>
    /// Table class for qryEvalCalcWsht_Results
    /// </summary>
    public class QryEvalCalcWshtResults : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public QryEvalCalcWshtResults()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryEvalCalcWsht_Results";
            Name = "qryEvalCalcWsht_Results";
            Type = "VIEW";
            UpdateTable = "dbo.qryEvalCalcWsht_Results"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Eval_ID = new (this, "x_Eval_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Eval_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Student_ID = new (this, "x_int_Student_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "int_Student_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            AssessmentID = new (this, "x_AssessmentID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "AssessmentID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Full_Name_Hdr = new (this, "x_str_Full_Name_Hdr", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "str_Full_Name_Hdr", "CustomMsg"),
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            intDrivinglicenseType = new (this, "x_intDrivinglicenseType", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "intDrivinglicenseType", "CustomMsg"),
                IsUpload = false
            };
            ...
            Date_Entered = new (this, "x_Date_Entered", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Date_Entered", "CustomMsg"),
                IsUpload = false
            };
            ...
            Examination_Number = new (this, "x_Examination_Number", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Examination_Number", "CustomMsg"),
                IsUpload = false
            };
            ...
            Sect11Sum = new (this, "x_Sect11Sum", 5, SqlDbType.Float) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Sect11Sum", "CustomMsg"),
                IsUpload = false
            };
            ...
            Subtotal = new (this, "x_Subtotal", 5, SqlDbType.Float) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Subtotal", "CustomMsg"),
                IsUpload = false
            };
            ...
            Assign_int_Package_Id = new (this, "x_Assign_int_Package_Id", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Assign_int_Package_Id", "CustomMsg"),
                IsUpload = false
            };
            ...
            Package_Name = new (this, "x_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Package_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            Discount = new (this, "x_Discount", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Discount", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Price", "CustomMsg"),
                IsUpload = false
            };
            ...
            Package_Items = new (this, "x_Package_Items", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Package_Items", "CustomMsg"),
                IsUpload = false
            };
            ...
            Examiner_Signature = new (this, "x_Examiner_Signature", 203, SqlDbType.NText) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Examiner_Signature", "CustomMsg"),
                IsUpload = false
            };
            ...
            Student_Signature = new (this, "x_Student_Signature", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "Student_Signature", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Email = new (this, "x_str_Email", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "str_Email", "CustomMsg"),
                IsUpload = false
            };
            ...
            UserlevelID = new (this, "x_UserlevelID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryEvalCalcWsht_Results", "UserlevelID", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryEvalCalcWsht_Results";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "QryEvalCalcWshtResultsList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "QryEvalCalcWshtResultsView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryEvalCalcWshtResultsEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryEvalCalcWshtResultsAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryEvalCalcWshtResultsView",
                Config.ApiAddAction => "QryEvalCalcWshtResultsAdd",
                Config.ApiEditAction => "QryEvalCalcWshtResultsEdit",
                Config.ApiDeleteAction => "QryEvalCalcWshtResultsDelete",
                Config.ApiListAction => "QryEvalCalcWshtResultsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryEvalCalcWshtResultsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryEvalCalcWshtResultsView", parm);
            else
                url = KeyUrl("QryEvalCalcWshtResultsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryEvalCalcWshtResultsAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryEvalCalcWshtResultsAdd?" + parm;
            else
                url = "QryEvalCalcWshtResultsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryEvalCalcWshtResultsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryEvalCalcWshtResultsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryEvalCalcWshtResultsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryEvalCalcWshtResultsList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryEvalCalcWshtResultsDelete")); // DN
        ...
        {
            string pageName = "QryEvalCalcWshtResultsList";
