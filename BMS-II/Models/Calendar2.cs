...
public partial class JUN26 {
    ...
    {
        get => HttpData.Resolve<Calendar2>("Calendar2");
        set => HttpData["Calendar2"] = value;
    }

    /// <summary>
    /// Table class for Calendar2
    /// </summary>
    public class Calendar2 : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> ClassNames;
        ...
        public Calendar2()
        {
            ...
            Name = "Calendar2";
            Type = "TABLE";
            UpdateTable = "dbo.Calendar2"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new (this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar2", "Id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Id", Id);

            // Title
            _Title = new (this, "x__Title", 203, SqlDbType.NText) {
                Name = "Title",
                Expression = "[Title]",
                UseBasicSearch = true,
                ...
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("Calendar2", "_Title", "CustomMsg"),
                IsUpload = false
            };
            _Title.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(_Title, "qryClassroomCldrList", false, "Title", new List<string> {"Title", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Title]"),
                "en-US" => new Lookup<DbField>(_Title, "qryClassroomCldrList", false, "Title", new List<string> {"Title", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Title]"),
                _ => new Lookup<DbField>(_Title, "qryClassroomCldrList", false, "Title", new List<string> {"Title", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "[Title]")
            };
            ...
            Start = new (this, "x_Start", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("Calendar2", "Start", "CustomMsg"),
                IsUpload = false
            };
            ...
            End = new (this, "x_End", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar2", "End", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("End", End);
            ...
            AllDay = new (this, "x_AllDay", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("Calendar2", "AllDay", "CustomMsg"),
                IsUpload = false
            };
            AllDay.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(AllDay, "Calendar2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(AllDay, "Calendar2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(AllDay, "Calendar2", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("AllDay", AllDay);

            // Notes
            Notes = new (this, "x_Notes", 203, SqlDbType.NText) {
                Name = "Notes",
                Expression = "[Notes]",
                ...
                CustomMessage = Language.FieldPhrase("Calendar2", "Notes", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar2", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Url = new (this, "x__Url", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar2", "_Url", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Url", _Url);

            // ClassNames
            ClassNames = new (this, "x_ClassNames", 202, SqlDbType.NVarChar) {
                Name = "ClassNames",
                Expression = "[ClassNames]",
                UseBasicSearch = true,
                BasicSearchExpression = "[ClassNames]",
                DateTimeFormat = -1,
                VirtualExpression = "[ClassNames]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar2", "ClassNames", "CustomMsg"),
                IsUpload = false
            };
            ClassNames.GetDefault = () => "event-primary";
            Fields.Add("ClassNames", ClassNames);
            ...
            Display = new (this, "x_Display", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar2", "Display", "CustomMsg"),
                IsUpload = false
            };
            Display.GetDefault = () => "auto";
            ...
            BackgroundColor = new (this, "x_BackgroundColor", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar2", "BackgroundColor", "CustomMsg"),
                IsUpload = false
            };
            ...
            CRSS_ID = new (this, "x_CRSS_ID", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar2", "CRSS_ID", "CustomMsg"),
                IsUpload = false
            };
            CRSS_ID.GetDefault = () => "event-primary";
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                ClassNames.DbValue = row["ClassNames"]; // Set DB value only
        ...
        {
            if (SameString(pageName, "Calendar2View"))
                return Language.Phrase("View");
            else if (SameString(pageName, "Calendar2Edit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "Calendar2Add"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "Calendar2View",
                Config.ApiAddAction => "Calendar2Add",
                Config.ApiEditAction => "Calendar2Edit",
                Config.ApiDeleteAction => "Calendar2Delete",
                Config.ApiListAction => "Calendar2List",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "Calendar2List";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("Calendar2View", parm);
            else
                url = KeyUrl("Calendar2View", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "Calendar2Add";
        ...
        {
            string url = "";
            url = KeyUrl("Calendar2Edit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("Calendar2List", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("Calendar2Add", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("Calendar2List", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("Calendar2Delete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            ClassNames.SetDbValue(dr["ClassNames"]);
        ...
        public async Task RenderEditRow()
        {
            ...
            ClassNames.EditValue = ConvertToString(ClassNames.CurrentValue); // DN
            ClassNames.ViewCustomAttributes = "";

            // Display
            Display.SetupEditAttributes();
            Display.EditValue = ConvertToString(Display.CurrentValue); // DN
            Display.ViewCustomAttributes = "";
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(ClassNames);
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM dbo.Calendar2";
