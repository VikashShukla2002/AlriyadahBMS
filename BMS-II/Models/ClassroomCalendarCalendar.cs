...
public partial class JUN26 {
    /// <summary>
    /// classroomCalendarCalendar
    /// </summary>
    public static ClassroomCalendarCalendar classroomCalendarCalendar
    {
        get => HttpData.Get<ClassroomCalendarCalendar>("classroomCalendarCalendar")!;
        set => HttpData["classroomCalendarCalendar"] = value;
    }

    /// <summary>
    /// Page class for Classroom_Calendar
    /// </summary>
    public class ClassroomCalendarCalendar : ClassroomCalendarCalendarBase
    {
        // Constructor
        public ClassroomCalendarCalendar(Controller controller) : base(controller)
        {
        }

        // Constructor
        public ClassroomCalendarCalendar() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class ClassroomCalendarCalendarBase : ClassroomCalendar
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "classroomCalendarCalendar";
        ...
        // Constructor
        public ClassroomCalendarCalendarBase()
        {
            // Initialize
        ...
        // Page name
        public string PageName => "ClassroomCalendar";
        ...
        // Constructor
        public ClassroomCalendarCalendarBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            EventViewUrl = Security.CanView ? "ClassroomCalendarView" : "";
            EventAddUrl = Security.CanAdd ? "ClassroomCalendarAdd" : "";
            EventEditUrl = Security.CanEdit ? "ClassroomCalendarEdit" : "";
            EventCopyUrl = Security.CanAdd ? "ClassroomCalendarAdd" : "";
            EventDeleteUrl = Security.CanDelete ? "ClassroomCalendarDelete" : "";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                classroomCalendarCalendar?.PageRender();
            }
            return PageResult();
        }
        ...
        {
            List<string> eventListFields = new () { "Id", "Title", "Start", "End", "AllDay", "Notes", "str_Username", "Url", "ClassNames", "Display", "BackgroundColor", "CRSS_ID" };
        ...
        public void SetupOtherOptions()
        {
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fClassroom_Calendarsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fClassroom_Calendarsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = false;
