...
public partial class JUN26 {
    ...
    /// dshbdAssessmentList
    /// </summary>
    public static DshbdAssessmentList dshbdAssessmentList
    {
        get => HttpData.Get<DshbdAssessmentList>("dshbdAssessmentList")!;
        set => HttpData["dshbdAssessmentList"] = value;
    }

    /// <summary>
    /// Page class for dshbdAssessment
    /// </summary>
    public class DshbdAssessmentList : DshbdAssessmentListBase
    {
        // Constructor
        public DshbdAssessmentList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public DshbdAssessmentList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class DshbdAssessmentListBase : DshbdAssessment
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "dshbdAssessment";

        // Page object name
        public string PageObjName = "dshbdAssessmentList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fdshbdAssessmentlist";
        ...
        // Constructor
        public DshbdAssessmentListBase()
        {
            // CSS class name as context
            TableVar = "dshbdAssessment";
            ...
            // Table object (dshbdAssessment)
            if (dshbdAssessment == null || dshbdAssessment is DshbdAssessment)
                dshbdAssessment = this;

            // Initialize URLs
            AddUrl = "DshbdAssessmentAdd";
            ...
            MultiDeleteUrl = "DshbdAssessmentDelete";
            MultiUpdateUrl = "DshbdAssessmentUpdate";
        ...
        // Page name
        public string PageName => "DshbdAssessmentList";
        ...
        // Constructor
        public DshbdAssessmentListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "DshbdAssessmentView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                dshbdAssessmentList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            if (Config.SearchFilterOption == "Server")
                savedFilterList = await Profile.GetSearchFilters(CurrentUserName(), "fdshbdAssessmentsrch");
        ...
        protected async Task<object?> ProcessFilterList() {
            if (Post("ajax") == "savefilters") {
                ...
                await Profile.SetSearchFilters(CurrentUserName(), "fdshbdAssessmentsrch", filters);
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fdshbdAssessmentlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fdshbdAssessmentlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<div class=\"btn-group\"><div class=\"form-check\"><input type=\"checkbox\" name=\"key\" id=\"key\" class=\"form-check-input\" data-ew-action=\"select-all-keys\" form=\"fdshbdAssessmentlist\"><label class=\"form-check-label\" for=\"key\">" + Language.Phrase("SelectAll") + "</label></div></div>";
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fdshbdAssessmentsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fdshbdAssessmentsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fdshbdAssessmentlist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_dshbdAssessment");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(dshbdAssessmentList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(dshbdAssessmentList.RowCount) + "_dshbdAssessment");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(dshbdAssessmentList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && dshbdAssessmentList.RowType == RowType.Add || IsEdit && dshbdAssessmentList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fdshbdAssessmentsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
