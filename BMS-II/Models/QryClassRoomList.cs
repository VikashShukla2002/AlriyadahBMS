...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static QryClassRoomList qryClassRoomList
    {
        get => HttpData.Resolve<QryClassRoomList>("qryClassRoomList");
        set => HttpData["qryClassRoomList"] = value;
    }

    /// <summary>
    /// Table class for qryClassRoomList
    /// </summary>
    public class QryClassRoomList : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public QryClassRoomList()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryClassRoomList";
            Name = "qryClassRoomList";
            Type = "VIEW";
            UpdateTable = "[BMS_DBT].[dbo].[tblClassRoom]"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            int_CR_ID = new (this, "x_int_CR_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_CR_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_CR_Product_ID = new (this, "x_int_CR_Product_ID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_CR_Product_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_CR_Number = new (this, "x_str_CR_Number", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "str_CR_Number", "CustomMsg"),
                IsUpload = false
            };
            ...
            mon_CR_Price = new (this, "x_mon_CR_Price", 6, SqlDbType.Money) {
                ...
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "mon_CR_Price", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_CR_Size = new (this, "x_int_CR_Size", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_CR_Size", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_MU_Size = new (this, "x_int_MU_Size", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_MU_Size", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_CR_Status = new (this, "x_int_CR_Status", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_CR_Status", "CustomMsg"),
                IsUpload = false
            };
            ...
            Is_Web_SignUp = new (this, "x_Is_Web_SignUp", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "Is_Web_SignUp", "CustomMsg"),
                IsUpload = false
            };
            Is_Web_SignUp.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Is_Web_SignUp, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Is_Web_SignUp, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Is_Web_SignUp, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            int_Location_ID = new (this, "x_int_Location_ID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_Location_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Teacher_ID = new (this, "x_int_Teacher_ID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_Teacher_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Start = new (this, "x_date_Start", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "date_Start", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_TotSession = new (this, "x_int_TotSession", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_TotSession", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_PerDaySession = new (this, "x_int_PerDaySession", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_PerDaySession", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_CR_Days = new (this, "x_str_CR_Days", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "str_CR_Days", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_CR_Notes = new (this, "x_str_CR_Notes", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "str_CR_Notes", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Created_By = new (this, "x_int_Created_By", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_Created_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Modified_By = new (this, "x_int_Modified_By", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_Modified_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Created = new (this, "x_date_Created", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "date_Created", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Modified = new (this, "x_date_Modified", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "date_Modified", "CustomMsg"),
                IsUpload = false
            };
            ...
            bit_IsDeleted = new (this, "x_bit_IsDeleted", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "bit_IsDeleted", "CustomMsg"),
                IsUpload = false
            };
            bit_IsDeleted.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(bit_IsDeleted, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(bit_IsDeleted, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(bit_IsDeleted, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            bit_AllTeacher = new (this, "x_bit_AllTeacher", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "bit_AllTeacher", "CustomMsg"),
                IsUpload = false
            };
            bit_AllTeacher.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(bit_AllTeacher, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(bit_AllTeacher, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(bit_AllTeacher, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            int_Manual_Change = new (this, "x_int_Manual_Change", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_Manual_Change", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_WebDesc = new (this, "x_str_WebDesc", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "str_WebDesc", "CustomMsg"),
                IsUpload = false
            };
            ...
            is_Show = new (this, "x_is_Show", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "is_Show", "CustomMsg"),
                IsUpload = false
            };
            is_Show.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(is_Show, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(is_Show, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(is_Show, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            is_ShowGridColumn = new (this, "x_is_ShowGridColumn", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "is_ShowGridColumn", "CustomMsg"),
                IsUpload = false
            };
            is_ShowGridColumn.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(is_ShowGridColumn, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(is_ShowGridColumn, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(is_ShowGridColumn, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            rowIndex = new (this, "x_rowIndex", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "rowIndex", "CustomMsg"),
                IsUpload = false
            };
            ...
            is_ZoomMeet = new (this, "x_is_ZoomMeet", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "is_ZoomMeet", "CustomMsg"),
                IsUpload = false
            };
            is_ZoomMeet.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(is_ZoomMeet, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(is_ZoomMeet, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(is_ZoomMeet, "qryClassRoomList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Classroom_Internal_Cr_Notes = new (this, "x_Classroom_Internal_Cr_Notes", 203, SqlDbType.NText) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "Classroom_Internal_Cr_Notes", "CustomMsg"),
                IsUpload = false
            };
            ...
            BulkCR_Set = new (this, "x_BulkCR_Set", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "BulkCR_Set", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Day_Incremental = new (this, "x_int_Day_Incremental", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_Day_Incremental", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Reoccurrence = new (this, "x_int_Reoccurrence", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "int_Reoccurrence", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            Calendar_ID = new (this, "x_Calendar_ID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "Calendar_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Package_Name = new (this, "x_str_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "str_Package_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Start2 = new (this, "x_date_Start2", 135, SqlDbType.DateTime) {
                ...
                BasicSearchExpression = CastDateFieldForLike("[date_Start2]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "date_Start2", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Start3 = new (this, "x_date_Start3", 135, SqlDbType.DateTime) {
                ...
                BasicSearchExpression = CastDateFieldForLike("[date_Start3]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "date_Start3", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Start4 = new (this, "x_date_Start4", 135, SqlDbType.DateTime) {
                ...
                BasicSearchExpression = CastDateFieldForLike("[date_Start4]", 0, "DB"),
                DateTimeFormat = 0,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryClassRoomList", "date_Start4", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryClassRoomList";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "QryClassRoomListView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryClassRoomListEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryClassRoomListAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryClassRoomListView",
                Config.ApiAddAction => "QryClassRoomListAdd",
                Config.ApiEditAction => "QryClassRoomListEdit",
                Config.ApiDeleteAction => "QryClassRoomListDelete",
                Config.ApiListAction => "QryClassRoomListList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryClassRoomListList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryClassRoomListView", parm);
            else
                url = KeyUrl("QryClassRoomListView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryClassRoomListAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryClassRoomListAdd?" + parm;
            else
                url = "QryClassRoomListAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryClassRoomListEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryClassRoomListList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryClassRoomListAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryClassRoomListList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryClassRoomListDelete")); // DN
        ...
        {
            string pageName = "QryClassRoomListList";
