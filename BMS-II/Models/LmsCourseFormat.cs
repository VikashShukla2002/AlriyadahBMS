...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static LmsCourseFormat lmsCourseFormat
    {
        get => HttpData.Resolve<LmsCourseFormat>("LMS_Course_Format");
        set => HttpData["LMS_Course_Format"] = value;
    }

    /// <summary>
    /// Table class for LMS_Course_Format
    /// </summary>
    public class LmsCourseFormat : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public LmsCourseFormat()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "LMS_Course_Format";
            Name = "LMS_Course_Format";
            Type = "VIEW";
            UpdateTable = "dbo.LMS_Course_Format"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            category = new (this, "x_category", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "category", "CustomMsg"),
                IsUpload = false
            };
            ...
            sortorder = new (this, "x_sortorder", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "sortorder", "CustomMsg"),
                IsUpload = false
            };
            ...
            fullname = new (this, "x_fullname", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "fullname", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("fullname", fullname);

            // shortname
            shortname = new (this, "x_shortname", 202, SqlDbType.NVarChar) {
                Name = "shortname",
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "shortname", "CustomMsg"),
                IsUpload = false
            };
            ...
            idnumber = new (this, "x_idnumber", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "idnumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            summary = new (this, "x_summary", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "summary", "CustomMsg"),
                IsUpload = false
            };
            ...
            summaryformat = new (this, "x_summaryformat", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "summaryformat", "CustomMsg"),
                IsUpload = false
            };
            ...
            format = new (this, "x_format", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "format", "CustomMsg"),
                IsUpload = false
            };
            ...
            showgrades = new (this, "x_showgrades", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "showgrades", "CustomMsg"),
                IsUpload = false
            };
            ...
            newsitems = new (this, "x_newsitems", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "newsitems", "CustomMsg"),
                IsUpload = false
            };
            ...
            startdate = new (this, "x_startdate", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "startdate", "CustomMsg"),
                IsUpload = false
            };
            ...
            enddate = new (this, "x_enddate", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "enddate", "CustomMsg"),
                IsUpload = false
            };
            ...
            relativedatesmode = new (this, "x_relativedatesmode", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "relativedatesmode", "CustomMsg"),
                IsUpload = false
            };
            ...
            marker = new (this, "x_marker", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "marker", "CustomMsg"),
                IsUpload = false
            };
            ...
            maxbytes = new (this, "x_maxbytes", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "maxbytes", "CustomMsg"),
                IsUpload = false
            };
            ...
            legacyfiles = new (this, "x_legacyfiles", 2, SqlDbType.SmallInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "legacyfiles", "CustomMsg"),
                IsUpload = false
            };
            ...
            showreports = new (this, "x_showreports", 2, SqlDbType.SmallInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "showreports", "CustomMsg"),
                IsUpload = false
            };
            ...
            _visible = new (this, "x__visible", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "_visible", "CustomMsg"),
                IsUpload = false
            };
            ...
            visibleold = new (this, "x_visibleold", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "visibleold", "CustomMsg"),
                IsUpload = false
            };
            ...
            downloadcontent = new (this, "x_downloadcontent", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "downloadcontent", "CustomMsg"),
                IsUpload = false
            };
            ...
            groupmode = new (this, "x_groupmode", 2, SqlDbType.SmallInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "groupmode", "CustomMsg"),
                IsUpload = false
            };
            ...
            groupmodeforce = new (this, "x_groupmodeforce", 2, SqlDbType.SmallInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "groupmodeforce", "CustomMsg"),
                IsUpload = false
            };
            ...
            defaultgroupingid = new (this, "x_defaultgroupingid", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "defaultgroupingid", "CustomMsg"),
                IsUpload = false
            };
            ...
            _lang = new (this, "x__lang", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "_lang", "CustomMsg"),
                IsUpload = false
            };
            ...
            calendartype = new (this, "x_calendartype", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "calendartype", "CustomMsg"),
                IsUpload = false
            };
            ...
            theme = new (this, "x_theme", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "theme", "CustomMsg"),
                IsUpload = false
            };
            ...
            timecreated = new (this, "x_timecreated", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "timecreated", "CustomMsg"),
                IsUpload = false
            };
            ...
            timemodified = new (this, "x_timemodified", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "timemodified", "CustomMsg"),
                IsUpload = false
            };
            ...
            requested = new (this, "x_requested", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "requested", "CustomMsg"),
                IsUpload = false
            };
            ...
            enablecompletion = new (this, "x_enablecompletion", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "enablecompletion", "CustomMsg"),
                IsUpload = false
            };
            ...
            completionnotify = new (this, "x_completionnotify", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "completionnotify", "CustomMsg"),
                IsUpload = false
            };
            ...
            cacherev = new (this, "x_cacherev", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "cacherev", "CustomMsg"),
                IsUpload = false
            };
            ...
            originalcourseid = new (this, "x_originalcourseid", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "originalcourseid", "CustomMsg"),
                IsUpload = false
            };
            ...
            showactivitydates = new (this, "x_showactivitydates", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "showactivitydates", "CustomMsg"),
                IsUpload = false
            };
            ...
            showcompletionconditions = new (this, "x_showcompletionconditions", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "showcompletionconditions", "CustomMsg"),
                IsUpload = false
            };
            ...
            pdfexportfont = new (this, "x_pdfexportfont", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Format", "pdfexportfont", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.LMS_Course_Format";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "LmsCourseFormatView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "LmsCourseFormatEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "LmsCourseFormatAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "LmsCourseFormatView",
                Config.ApiAddAction => "LmsCourseFormatAdd",
                Config.ApiEditAction => "LmsCourseFormatEdit",
                Config.ApiDeleteAction => "LmsCourseFormatDelete",
                Config.ApiListAction => "LmsCourseFormatList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "LmsCourseFormatList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("LmsCourseFormatView", parm);
            else
                url = KeyUrl("LmsCourseFormatView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "LmsCourseFormatAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "LmsCourseFormatAdd?" + parm;
            else
                url = "LmsCourseFormatAdd";
        ...
        {
            string url = "";
            url = KeyUrl("LmsCourseFormatEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsCourseFormatList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("LmsCourseFormatAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsCourseFormatList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("LmsCourseFormatDelete")); // DN
        ...
        {
            string pageName = "LmsCourseFormatList";
