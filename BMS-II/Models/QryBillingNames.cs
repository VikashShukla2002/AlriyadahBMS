...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static QryBillingNames qryBillingNames
    {
        get => HttpData.Resolve<QryBillingNames>("qryBillingNames");
        set => HttpData["qryBillingNames"] = value;
    }

    /// <summary>
    /// Table class for qryBillingNames
    /// </summary>
    public class QryBillingNames : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public QryBillingNames()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryBillingNames";
            Name = "qryBillingNames";
            Type = "VIEW";
            UpdateTable = "dbo.qryBillingNames"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            int_Student_ID = new (this, "x_int_Student_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryBillingNames", "int_Student_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Full_Name = new (this, "x_str_Full_Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryBillingNames", "str_Full_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("qryBillingNames", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingNames", "str_Username", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryBillingNames";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "QryBillingNamesView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryBillingNamesEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryBillingNamesAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryBillingNamesView",
                Config.ApiAddAction => "QryBillingNamesAdd",
                Config.ApiEditAction => "QryBillingNamesEdit",
                Config.ApiDeleteAction => "QryBillingNamesDelete",
                Config.ApiListAction => "QryBillingNamesList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryBillingNamesList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryBillingNamesView", parm);
            else
                url = KeyUrl("QryBillingNamesView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryBillingNamesAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryBillingNamesAdd?" + parm;
            else
                url = "QryBillingNamesAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryBillingNamesEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryBillingNamesList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryBillingNamesAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryBillingNamesList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryBillingNamesDelete")); // DN
        ...
        {
            string pageName = "QryBillingNamesList";
