...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static LmsUserEnrolments lmsUserEnrolments
    {
        get => HttpData.Resolve<LmsUserEnrolments>("LMS_User_Enrolments");
        set => HttpData["LMS_User_Enrolments"] = value;
    }

    /// <summary>
    /// Table class for LMS_User_Enrolments
    /// </summary>
    public class LmsUserEnrolments : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> enrolid;

        public readonly DbField<SqlDbType> userid;

        public readonly DbField<SqlDbType> timestart;

        public readonly DbField<SqlDbType> timeend;

        public readonly DbField<SqlDbType> modifierid;
        ...
        // Constructor
        public LmsUserEnrolments()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "LMS_User_Enrolments";
            Name = "LMS_User_Enrolments";
            Type = "VIEW";
            UpdateTable = "dbo.LMS_User_Enrolments"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            status = new (this, "x_status", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "status", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("status", status);

            // enrolid
            enrolid = new (this, "x_enrolid", 20, SqlDbType.BigInt) {
                Name = "enrolid",
                Expression = "[enrolid]",
                BasicSearchExpression = "CAST([enrolid] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[enrolid]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "enrolid", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("enrolid", enrolid);
            ...
            userid = new (this, "x_userid", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "userid", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("userid", userid);

            // timestart
            timestart = new (this, "x_timestart", 20, SqlDbType.BigInt) {
                Name = "timestart",
                Expression = "[timestart]",
                BasicSearchExpression = "CAST([timestart] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[timestart]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "timestart", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("timestart", timestart);

            // timeend
            timeend = new (this, "x_timeend", 20, SqlDbType.BigInt) {
                Name = "timeend",
                Expression = "[timeend]",
                BasicSearchExpression = "CAST([timeend] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[timeend]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "timeend", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("timeend", timeend);

            // modifierid
            modifierid = new (this, "x_modifierid", 20, SqlDbType.BigInt) {
                Name = "modifierid",
                Expression = "[modifierid]",
                BasicSearchExpression = "CAST([modifierid] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[modifierid]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "modifierid", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("modifierid", modifierid);
            ...
            timecreated = new (this, "x_timecreated", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "timecreated", "CustomMsg"),
                IsUpload = false
            };
            ...
            timemodified = new (this, "x_timemodified", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_User_Enrolments", "timemodified", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.LMS_User_Enrolments";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                enrolid.DbValue = row["enrolid"]; // Set DB value only
                userid.DbValue = row["userid"]; // Set DB value only
                timestart.DbValue = row["timestart"]; // Set DB value only
                timeend.DbValue = row["timeend"]; // Set DB value only
                modifierid.DbValue = row["modifierid"]; // Set DB value only
        ...
        {
            if (SameString(pageName, "LmsUserEnrolmentsView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "LmsUserEnrolmentsEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "LmsUserEnrolmentsAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "LmsUserEnrolmentsView",
                Config.ApiAddAction => "LmsUserEnrolmentsAdd",
                Config.ApiEditAction => "LmsUserEnrolmentsEdit",
                Config.ApiDeleteAction => "LmsUserEnrolmentsDelete",
                Config.ApiListAction => "LmsUserEnrolmentsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "LmsUserEnrolmentsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("LmsUserEnrolmentsView", parm);
            else
                url = KeyUrl("LmsUserEnrolmentsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "LmsUserEnrolmentsAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "LmsUserEnrolmentsAdd?" + parm;
            else
                url = "LmsUserEnrolmentsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("LmsUserEnrolmentsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsUserEnrolmentsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("LmsUserEnrolmentsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsUserEnrolmentsList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("LmsUserEnrolmentsDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            enrolid.SetDbValue(dr["enrolid"]);
            userid.SetDbValue(dr["userid"]);
            timestart.SetDbValue(dr["timestart"]);
            timeend.SetDbValue(dr["timeend"]);
            modifierid.SetDbValue(dr["modifierid"]);
        ...
        {
            string pageName = "LmsUserEnrolmentsList";
        ...
        public async Task RenderListRow()
        {
            ...
            // enrolid
            enrolid.ViewValue = enrolid.CurrentValue;
            enrolid.ViewValue = FormatNumber(enrolid.ViewValue, enrolid.FormatPattern);
            enrolid.ViewCustomAttributes = "";
            ...
            // timestart
            timestart.ViewValue = timestart.CurrentValue;
            timestart.ViewValue = FormatNumber(timestart.ViewValue, timestart.FormatPattern);
            timestart.ViewCustomAttributes = "";

            // timeend
            timeend.ViewValue = timeend.CurrentValue;
            timeend.ViewValue = FormatNumber(timeend.ViewValue, timeend.FormatPattern);
            timeend.ViewCustomAttributes = "";

            // modifierid
            modifierid.ViewValue = modifierid.CurrentValue;
            modifierid.ViewValue = FormatNumber(modifierid.ViewValue, modifierid.FormatPattern);
            modifierid.ViewCustomAttributes = "";
            ...
            // timestart
            timestart.HrefValue = "";
            timestart.TooltipValue = "";

            // timeend
            timeend.HrefValue = "";
            timeend.TooltipValue = "";

            // modifierid
            modifierid.HrefValue = "";
            modifierid.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // enrolid
            enrolid.SetupEditAttributes();
            enrolid.EditValue = enrolid.CurrentValue; // DN
            enrolid.PlaceHolder = RemoveHtml(enrolid.Caption);
            if (!Empty(enrolid.EditValue) && IsNumeric(enrolid.EditValue))
                enrolid.EditValue = FormatNumber(enrolid.EditValue, null);
            ...
            // timestart
            timestart.SetupEditAttributes();
            timestart.EditValue = timestart.CurrentValue; // DN
            timestart.PlaceHolder = RemoveHtml(timestart.Caption);
            if (!Empty(timestart.EditValue) && IsNumeric(timestart.EditValue))
                timestart.EditValue = FormatNumber(timestart.EditValue, null);

            // timeend
            timeend.SetupEditAttributes();
            timeend.EditValue = timeend.CurrentValue; // DN
            timeend.PlaceHolder = RemoveHtml(timeend.Caption);
            if (!Empty(timeend.EditValue) && IsNumeric(timeend.EditValue))
                timeend.EditValue = FormatNumber(timeend.EditValue, null);

            // modifierid
            modifierid.SetupEditAttributes();
            modifierid.EditValue = modifierid.CurrentValue; // DN
            modifierid.PlaceHolder = RemoveHtml(modifierid.Caption);
            if (!Empty(modifierid.EditValue) && IsNumeric(modifierid.EditValue))
                modifierid.EditValue = FormatNumber(modifierid.EditValue, null);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(enrolid);
                        doc.ExportCaption(userid);
                        doc.ExportCaption(timestart);
                        doc.ExportCaption(timeend);
                        doc.ExportCaption(modifierid);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(enrolid);
                            await doc.ExportField(userid);
                            await doc.ExportField(timestart);
                            await doc.ExportField(timeend);
                            await doc.ExportField(modifierid);
