...
public partial class JUN26 {
    ...
    /// equipmentDelete
    /// </summary>
    public static EquipmentDelete equipmentDelete
    {
        get => HttpData.Get<EquipmentDelete>("equipmentDelete")!;
        set => HttpData["equipmentDelete"] = value;
    }

    /// <summary>
    /// Page class for Equipment
    /// </summary>
    public class EquipmentDelete : EquipmentDeleteBase
    {
        // Constructor
        public EquipmentDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public EquipmentDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class EquipmentDeleteBase : Equipment
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "equipmentDelete";
        ...
        // Page name
        public string PageName => "EquipmentDelete";
        ...
        // Constructor
        public EquipmentDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("EquipmentList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("EquipmentList"); // Return to list
                }
            }
