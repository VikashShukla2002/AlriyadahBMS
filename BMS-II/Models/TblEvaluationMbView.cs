...
public partial class JUN26 {
    ...
    /// tblEvaluationMbView
    /// </summary>
    public static TblEvaluationMbView tblEvaluationMbView
    {
        get => HttpData.Get<TblEvaluationMbView>("tblEvaluationMbView")!;
        set => HttpData["tblEvaluationMbView"] = value;
    }

    /// <summary>
    /// Page class for tblEvaluationMB
    /// </summary>
    public class TblEvaluationMbView : TblEvaluationMbViewBase
    {
        // Constructor
        public TblEvaluationMbView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblEvaluationMbView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TblEvaluationMbViewBase : TblEvaluationMb
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblEvaluationMbView";
        ...
        // Constructor
        public TblEvaluationMbViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TblEvaluationMbView";
        ...
        // Constructor
        public TblEvaluationMbViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("Eval_ID", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "TblEvaluationMbList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("TblEvaluationMbList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                tblEvaluationMbView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"ftblEvaluationMBview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
