...
public partial class JUN26 {
    /// <summary>
    /// dshbdAssessmentScore
    /// </summary>
    [MaybeNull]
    public static DshbdAssessmentScore dshbdAssessmentScore
    {
        get => HttpData.Resolve<DshbdAssessmentScore>("dshbdAssessmentScore");
        set => HttpData["dshbdAssessmentScore"] = value;
    }

    /// <summary>
    /// Table class for dshbdAssessmentScore
    /// </summary>
    public class DshbdAssessmentScore : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public DshbdAssessmentScore()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "dshbdAssessmentScore";
            Name = "dshbdAssessmentScore";
            Type = "VIEW";
            UpdateTable = "dbo.dshbdAssessmentScore"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            AssessmentID = new (this, "x_AssessmentID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdAssessmentScore", "AssessmentID", "CustomMsg"),
                IsUpload = false
            };
            ...
            intDrivinglicenseType = new (this, "x_intDrivinglicenseType", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdAssessmentScore", "intDrivinglicenseType", "CustomMsg"),
                IsUpload = false
            };
            ...
            Date_Entered = new (this, "x_Date_Entered", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentScore", "Date_Entered", "CustomMsg"),
                IsUpload = false
            };
            ...
            Evaluation_Score = new (this, "x_Evaluation_Score", 5, SqlDbType.Float) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentScore", "Evaluation_Score", "CustomMsg"),
                IsUpload = false
            };
            ...
            Immediate_Failure_Score = new (this, "x_Immediate_Failure_Score", 5, SqlDbType.Float) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentScore", "Immediate_Failure_Score", "CustomMsg"),
                IsUpload = false
            };
            ...
            AssessmentScore = new (this, "x_AssessmentScore", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdAssessmentScore", "AssessmentScore", "CustomMsg"),
                IsUpload = false
            };
            ...
            Required_Program = new (this, "x_Required_Program", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdAssessmentScore", "Required_Program", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentScore", "Price", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.dshbdAssessmentScore";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "DshbdAssessmentScoreList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "DshbdAssessmentScoreView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "DshbdAssessmentScoreEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "DshbdAssessmentScoreAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "DshbdAssessmentScoreView",
                Config.ApiAddAction => "DshbdAssessmentScoreAdd",
                Config.ApiEditAction => "DshbdAssessmentScoreEdit",
                Config.ApiDeleteAction => "DshbdAssessmentScoreDelete",
                Config.ApiListAction => "DshbdAssessmentScoreList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "DshbdAssessmentScoreList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("DshbdAssessmentScoreView", parm);
            else
                url = KeyUrl("DshbdAssessmentScoreView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "DshbdAssessmentScoreAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "DshbdAssessmentScoreAdd?" + parm;
            else
                url = "DshbdAssessmentScoreAdd";
        ...
        {
            string url = "";
            url = KeyUrl("DshbdAssessmentScoreEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("DshbdAssessmentScoreList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("DshbdAssessmentScoreAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("DshbdAssessmentScoreList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("DshbdAssessmentScoreDelete")); // DN
        ...
        {
            string pageName = "DshbdAssessmentScoreList";
