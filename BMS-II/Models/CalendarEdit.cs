...
public partial class JUN26 {
    ...
    /// calendarEdit
    /// </summary>
    public static CalendarEdit calendarEdit
    {
        get => HttpData.Get<CalendarEdit>("calendarEdit")!;
        set => HttpData["calendarEdit"] = value;
    }

    /// <summary>
    /// Page class for Calendar
    /// </summary>
    public class CalendarEdit : CalendarEditBase
    {
        // Constructor
        public CalendarEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CalendarEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CalendarEditBase : Calendar
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "calendarEdit";
        ...
        // Page name
        public string PageName => "CalendarEdit";
        ...
        // Constructor
        public CalendarEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("CalendarList"); // No matching record, return to list
                        }
                    break;
        ...
        protected async Task<bool> ValidateForm() {
            ...
            if (BackgroundColor.Required) {
                if (!BackgroundColor.IsDetailKey && Empty(BackgroundColor.FormValue)) {
                    BackgroundColor.AddErrorMessage(ConvertToString(BackgroundColor.RequiredErrorMessage).Replace("%s", BackgroundColor.Caption));
                }
            }
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // AllDay
            AllDay.SetDbValue(rsnew, ConvertToBool(AllDay.CurrentValue), AllDay.ReadOnly);
            ...
            // ClassNames
            ClassNames.SetDbValue(rsnew, ClassNames.CurrentValue, ClassNames.ReadOnly);

            // Display
            Display.SetDbValue(rsnew, Display.CurrentValue, Display.ReadOnly);

            // BackgroundColor
            BackgroundColor.SetDbValue(rsnew, BackgroundColor.CurrentValue, BackgroundColor.ReadOnly);
        ...
        protected void SetupBreadcrumb() {
            ...
            breadcrumb.Add("list", TableVar, AppPath(AddMasterUrl("CalendarList")), "", TableVar, true);
            string pageId = "edit";
