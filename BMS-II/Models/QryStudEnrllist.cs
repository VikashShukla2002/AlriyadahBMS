...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static QryStudEnrllist qryStudEnrllist
    {
        get => HttpData.Resolve<QryStudEnrllist>("qryStudEnrllist");
        set => HttpData["qryStudEnrllist"] = value;
    }

    /// <summary>
    /// Table class for qryStudEnrllist
    /// </summary>
    public class QryStudEnrllist : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public QryStudEnrllist()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryStudEnrllist";
            Name = "qryStudEnrllist";
            Type = "VIEW";
            UpdateTable = "[BMS_DBT].[dbo].[tblStudentEnrollment]"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            int_Enrollement_Id = new (this, "x_int_Enrollement_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryStudEnrllist", "int_Enrollement_Id", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Package_Id = new (this, "x_int_Package_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryStudEnrllist", "int_Package_Id", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryStudEnrllist", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudEnrllist", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Package_Name = new (this, "x_str_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudEnrllist", "str_Package_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            course = new (this, "x_course", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudEnrllist", "course", "CustomMsg"),
                IsUpload = false
            };
            ...
            institution = new (this, "x_institution", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudEnrllist", "institution", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryStudEnrllist";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "QryStudEnrllistView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryStudEnrllistEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryStudEnrllistAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryStudEnrllistView",
                Config.ApiAddAction => "QryStudEnrllistAdd",
                Config.ApiEditAction => "QryStudEnrllistEdit",
                Config.ApiDeleteAction => "QryStudEnrllistDelete",
                Config.ApiListAction => "QryStudEnrllistList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryStudEnrllistList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryStudEnrllistView", parm);
            else
                url = KeyUrl("QryStudEnrllistView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryStudEnrllistAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryStudEnrllistAdd?" + parm;
            else
                url = "QryStudEnrllistAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryStudEnrllistEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryStudEnrllistList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryStudEnrllistAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryStudEnrllistList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryStudEnrllistDelete")); // DN
        ...
        {
            string pageName = "QryStudEnrllistList";
