...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static TblStudentJourney tblStudentJourney
    {
        get => HttpData.Resolve<TblStudentJourney>("tblStudentJourney");
        set => HttpData["tblStudentJourney"] = value;
    }

    /// <summary>
    /// Table class for tblStudentJourney
    /// </summary>
    public class TblStudentJourney : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> STDJ_ID;

        public readonly DbField<SqlDbType> FullName;

        public readonly DbField<SqlDbType> str_Username;

        public readonly DbField<SqlDbType> Number_ID;

        public readonly DbField<SqlDbType> Journey_ID;

        public readonly DbField<SqlDbType> Journey;

        public readonly DbField<SqlDbType> Start_Date;

        public readonly DbField<SqlDbType> End_Date;

        public readonly DbField<SqlDbType> Total_Days;

        public readonly DbField<SqlDbType> Status;

        public readonly DbField<SqlDbType> Package_Name;

        public readonly DbField<SqlDbType> Product_Name;

        public readonly DbField<SqlDbType> Price;

        // Constructor
        public TblStudentJourney()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "tblStudentJourney";
            Name = "tblStudentJourney";
            Type = "TABLE";
            UpdateTable = "dbo.tblStudentJourney"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // STDJ_ID
            STDJ_ID = new (this, "x_STDJ_ID", 3, SqlDbType.Int) {
                Name = "STDJ_ID",
                Expression = "[STDJ_ID]",
                BasicSearchExpression = "CAST([STDJ_ID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[STDJ_ID]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "STDJ_ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("STDJ_ID", STDJ_ID);
            ...
            FullName = new (this, "x_FullName", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "FullName", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("str_Username", str_Username);

            // Number_ID
            Number_ID = new (this, "x_Number_ID", 3, SqlDbType.Int) {
                Name = "Number_ID",
                Expression = "[Number_ID]",
                BasicSearchExpression = "CAST([Number_ID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[Number_ID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Number_ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Number_ID", Number_ID);

            // Journey_ID
            Journey_ID = new (this, "x_Journey_ID", 3, SqlDbType.Int) {
                Name = "Journey_ID",
                Expression = "[Journey_ID]",
                BasicSearchExpression = "CAST([Journey_ID] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[Journey_ID]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Journey_ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Journey_ID", Journey_ID);

            // Journey
            Journey = new (this, "x_Journey", 202, SqlDbType.NVarChar) {
                Name = "Journey",
                Expression = "[Journey]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Journey]",
                DateTimeFormat = -1,
                VirtualExpression = "[Journey]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Journey", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Journey", Journey);

            // Start_Date
            Start_Date = new (this, "x_Start_Date", 135, SqlDbType.DateTime) {
                Name = "Start_Date",
                Expression = "[Start_Date]",
                BasicSearchExpression = CastDateFieldForLike("[Start_Date]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[Start_Date]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Start_Date", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Start_Date", Start_Date);

            // End_Date
            End_Date = new (this, "x_End_Date", 135, SqlDbType.DateTime) {
                Name = "End_Date",
                Expression = "[End_Date]",
                BasicSearchExpression = CastDateFieldForLike("[End_Date]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[End_Date]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "End_Date", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("End_Date", End_Date);

            // Total_Days
            Total_Days = new (this, "x_Total_Days", 3, SqlDbType.Int) {
                Name = "Total_Days",
                Expression = "[Total_Days]",
                BasicSearchExpression = "CAST([Total_Days] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[Total_Days]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Total_Days", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Total_Days", Total_Days);
            ...
            Status = new (this, "x_Status", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Status", "CustomMsg"),
                IsUpload = false
            };
            ...
            Package_Name = new (this, "x_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Package_Name", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Package_Name", Package_Name);

            // Product_Name
            Product_Name = new (this, "x_Product_Name", 202, SqlDbType.NVarChar) {
                Name = "Product_Name",
                Expression = "[Product_Name]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Product_Name]",
                DateTimeFormat = -1,
                VirtualExpression = "[Product_Name]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Product_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblStudentJourney", "Price", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.tblStudentJourney";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                STDJ_ID.DbValue = row["STDJ_ID"]; // Set DB value only
                FullName.DbValue = row["FullName"]; // Set DB value only
                str_Username.DbValue = row["str_Username"]; // Set DB value only
                Number_ID.DbValue = row["Number_ID"]; // Set DB value only
                Journey_ID.DbValue = row["Journey_ID"]; // Set DB value only
                Journey.DbValue = row["Journey"]; // Set DB value only
                Start_Date.DbValue = row["Start_Date"]; // Set DB value only
                End_Date.DbValue = row["End_Date"]; // Set DB value only
                Total_Days.DbValue = row["Total_Days"]; // Set DB value only
                Status.DbValue = row["Status"]; // Set DB value only
                Package_Name.DbValue = row["Package_Name"]; // Set DB value only
                Product_Name.DbValue = row["Product_Name"]; // Set DB value only
        ...
        private string _sqlKeyFilter => "[STDJ_ID] = @STDJ_ID@";
        ...
        public string GetRecordFilter(Dictionary<string, object>? row = null, bool current = false)
        {
            ...
            val = row?.TryGetValue("STDJ_ID", out result) ?? false
                ? result
                : !Empty(STDJ_ID.OldValue) && !current ? STDJ_ID.OldValue : STDJ_ID.CurrentValue;
            if (!IsNumeric(val))
                return "0=1"; // Invalid key
            if (val == null)
                return "0=1"; // Invalid key
            keyFilter = keyFilter.Replace("@STDJ_ID@", AdjustSql(val, DbId)); // Replace key value
            return keyFilter;
        }
        ...
        public Dictionary<string, object>? GetRowFilterAsDictionary(IDictionary<string, object>? row = null)
        {
            ...
            val = row?.TryGetValue("STDJ_ID", out result) ?? false
                ? result
                : !Empty(STDJ_ID.OldValue) ? STDJ_ID.OldValue : STDJ_ID.CurrentValue;
            if (!IsNumeric(val))
                return null; // Invalid key
            if (Empty(val))
                return null; // Invalid key
            keyFilter.Add("STDJ_ID", val); // Add key value
        ...
        {
            if (SameString(pageName, "TblStudentJourneyView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TblStudentJourneyEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TblStudentJourneyAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TblStudentJourneyView",
                Config.ApiAddAction => "TblStudentJourneyAdd",
                Config.ApiEditAction => "TblStudentJourneyEdit",
                Config.ApiDeleteAction => "TblStudentJourneyDelete",
                Config.ApiListAction => "TblStudentJourneyList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TblStudentJourneyList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TblStudentJourneyView", parm);
            else
                url = KeyUrl("TblStudentJourneyView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TblStudentJourneyAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TblStudentJourneyAdd?" + parm;
            else
                url = "TblStudentJourneyAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TblStudentJourneyEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TblStudentJourneyList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TblStudentJourneyAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TblStudentJourneyList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("TblStudentJourneyDelete")); // DN
        ...
        {
            string json = "";
            json += "\"STDJ_ID\":" + ConvertToJson(STDJ_ID.CurrentValue, "number", true);
            json = "{" + json + "}";
            if (htmlEncode)
        ...
        public string KeyUrl(string url, string parm = "") { // DN
            if (!IsNull(STDJ_ID.CurrentValue)) {
                url += "/" + STDJ_ID.CurrentValue;
            } else {
        ...
        public string GetKey(bool current = false)
        {
            ...
            string val;
            val = current ? ConvertToString(STDJ_ID.CurrentValue) ?? "" : ConvertToString(STDJ_ID.OldValue) ?? "";
            if (Empty(val))
                return String.Empty;
            keys.Add(val);
        ...
        public string GetKey(IDictionary<string, object> row)
        {
            List<string> keys = new ();
            object? val = null, result;
            val = row?.TryGetValue("STDJ_ID", out result) ?? false ? ConvertToString(result) : null;
            if (Empty(val))
        ...
        public void SetKey(string key, bool current = false)
        {
            ...
            if (keys.Length == 1) {
                if (current) {
                    STDJ_ID.CurrentValue = keys[0];
                } else {
                    STDJ_ID.OldValue = keys[0];
                }
            }
        }
        ...
        public List<string> GetRecordKeys()
        {
            ...
            if (Post("key_m[]", out sv) || Get("key_m[]", out sv)) { // DN
                ...
                if (RouteValues.TryGetValue("STDJ_ID", out object? v0)) { // STDJ_ID // DN
                    key = UrlDecode(v0); // DN
        ...
        public string GetFilterFromRecordKeys(bool setCurrent = true)
        {
            ...
            foreach (var keys in recordKeys) {
                if (!Empty(keyFilter))
                    keyFilter += " OR ";
                if (setCurrent)
                    STDJ_ID.CurrentValue = keys;
                else
                    STDJ_ID.OldValue = keys;
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            STDJ_ID.SetDbValue(dr["STDJ_ID"]);
            FullName.SetDbValue(dr["FullName"]);
            str_Username.SetDbValue(dr["str_Username"]);
            Number_ID.SetDbValue(dr["Number_ID"]);
            Journey_ID.SetDbValue(dr["Journey_ID"]);
            Journey.SetDbValue(dr["Journey"]);
            Start_Date.SetDbValue(dr["Start_Date"]);
            End_Date.SetDbValue(dr["End_Date"]);
            Total_Days.SetDbValue(dr["Total_Days"]);
            Status.SetDbValue(dr["Status"]);
            Package_Name.SetDbValue(dr["Package_Name"]);
            Product_Name.SetDbValue(dr["Product_Name"]);
        ...
        {
            string pageName = "TblStudentJourneyList";
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(STDJ_ID);
                        doc.ExportCaption(FullName);
                        doc.ExportCaption(str_Username);
                        doc.ExportCaption(Number_ID);
                        doc.ExportCaption(Journey_ID);
                        doc.ExportCaption(Journey);
                        doc.ExportCaption(Start_Date);
                        doc.ExportCaption(End_Date);
                        doc.ExportCaption(Total_Days);
                        doc.ExportCaption(Status);
                        doc.ExportCaption(Package_Name);
                        doc.ExportCaption(Product_Name);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(STDJ_ID);
                            await doc.ExportField(FullName);
                            await doc.ExportField(str_Username);
                            await doc.ExportField(Number_ID);
                            await doc.ExportField(Journey_ID);
                            await doc.ExportField(Journey);
                            await doc.ExportField(Start_Date);
                            await doc.ExportField(End_Date);
                            await doc.ExportField(Total_Days);
                            await doc.ExportField(Status);
                            await doc.ExportField(Package_Name);
                            await doc.ExportField(Product_Name);
