...
public partial class JUN26 {
    /// <summary>
    /// qryStudentJourneyList
    /// </summary>
    [MaybeNull]
    public static QryStudentJourneyList qryStudentJourneyList
    {
        get => HttpData.Resolve<QryStudentJourneyList>("qryStudentJourneyList");
        set => HttpData["qryStudentJourneyList"] = value;
    }

    /// <summary>
    /// Table class for qryStudentJourneyList
    /// </summary>
    public class QryStudentJourneyList : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Package_No;

        public readonly DbField<SqlDbType> Package_Name;

        public readonly DbField<SqlDbType> Item_No;

        public readonly DbField<SqlDbType> Service_Description;
        ...
        // Constructor
        public QryStudentJourneyList()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryStudentJourneyList";
            Name = "qryStudentJourneyList";
            Type = "VIEW";
            UpdateTable = "dbo.qryStudentJourneyList"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            // Package_No#
            Package_No = new (this, "x_Package_No", 3, SqlDbType.Int) {
                Name = "Package_No#",
                Expression = "[Package_No#]",
                BasicSearchExpression = "CAST([Package_No#] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[Package_No#]",
                IsVirtual = false,
                ...
                CustomMessage = Language.FieldPhrase("qryStudentJourneyList", "Package_No", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Package_No#", Package_No);
            ...
            Package_Name = new (this, "x_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryStudentJourneyList", "Package_Name", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Package_Name", Package_Name);

            // Item_No#
            Item_No = new (this, "x_Item_No", 3, SqlDbType.Int) {
                Name = "Item_No#",
                Expression = "[Item_No#]",
                ...
                CustomMessage = Language.FieldPhrase("qryStudentJourneyList", "Item_No", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Item_No#", Item_No);

            // Service_Description
            Service_Description = new (this, "x_Service_Description", 202, SqlDbType.NVarChar) {
                Name = "Service_Description",
                Expression = "[Service_Description]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Service_Description]",
                DateTimeFormat = -1,
                VirtualExpression = "[Service_Description]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudentJourneyList", "Service_Description", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Service_Description", Service_Description);
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudentJourneyList", "Price", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Price", Price);

            // Journey
            Journey = new (this, "x_Journey", 200, SqlDbType.VarChar) {
                Name = "Journey",
                Expression = "[Journey]",
                UseBasicSearch = true,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudentJourneyList", "Journey", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryStudentJourneyList";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            if (row == null)
                return;
            try {
                Package_No.DbValue = row["Package_No#"]; // Set DB value only
                Package_Name.DbValue = row["Package_Name"]; // Set DB value only
                Item_No.DbValue = row["Item_No#"]; // Set DB value only
                Service_Description.DbValue = row["Service_Description"]; // Set DB value only
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "QryStudentJourneyListList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "QryStudentJourneyListView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryStudentJourneyListEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryStudentJourneyListAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryStudentJourneyListView",
                Config.ApiAddAction => "QryStudentJourneyListAdd",
                Config.ApiEditAction => "QryStudentJourneyListEdit",
                Config.ApiDeleteAction => "QryStudentJourneyListDelete",
                Config.ApiListAction => "QryStudentJourneyListList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryStudentJourneyListList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryStudentJourneyListView", parm);
            else
                url = KeyUrl("QryStudentJourneyListView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryStudentJourneyListAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryStudentJourneyListAdd?" + parm;
            else
                url = "QryStudentJourneyListAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryStudentJourneyListEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryStudentJourneyListList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryStudentJourneyListAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryStudentJourneyListList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryStudentJourneyListDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            Package_No.SetDbValue(dr["Package_No#"]);
            Package_Name.SetDbValue(dr["Package_Name"]);
            Item_No.SetDbValue(dr["Item_No#"]);
            Service_Description.SetDbValue(dr["Service_Description"]);
        ...
        {
            string pageName = "QryStudentJourneyListList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Package_No#
            Package_No.SetupEditAttributes();
            Package_No.EditValue = Package_No.CurrentValue; // DN
            Package_No.PlaceHolder = RemoveHtml(Package_No.Caption);
            if (!Empty(Package_No.EditValue) && IsNumeric(Package_No.EditValue))
                Package_No.EditValue = FormatNumber(Package_No.EditValue, null);
            ...
            if (!Empty(Item_No.EditValue) && IsNumeric(Item_No.EditValue))
                Item_No.EditValue = FormatNumber(Item_No.EditValue, null);

            // Service_Description
            Service_Description.SetupEditAttributes();
            if (!Service_Description.Raw)
                Service_Description.CurrentValue = HtmlDecode(Service_Description.CurrentValue);
            Service_Description.EditValue = HtmlEncode(Service_Description.CurrentValue);
            Service_Description.PlaceHolder = RemoveHtml(Service_Description.Caption);
        ...
        public async Task ExportDocument(dynamic doc, DbDataReader dataReader, int startRec, int stopRec, string exportType = "")
        {
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    doc.BeginExportRow();
                    if (exportType == "view") {
                        doc.ExportCaption(Package_No);
                        doc.ExportCaption(Package_Name);
                        doc.ExportCaption(Item_No);
                        doc.ExportCaption(Service_Description);
            ...
            do { // DN
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            await doc.ExportField(Package_No);
                            await doc.ExportField(Package_Name);
                            await doc.ExportField(Item_No);
                            await doc.ExportField(Service_Description);
