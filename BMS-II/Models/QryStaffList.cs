...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static QryStaffList qryStaffList
    {
        get => HttpData.Resolve<QryStaffList>("qryStaffList");
        set => HttpData["qryStaffList"] = value;
    }

    /// <summary>
    /// Table class for qryStaffList
    /// </summary>
    public class QryStaffList : DbTable, IQueryFactory
    {
        ...
        public QryStaffList()
        {
            ...
            Name = "qryStaffList";
            Type = "VIEW";
            UpdateTable = "[BMS_DBT].[dbo].[tblStaff]"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            int_Staff_Id = new (this, "x_int_Staff_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryStaffList", "int_Staff_Id", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Password = new (this, "x_str_Password", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Password", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_NationalID_Iqama = new (this, "x_str_NationalID_Iqama", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_NationalID_Iqama", "CustomMsg"),
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Full_Name = new (this, "x_str_Full_Name", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Full_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            User_Role = new (this, "x_User_Role", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryStaffList", "User_Role", "CustomMsg"),
                IsUpload = false
            };
            ...
            UserlevelID = new (this, "x_UserlevelID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryStaffList", "UserlevelID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Activated = new (this, "x_Activated", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("qryStaffList", "Activated", "CustomMsg"),
                IsUpload = false
            };
            Activated.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Activated, "qryStaffList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Activated, "qryStaffList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Activated, "qryStaffList", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Supervisor_Username = new (this, "x_Supervisor_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "Supervisor_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Staff_Username = new (this, "x_str_Staff_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Staff_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_First_Name = new (this, "x_str_First_Name", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_First_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Middle_Name = new (this, "x_str_Middle_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Middle_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Last_Name = new (this, "x_str_Last_Name", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Last_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Address = new (this, "x_str_Address", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Address", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_City = new (this, "x_str_City", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_City", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_State = new (this, "x_int_State", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "int_State", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Zip = new (this, "x_str_Zip", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Zip", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Home_Phone = new (this, "x_str_Home_Phone", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Home_Phone", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Cell_Phone = new (this, "x_str_Cell_Phone", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Cell_Phone", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Email = new (this, "x_str_Email", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "str_Email", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Birth = new (this, "x_date_Birth", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "date_Birth", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Birth_Hijri = new (this, "x_date_Birth_Hijri", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "date_Birth_Hijri", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Location = new (this, "x_int_Location", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "int_Location", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Created = new (this, "x_date_Created", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "date_Created", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Modified = new (this, "x_date_Modified", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "date_Modified", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Created_By = new (this, "x_int_Created_By", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "int_Created_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Modified_By = new (this, "x_int_Modified_By", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "int_Modified_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Nationality = new (this, "x_int_Nationality", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "int_Nationality", "CustomMsg"),
                IsUpload = false
            };
            ...
            Hijri_Day = new (this, "x_Hijri_Day", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "Hijri_Day", "CustomMsg"),
                IsUpload = false
            };
            ...
            Hijri_Month = new (this, "x_Hijri_Month", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "Hijri_Month", "CustomMsg"),
                IsUpload = false
            };
            ...
            Hijri_Year = new (this, "x_Hijri_Year", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "Hijri_Year", "CustomMsg"),
                IsUpload = false
            };
            ...
            ProfileField = new (this, "x_ProfileField", 203, SqlDbType.NText) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStaffList", "ProfileField", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "QryStaffListView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryStaffListEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryStaffListAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryStaffListView",
                Config.ApiAddAction => "QryStaffListAdd",
                Config.ApiEditAction => "QryStaffListEdit",
                Config.ApiDeleteAction => "QryStaffListDelete",
                Config.ApiListAction => "QryStaffListList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryStaffListList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryStaffListView", parm);
            else
                url = KeyUrl("QryStaffListView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryStaffListAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryStaffListEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryStaffListList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryStaffListAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryStaffListList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryStaffListDelete")); // DN
        ...
        {
            string pageName = "QryStaffListList";
        ...
        public async Task RenderEditRow()
        {
            ...
            if (!User_Role.Raw)
                User_Role.CurrentValue = HtmlDecode(User_Role.CurrentValue);
            User_Role.EditValue = HtmlEncode(User_Role.CurrentValue);
            ...
            if (!Supervisor_Username.Raw)
                Supervisor_Username.CurrentValue = HtmlDecode(Supervisor_Username.CurrentValue);
            Supervisor_Username.EditValue = HtmlEncode(Supervisor_Username.CurrentValue);
            ...
            Hijri_Day.EditValue = Hijri_Day.CurrentValue; // DN
            ...
            Hijri_Month.EditValue = Hijri_Month.CurrentValue; // DN
            ...
            Hijri_Year.EditValue = Hijri_Year.CurrentValue; // DN
