...
public partial class JUN26 {
    ...
    public class ExportHandler
    {
        ...
        public async Task<IActionResult> ExportData(string exportType, string tableName, string[]? recordKey = null)
        {
            ...
            Security.LoadTablePermissions(tableName);
            ...
            string pageClassName = isReport && (new [] { "summary", "crosstab" }).Contains(reportType) ? pageName + TitleCaseInvariant(reportType) : pageName; // Add Report type to page class name // DN
