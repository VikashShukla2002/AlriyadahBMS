...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static LmsGroups lmsGroups
    {
        get => HttpData.Resolve<LmsGroups>("LMS_Groups");
        set => HttpData["LMS_Groups"] = value;
    }

    /// <summary>
    /// Table class for LMS_Groups
    /// </summary>
    public class LmsGroups : DbTable, IQueryFactory
    {
        ...
        public LmsGroups()
        {
            ...
            Name = "LMS_Groups";
            Type = "VIEW";
            UpdateTable = "dbo.LMS_Groups"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Groups", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            courseid = new (this, "x_courseid", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Groups", "courseid", "CustomMsg"),
                IsUpload = false
            };
            ...
            idnumber = new (this, "x_idnumber", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Groups", "idnumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            _name = new (this, "x__name", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Groups", "_name", "CustomMsg"),
                IsUpload = false
            };
            ...
            description = new (this, "x_description", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Groups", "description", "CustomMsg"),
                IsUpload = false
            };
            ...
            descriptionformat = new (this, "x_descriptionformat", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups", "descriptionformat", "CustomMsg"),
                IsUpload = false
            };
            ...
            enrolmentkey = new (this, "x_enrolmentkey", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("LMS_Groups", "enrolmentkey", "CustomMsg"),
                IsUpload = false
            };
            ...
            picture = new (this, "x_picture", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups", "picture", "CustomMsg"),
                IsUpload = false
            };
            ...
            visibility = new (this, "x_visibility", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups", "visibility", "CustomMsg"),
                IsUpload = false
            };
            ...
            participation = new (this, "x_participation", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups", "participation", "CustomMsg"),
                IsUpload = false
            };
            ...
            timecreated = new (this, "x_timecreated", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups", "timecreated", "CustomMsg"),
                IsUpload = false
            };
            ...
            timemodified = new (this, "x_timemodified", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups", "timemodified", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "LmsGroupsView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "LmsGroupsEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "LmsGroupsAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "LmsGroupsView",
                Config.ApiAddAction => "LmsGroupsAdd",
                Config.ApiEditAction => "LmsGroupsEdit",
                Config.ApiDeleteAction => "LmsGroupsDelete",
                Config.ApiListAction => "LmsGroupsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "LmsGroupsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("LmsGroupsView", parm);
            else
                url = KeyUrl("LmsGroupsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "LmsGroupsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("LmsGroupsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsGroupsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("LmsGroupsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsGroupsList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("LmsGroupsDelete")); // DN
