...
public partial class JUN26 {
    ...
    {
        get => HttpData.Get<CalendarView>("calendarView")!;
        set => HttpData["calendarView"] = value;
    }
    ...
    {
        // Constructor
        public CalendarView(Controller controller) : base(controller)
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class CalendarViewBase : Calendar
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "calendarView";
        ...
        // Page name
        public string PageName => "CalendarView";
        ...
        // Constructor
        public CalendarViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("Id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "CalendarList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("CalendarList"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fCalendarview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
