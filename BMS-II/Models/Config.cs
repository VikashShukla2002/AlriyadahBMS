...
public partial class JUN26 {
    ...
    public static partial class Config
    {
        ...
        // Product version
        public const string ProductVersion = "20.5.0";

        // Project
        public const string ProjectNamespace = "ASPNETMaker2023";

        public const string ProjectClassName = "ASPNETMaker2023.Models.JUN26"; // DN
        ...
        public const string ProjectName = "JUN26"; // Project name

        public static string ControllerName { get; set; } = "Home"; // Controller name // DN

        public const string ProjectId = "{58F886EE-30CC-4C06-BB53-F2D76AC39924}"; // Project ID (GUID)

        public static string RandomKey = "qDbUUob8hhOjN1kd"; // Random key for encryption

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/JUN26.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        public static string SidebarClass = "main-sidebar sidebar-dark-green"; // CSS class(es) for sidebar

        public static string NavbarClass = "main-header navbar navbar-expand navbar-green navbar-dark border-bottom-0"; // CSS class(es) for navbar
        ...
        // Export Log
        public static string ExportPath = "export-58f886ee-30cc-4c06-bb53-f2d76ac39924"; // Export folder
        ...
        public static string AdminPassword = "master"; // Administrator password
        ...
        public static string UserTableName = "tblStudents";

        public static string LoginUsernameFieldName = "str_Username";

        public static string LoginPasswordFieldName = "str_Password";

        public static string UserIdFieldName = "str_Username";

        public static string ParentUserIdFieldName = "Parent_Username";

        public static string UserLevelFieldName = "UserlevelID";

        public static string UserProfileFieldName = "ProfileField";

        public static string RegisterActivateFieldName = "Activated";

        public static string UserEmailFieldName = "str_Email";

        public static string UserPhoneFieldName = "str_Cell_Phone";

        public static string UserImageFieldName = "Absherphoto";
        ...
        public static string UserTable = "dbo.tblStudents";

        public static string UserNameFilter = "([str_Username] = '%u')";

        public static string UserIdFilter = "([str_Username] = '%u')";

        public static string UserEmailFilter = "([str_Email] = '%e')";

        public static string UserActivateFilter = "([Activated] = 1)";
        ...
        public static string SenderEmail = "ajones@ustbanalytics.com"; // Sender email

        public static string RecipientEmail = "jones@alriyadahde.com"; // Recipient email
        ...
        {
            {"tblAppointmentsInfo", typeof(TblAppointmentsInfo)},
            {"Appointment_Cldr", typeof(AppointmentCldr)},
            {"tblBillingInfo", typeof(TblBillingInfo)},
            {"tblClassRoom", typeof(TblClassRoom)},
            {"tblCRAttendance", typeof(TblCrAttendance)},
            {"tblCRSessions", typeof(TblCrSessions)},
            {"tblLocation", typeof(TblLocation)},
            {"tblNationality", typeof(TblNationality)},
            {"tblPackageInfo", typeof(TblPackageInfo)},
            {"tblPotentialStudentInfo", typeof(TblPotentialStudentInfo)},
            {"tblProductInfo", typeof(TblProductInfo)},
            {"tblStudents", typeof(TblStudents)},
            {"tblStudentEnrollment", typeof(TblStudentEnrollment)},
            {"tblAssessment", typeof(TblAssessment)},
            {"tblStaff", typeof(TblStaff)},
            {"UserLevelPermissions", typeof(UserLevelPermissions)},
            {"UserLevels", typeof(UserLevels)},
            {"qryEvalCalcWsht_Results", typeof(QryEvalCalcWshtResults)},
            {"tblEvaluation", typeof(TblEvaluation)},
            {"qryEvalCalcWsht_ResultsMB", typeof(QryEvalCalcWshtResultsMb)},
            {"tblEvaluationMB", typeof(TblEvaluationMb)},
            {"Calendar1", typeof(Calendar1)},
            {"Calendar", typeof(Calendar)},
            {"AuditTrail", typeof(AuditTrail)},
            {"Classroom_Calendar", typeof(ClassroomCalendar)},
            {"Calendar2", typeof(Calendar2)},
            {"qryClassroomCldrList", typeof(QryClassroomCldrList)},
            {"Hijri_Table", typeof(HijriTable)},
            {"qryInvoices", typeof(QryInvoices)},
            {"tblRptMgrInvoices", typeof(TblRptMgrInvoices)},
            {"rptqryInvoiceItemPrices", typeof(RptqryInvoiceItemPrices)},
            {"dshbdClasses", typeof(DshbdClasses)},
            {"Class Status", typeof(ClassStatus)},
            {"Class_Status", typeof(ClassStatus)},
            {"Home-Dashboard", typeof(HomeDashboard)},
            {"Home_Dashboard", typeof(HomeDashboard)},
            {"dshbdAssessment", typeof(DshbdAssessment)},
            {"dshbdAssessmentScore", typeof(DshbdAssessmentScore)},
            {"dshbdRegistered", typeof(DshbdRegistered)},
            {"dshbdAssessmentv1", typeof(DshbdAssessmentv1)},
            {"dshbdPay", typeof(DshbdPay)},
            {"tblOtherWebServices", typeof(TblOtherWebServices)},
            {"Appointment_Calendar", typeof(AppointmentCalendar)},
            {"Billing Status", typeof(BillingStatus)},
            {"Billing_Status", typeof(BillingStatus)},
            {"Assessment Status", typeof(AssessmentStatus)},
            {"Assessment_Status", typeof(AssessmentStatus)},
            {"Registration Status", typeof(RegistrationStatus)},
            {"Registration_Status", typeof(RegistrationStatus)},
            {"Enrollment Status", typeof(EnrollmentStatus)},
            {"Enrollment_Status", typeof(EnrollmentStatus)},
            {"qryAppointmentType", typeof(QryAppointmentType)},
            {"tblStudentJourney", typeof(TblStudentJourney)},
            {"qryStudentJourneyList", typeof(QryStudentJourneyList)},
            {"qryStudentJourneyTitle", typeof(QryStudentJourneyTitle)},
            {"qryStaffList", typeof(QryStaffList)},
            {"qryClassRoomList", typeof(QryClassRoomList)},
            {"qryBillingNames", typeof(QryBillingNames)},
            {"qryBillingDetails_v2", typeof(QryBillingDetailsV2)},
            {"qryStudEnrllist", typeof(QryStudEnrllist)},
            {"Sessions", typeof(Sessions)},
            {"Cities", typeof(Cities)},
            {"Equipment", typeof(Equipment)},
            {"Register", typeof(Register)}, // Lookup for register page // DN
            {"usertable", typeof(TblStudents)},
        };

        // Database IDs // DN
        public static Dictionary<string, string> DbIds = new ()
        {
            {"tblAppointmentsInfo", "DB"},
            {"Appointment_Cldr", "DB"},
            {"tblBillingInfo", "DB"},
            {"tblClassRoom", "DB"},
            {"tblCRAttendance", "DB"},
            ...
            {"tblNationality", "DB"},
            {"tblPackageInfo", "DB"},
            {"tblPotentialStudentInfo", "DB"},
            {"tblProductInfo", "DB"},
            {"tblStudents", "DB"},
            {"tblStudentEnrollment", "DB"},
            {"tblAssessment", "DB"},
            {"tblStaff", "DB"},
            {"UserLevelPermissions", "DB"},
            {"UserLevels", "DB"},
            {"qryEvalCalcWsht_Results", "DB"},
            {"tblEvaluation", "DB"},
            {"qryEvalCalcWsht_ResultsMB", "DB"},
            {"tblEvaluationMB", "DB"},
            {"Calendar1", "DB"},
            {"Calendar", "DB"},
            {"AuditTrail", "DB"},
            {"Classroom_Calendar", "DB"},
            {"Calendar2", "DB"},
            {"qryClassroomCldrList", "DB"},
            {"Hijri_Table", "DB"},
            {"qryInvoices", "DB"},
            {"tblRptMgrInvoices", "DB"},
            {"rptqryInvoiceItemPrices", "DB"},
            {"dshbdClasses", "DB"},
            {"Class Status", "DB"},
            {"Home-Dashboard", "DB"},
            {"dshbdAssessment", "DB"},
            {"dshbdAssessmentScore", "DB"},
            {"dshbdRegistered", "DB"},
            {"dshbdAssessmentv1", "DB"},
            {"dshbdPay", "DB"},
            {"tblOtherWebServices", "DB"},
            {"Appointment_Calendar", "DB"},
            {"Billing Status", "DB"},
            {"Assessment Status", "DB"},
            {"Registration Status", "DB"},
            {"Enrollment Status", "DB"},
            {"qryAppointmentType", "DB"},
            {"tblStudentJourney", "DB"},
            {"qryStudentJourneyList", "DB"},
            {"qryStudentJourneyTitle", "DB"},
            {"qryStaffList", "DB"},
            {"qryClassRoomList", "DB"},
            {"qryBillingNames", "DB"},
            {"qryBillingDetails_v2", "DB"},
            {"qryStudEnrllist", "DB"},
            {"Sessions", "DB"},
            {"Cities", "DB"},
            {"Equipment", "DB"},
        ...
        {
            new object[] { 33, "mci_Schedules,_Classes_&_Attendance", "33", "", -1, "", true, true, true, "Class & Attendance", "", true, false },
            new object[] { 17, "mi_tblClassRoom", "17", "TblClassRoomList", 33, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblClassRoom", false, false, "Classrooms", "", true, false },
            new object[] { 62, "mi_Classroom_Calendar", "62", "ClassroomCalendar", 33, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Classroom_Calendar", false, false, "", "", true, false },
            new object[] { 16, "mi_tblCRSessions", "16", "TblCrSessionsList", 33, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblCRSessions", false, false, "Sessions", "", true, false },
            new object[] { 2, "mi_tblCRAttendance", "2", "TblCrAttendanceList", 33, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblCRAttendance", false, false, "Attendance", "", true, false },
            new object[] { 205, "mci_Appointments", "205", "", -1, "", true, true, true, "", "", true, false },
            new object[] { 141, "mi_Appointment_Calendar", "141", "AppointmentCalendar", 205, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Appointment_Calendar", false, false, "", "", true, false },
            new object[] { 140, "mi_Appointment_Cldr", "140", "AppointmentCldrList", 205, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Appointment_Cldr", false, false, "", "", true, false },
            new object[] { 34, "mci_Product_Offerings", "34", "", -1, "", true, true, true, "Product Offerings", "", true, false },
            new object[] { 15, "mi_tblPackageInfo", "15", "TblPackageInfoList", 34, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblPackageInfo", false, false, "Packages", "", true, false },
            new object[] { 19, "mi_tblProductInfo", "19", "TblProductInfoList", 15, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblProductInfo", false, false, "Products", "", true, false },
            new object[] { 53, "mci_References", "53", "", -1, "", true, true, true, "References", "", true, false },
            new object[] { 14, "mi_tblNationality", "14", "TblNationalityList", 53, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblNationality", false, false, "Nationality", "", true, false },
            new object[] { 13, "mi_tblLocation", "13", "TblLocationList", 53, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblLocation", false, false, "Location", "", true, false },
            new object[] { 300, "mi_Equipment", "300", "EquipmentList", 53, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Equipment", false, false, "", "", true, false },
            new object[] { 54, "mci_Management", "54", "", -1, "", true, true, true, "Management", "", true, false },
            new object[] { 5, "mi_tblStaff", "5", "TblStaffList", 54, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblStaff", false, false, "Staff", "", true, false },
            new object[] { 9, "mi_UserLevelPermissions", "9", "UserLevelPermissionsList", 54, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}UserLevelPermissions", false, false, "", "", true, false },
            new object[] { 10, "mi_UserLevels", "10", "UserLevelsList", 54, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}UserLevels", false, false, "", "", true, false },
            new object[] { 60, "mi_AuditTrail", "60", "AuditTrailList", 54, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}AuditTrail", false, false, "", "", true, false },
            new object[] { 291, "mci_Reporting_Manager", "291", "http://bmstest.alriyadahbms.com:80/Reports_BMSIIRPTS?/ParamValue&rs:Command=Render&rs:Format=HTML4.0&rc:Toolbar=false&dsu:BMS_DBT=DSAccountant&dsp:BMS_DBT=Cf369y004", 54, "", false, false, true, "Report Manager", "", true, false }
        };

        // Menu items // DN
        public static List<object[]> MenuItems = new ()
        {
            new object[] { 32, "mci_Students", "32", "", -1, "", true, true, true, "Students", "", false, true },
            new object[] { 4, "mi_tblStudents", "4", "TblStudentsList", -1, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblStudents", false, false, "Student Registration", "", false, true },
            new object[] { 3, "mi_tblAssessment", "3", "TblAssessmentList?cmd=resetall", 4, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblAssessment", false, false, "Assessment", "", false, true },
            new object[] { 56, "mi_tblEvaluation", "56", "TblEvaluationList?cmd=resetall", 3, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblEvaluation", false, false, "Assessment Evaluation", "", false, true },
            new object[] { 57, "mi_tblEvaluationMB", "57", "TblEvaluationMbList?cmd=resetall", 3, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblEvaluationMB", false, false, "Assessment Evaluation - Motorbike", "", false, true },
            new object[] { 59, "mi_Calendar1", "59", "Calendar1", 4, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Calendar1", false, false, "Assessment Calendar", "", false, true },
            new object[] { 1, "mi_tblPotentialStudentInfo", "1", "TblPotentialStudentInfoList", -1, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblPotentialStudentInfo", false, false, "Student Information", "", false, true },
            new object[] { 18, "mi_tblBillingInfo", "18", "TblBillingInfoList?cmd=resetall", -1, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblBillingInfo", false, false, "Payments", "", false, true },
            new object[] { 20, "mi_tblStudentEnrollment", "20", "TblStudentEnrollmentList?cmd=resetall", -1, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblStudentEnrollment", false, false, "Student Enrollment", "", false, true },
            new object[] { 98, "mci_Reports", "98", "", -1, "", false, true, true, "", "", false, true },
            new object[] { 66, "mi_tblRptMgrInvoices", "66", "TblRptMgrInvoicesList", 98, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblRptMgrInvoices", false, false, "Invoices", "", false, true },
            new object[] { 136, "mi_tblOtherWebServices", "136", "TblOtherWebServicesList", 98, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblOtherWebServices", false, false, "", "", false, true },
            new object[] { 33, "mci_Schedules,_Classes_&_Attendance", "33", "", -1, "", true, true, true, "Class & Attendance", "", true, true },
            new object[] { 17, "mi_tblClassRoom", "17", "TblClassRoomList", 33, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblClassRoom", false, false, "Classrooms", "", true, true },
            new object[] { 62, "mi_Classroom_Calendar", "62", "ClassroomCalendar", 33, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Classroom_Calendar", false, false, "", "", true, true },
            new object[] { 16, "mi_tblCRSessions", "16", "TblCrSessionsList", 33, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblCRSessions", false, false, "Sessions", "", true, true },
            new object[] { 2, "mi_tblCRAttendance", "2", "TblCrAttendanceList", 33, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblCRAttendance", false, false, "Attendance", "", true, true },
            new object[] { 205, "mci_Appointments", "205", "", -1, "", true, true, true, "", "", true, true },
            new object[] { 141, "mi_Appointment_Calendar", "141", "AppointmentCalendar", 205, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Appointment_Calendar", false, false, "", "", true, true },
            new object[] { 140, "mi_Appointment_Cldr", "140", "AppointmentCldrList", 205, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Appointment_Cldr", false, false, "", "", true, true },
            new object[] { 34, "mci_Product_Offerings", "34", "", -1, "", true, true, true, "Product Offerings", "", true, true },
            new object[] { 15, "mi_tblPackageInfo", "15", "TblPackageInfoList", 34, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblPackageInfo", false, false, "Packages", "", true, true },
            new object[] { 19, "mi_tblProductInfo", "19", "TblProductInfoList", 15, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblProductInfo", false, false, "Products", "", true, true },
            new object[] { 53, "mci_References", "53", "", -1, "", true, true, true, "References", "", true, true },
            new object[] { 14, "mi_tblNationality", "14", "TblNationalityList", 53, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblNationality", false, false, "Nationality", "", true, true },
            new object[] { 13, "mi_tblLocation", "13", "TblLocationList", 53, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblLocation", false, false, "Location", "", true, true },
            new object[] { 300, "mi_Equipment", "300", "EquipmentList", 53, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}Equipment", false, false, "", "", true, true },
            new object[] { 54, "mci_Management", "54", "", -1, "", true, true, true, "Management", "", true, true },
            new object[] { 5, "mi_tblStaff", "5", "TblStaffList", 54, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}tblStaff", false, false, "Staff", "", true, true },
            new object[] { 9, "mi_UserLevelPermissions", "9", "UserLevelPermissionsList", 54, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}UserLevelPermissions", false, false, "", "", true, true },
            new object[] { 10, "mi_UserLevels", "10", "UserLevelsList", 54, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}UserLevels", false, false, "", "", true, true },
            new object[] { 60, "mi_AuditTrail", "60", "AuditTrailList", 54, "", "{58F886EE-30CC-4C06-BB53-F2D76AC39924}AuditTrail", false, false, "", "", true, true },
            new object[] { 291, "mci_Reporting_Manager", "291", "http://bmstest.alriyadahbms.com:80/Reports_BMSIIRPTS?/ParamValue&rs:Command=Render&rs:Format=HTML4.0&rc:Toolbar=false&dsu:BMS_DBT=DSAccountant&dsp:BMS_DBT=Cf369y004", 54, "", false, false, true, "Report Manager", "", true, true }
        };
