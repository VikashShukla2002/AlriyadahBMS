...
public partial class JUN26 {
    /// <summary>
    /// qryClassroomCldrList
    /// </summary>
    [MaybeNull]
    public static QryClassroomCldrList qryClassroomCldrList
    {
        get => HttpData.Resolve<QryClassroomCldrList>("qryClassroomCldrList");
        set => HttpData["qryClassroomCldrList"] = value;
    }

    /// <summary>
    /// Table class for qryClassroomCldrList
    /// </summary>
    public class QryClassroomCldrList : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public QryClassroomCldrList()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryClassroomCldrList";
            Name = "qryClassroomCldrList";
            Type = "VIEW";
            UpdateTable = "[BMS_DBT].[dbo].[Calendar2]"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            _Title = new (this, "x__Title", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("qryClassroomCldrList", "_Title", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryClassroomCldrList";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "QryClassroomCldrListList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "QryClassroomCldrListView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryClassroomCldrListEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryClassroomCldrListAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryClassroomCldrListView",
                Config.ApiAddAction => "QryClassroomCldrListAdd",
                Config.ApiEditAction => "QryClassroomCldrListEdit",
                Config.ApiDeleteAction => "QryClassroomCldrListDelete",
                Config.ApiListAction => "QryClassroomCldrListList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryClassroomCldrListList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryClassroomCldrListView", parm);
            else
                url = KeyUrl("QryClassroomCldrListView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryClassroomCldrListAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryClassroomCldrListAdd?" + parm;
            else
                url = "QryClassroomCldrListAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryClassroomCldrListEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryClassroomCldrListList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryClassroomCldrListAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryClassroomCldrListList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryClassroomCldrListDelete")); // DN
        ...
        {
            string pageName = "QryClassroomCldrListList";
