...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static LmsGroupsV2 lmsGroupsV2
    {
        get => HttpData.Resolve<LmsGroupsV2>("LMS_Groups_v2");
        set => HttpData["LMS_Groups_v2"] = value;
    }

    /// <summary>
    /// Table class for LMS_Groups_v2
    /// </summary>
    public class LmsGroupsV2 : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> coursename;
        ...
        public readonly DbField<SqlDbType> enrolmentkey;

        public readonly DbField<SqlDbType> picture;

        public readonly DbField<SqlDbType> visibility;

        public readonly DbField<SqlDbType> participation;
        ...
        public LmsGroupsV2()
        {
            ...
            TableVar = "LMS_Groups_v2";
            Name = "LMS_Groups_v2";
            Type = "VIEW";
            UpdateTable = "dbo.LMS_Groups_v2"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            courseid = new (this, "x_courseid", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "courseid", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("courseid", courseid);

            // coursename
            coursename = new (this, "x_coursename", 202, SqlDbType.NVarChar) {
                Name = "coursename",
                Expression = "[coursename]",
                UseBasicSearch = true,
                BasicSearchExpression = "[coursename]",
                DateTimeFormat = -1,
                VirtualExpression = "[coursename]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "coursename", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("coursename", coursename);
            ...
            idnumber = new (this, "x_idnumber", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "idnumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            _name = new (this, "x__name", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "_name", "CustomMsg"),
                IsUpload = false
            };
            ...
            description = new (this, "x_description", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "description", "CustomMsg"),
                IsUpload = false
            };
            ...
            descriptionformat = new (this, "x_descriptionformat", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "descriptionformat", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("descriptionformat", descriptionformat);

            // enrolmentkey
            enrolmentkey = new (this, "x_enrolmentkey", 200, SqlDbType.VarChar) {
                Name = "enrolmentkey",
                Expression = "[enrolmentkey]",
                UseBasicSearch = true,
                BasicSearchExpression = "[enrolmentkey]",
                DateTimeFormat = -1,
                VirtualExpression = "[enrolmentkey]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "enrolmentkey", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("enrolmentkey", enrolmentkey);
            ...
            picture = new (this, "x_picture", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "picture", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("picture", picture);

            // visibility
            visibility = new (this, "x_visibility", 131, SqlDbType.Decimal) {
                Name = "visibility",
                Expression = "[visibility]",
                BasicSearchExpression = "CAST([visibility] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[visibility]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "visibility", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("visibility", visibility);

            // participation
            participation = new (this, "x_participation", 131, SqlDbType.Decimal) {
                Name = "participation",
                Expression = "[participation]",
                BasicSearchExpression = "CAST([participation] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[participation]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "participation", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("participation", participation);
            ...
            timecreated = new (this, "x_timecreated", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "timecreated", "CustomMsg"),
                IsUpload = false
            };
            ...
            timemodified = new (this, "x_timemodified", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("LMS_Groups_v2", "timemodified", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.LMS_Groups_v2";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                coursename.DbValue = row["coursename"]; // Set DB value only
                ...
                enrolmentkey.DbValue = row["enrolmentkey"]; // Set DB value only
                picture.DbValue = row["picture"]; // Set DB value only
                visibility.DbValue = row["visibility"]; // Set DB value only
                participation.DbValue = row["participation"]; // Set DB value only
        ...
        {
            if (SameString(pageName, "LmsGroupsV2View"))
                return Language.Phrase("View");
            else if (SameString(pageName, "LmsGroupsV2Edit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "LmsGroupsV2Add"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "LmsGroupsV2View",
                Config.ApiAddAction => "LmsGroupsV2Add",
                Config.ApiEditAction => "LmsGroupsV2Edit",
                Config.ApiDeleteAction => "LmsGroupsV2Delete",
                Config.ApiListAction => "LmsGroupsV2List",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "LmsGroupsV2List";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("LmsGroupsV2View", parm);
            else
                url = KeyUrl("LmsGroupsV2View", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "LmsGroupsV2Add";
        ...
        {
            string url = "";
            url = KeyUrl("LmsGroupsV2Edit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsGroupsV2List", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("LmsGroupsV2Add", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsGroupsV2List", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("LmsGroupsV2Delete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            coursename.SetDbValue(dr["coursename"]);
            ...
            enrolmentkey.SetDbValue(dr["enrolmentkey"]);
            picture.SetDbValue(dr["picture"]);
            visibility.SetDbValue(dr["visibility"]);
            participation.SetDbValue(dr["participation"]);
        ...
        {
            string pageName = "LmsGroupsV2List";
        ...
        public async Task RenderListRow()
        {
            ...
            // coursename
            coursename.ViewValue = ConvertToString(coursename.CurrentValue); // DN
            coursename.ViewCustomAttributes = "";
            ...
            // enrolmentkey
            enrolmentkey.ViewValue = ConvertToString(enrolmentkey.CurrentValue); // DN
            enrolmentkey.ViewCustomAttributes = "";
            ...
            // visibility
            visibility.ViewValue = visibility.CurrentValue;
            visibility.ViewValue = FormatNumber(visibility.ViewValue, visibility.FormatPattern);
            visibility.ViewCustomAttributes = "";

            // participation
            participation.ViewValue = participation.CurrentValue;
            participation.ViewValue = FormatNumber(participation.ViewValue, participation.FormatPattern);
            participation.ViewCustomAttributes = "";
            ...
            // coursename
            coursename.HrefValue = "";
            coursename.TooltipValue = "";
            ...
            // enrolmentkey
            enrolmentkey.HrefValue = "";
            enrolmentkey.TooltipValue = "";
            ...
            // visibility
            visibility.HrefValue = "";
            visibility.TooltipValue = "";

            // participation
            participation.HrefValue = "";
            participation.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // coursename
            coursename.SetupEditAttributes();
            if (!coursename.Raw)
                coursename.CurrentValue = HtmlDecode(coursename.CurrentValue);
            coursename.EditValue = HtmlEncode(coursename.CurrentValue);
            coursename.PlaceHolder = RemoveHtml(coursename.Caption);
            ...
            // enrolmentkey
            enrolmentkey.SetupEditAttributes();
            if (!enrolmentkey.Raw)
                enrolmentkey.CurrentValue = HtmlDecode(enrolmentkey.CurrentValue);
            enrolmentkey.EditValue = HtmlEncode(enrolmentkey.CurrentValue);
            enrolmentkey.PlaceHolder = RemoveHtml(enrolmentkey.Caption);
            ...
            // visibility
            visibility.SetupEditAttributes();
            visibility.EditValue = visibility.CurrentValue; // DN
            visibility.PlaceHolder = RemoveHtml(visibility.Caption);
            if (!Empty(visibility.EditValue) && IsNumeric(visibility.EditValue))
                visibility.EditValue = FormatNumber(visibility.EditValue, null);

            // participation
            participation.SetupEditAttributes();
            participation.EditValue = participation.CurrentValue; // DN
            participation.PlaceHolder = RemoveHtml(participation.Caption);
            if (!Empty(participation.EditValue) && IsNumeric(participation.EditValue))
                participation.EditValue = FormatNumber(participation.EditValue, null);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(coursename);
                            ...
                            await doc.ExportField(enrolmentkey);
                            await doc.ExportField(picture);
                            await doc.ExportField(visibility);
                            await doc.ExportField(participation);
