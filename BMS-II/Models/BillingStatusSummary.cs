...
public partial class JUN26 {
    ...
    /// </summary>
    public static BillingStatusSummary billingStatusSummary
    {
        get => HttpData.Get<BillingStatusSummary>("billingStatusSummary")!;
        set => HttpData["billingStatusSummary"] = value;
    }

    /// <summary>
    /// Page class for Billing Status
    /// </summary>
    public class BillingStatusSummary : BillingStatusSummaryBase
    {
        // Constructor
        public BillingStatusSummary(Controller controller) : base(controller)
        {
        }

        // Constructor
        public BillingStatusSummary() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class BillingStatusSummaryBase : BillingStatus
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "Billing Status";

        // Page object name
        public string PageObjName = "billingStatusSummary";
        ...
        // Constructor
        public BillingStatusSummaryBase()
        {
            ...
            // Table object (billingStatus)
            if (billingStatus == null || billingStatus is BillingStatus)
                billingStatus = this;
        ...
        // Page name
        public string PageName => "BillingStatus";
        ...
        // Constructor
        public BillingStatusSummaryBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run() {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                billingStatusSummary?.PageRender();
            }
        ...
        public void LoadRowValues(Dictionary<string, object> record)
        {
            ...
            data["int_Payment_Method"] = record["int_Payment_Method"];
            data["int_Student_ID"] = record["int_Student_ID"];
            data["str_ApprovalCode"] = record["str_ApprovalCode"];
            data["NationalID"] = record["NationalID"];
            data["AmountPaid"] = record["Amount Paid"];
            data["Price"] = record["Price"];
            data["date_Paid"] = record["date_Paid"];
            Rows.Add(data);
            str_Username.SetDbValue(GroupValue(str_Username, record["str_Username"]));
            int_Payment_Method.SetDbValue(record["int_Payment_Method"]);
            int_Student_ID.SetDbValue(record["int_Student_ID"]);
            str_ApprovalCode.SetDbValue(record["str_ApprovalCode"]);
            NationalID.SetDbValue(record["NationalID"]);
            AmountPaid.SetDbValue(record["Amount Paid"]);
            Price.SetDbValue(record["Price"]);
            date_Paid.SetDbValue(record["date_Paid"]);
        }
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.Search) { // Search row
                ...
                if (RowTotalType == RowSummary.Group && RowGroupLevel >= 2)
                    RowAttrs["data-group-2"] = ConvertToString(date_Paid.GroupValue); // Set up group attribute 2
                if (RowTotalType == RowSummary.Group && RowGroupLevel >= 3)
                    RowAttrs["data-group-3"] = ConvertToString(str_ApprovalCode.GroupValue); // Set up group attribute 3
                ...
                // date_Paid
                date_Paid.GroupViewValue = date_Paid.GroupValue;
                date_Paid.GroupViewValue = FormatDateTime(date_Paid.GroupViewValue, date_Paid.FormatPattern);
                date_Paid.CellCssClass = (RowGroupLevel == 2 ? "ew-rpt-grp-summary-2" : "ew-rpt-grp-field-2");
                date_Paid.ViewCustomAttributes = "";
                date_Paid.GroupViewValue = DisplayGroupValue(date_Paid, date_Paid.GroupViewValue);
                if (!date_Paid.LevelBreak) {
                    if (date_Paid.ShowCompactSummaryFooter)
                        date_Paid.GroupViewValue = "&nbsp;";
                } else
                    date_Paid.LevelBreak = false;

                // str_ApprovalCode
                str_ApprovalCode.GroupViewValue = ConvertToString(str_ApprovalCode.GroupValue); // DN
                str_ApprovalCode.CellCssClass = (RowGroupLevel == 3 ? "ew-rpt-grp-summary-3" : "ew-rpt-grp-field-3");
                str_ApprovalCode.ViewCustomAttributes = "";
                str_ApprovalCode.GroupViewValue = DisplayGroupValue(str_ApprovalCode, str_ApprovalCode.GroupViewValue);
                if (!str_ApprovalCode.LevelBreak) {
                    if (str_ApprovalCode.ShowCompactSummaryFooter)
                        str_ApprovalCode.GroupViewValue = "&nbsp;";
                } else
                    str_ApprovalCode.LevelBreak = false;
                ...
                date_Paid.GroupViewValue = date_Paid.GroupValue;
                date_Paid.GroupViewValue = FormatDateTime(date_Paid.GroupViewValue, date_Paid.FormatPattern);
                date_Paid.CellCssClass = "ew-rpt-grp-field-2";
                date_Paid.ViewCustomAttributes = "";
                date_Paid.GroupViewValue = DisplayGroupValue(date_Paid, date_Paid.GroupViewValue);
                if (!date_Paid.LevelBreak)
                    date_Paid.GroupViewValue = "&nbsp;";
                ...
                // str_ApprovalCode
                str_ApprovalCode.GroupViewValue = ConvertToString(str_ApprovalCode.GroupValue); // DN
                str_ApprovalCode.CellCssClass = "ew-rpt-grp-field-3";
                str_ApprovalCode.ViewCustomAttributes = "";
                str_ApprovalCode.GroupViewValue = DisplayGroupValue(str_ApprovalCode, str_ApprovalCode.GroupViewValue);
                if (!str_ApprovalCode.LevelBreak)
                    str_ApprovalCode.GroupViewValue = "&nbsp;";
            ...
            if (RowType == RowType.Total) {
                ...
                // date_Paid
                CellRendered(date_Paid, date_Paid.GroupViewValue, ref date_Paid.GroupViewValue, date_Paid.ViewAttrs, date_Paid.CellAttrs, ref date_Paid.HrefValue, date_Paid.LinkAttrs);

                // str_ApprovalCode
                CellRendered(str_ApprovalCode, str_ApprovalCode.GroupViewValue, ref str_ApprovalCode.GroupViewValue, str_ApprovalCode.ViewAttrs, str_ApprovalCode.CellAttrs, ref str_ApprovalCode.HrefValue, str_ApprovalCode.LinkAttrs);
                ...
                // date_Paid
                CellRendered(date_Paid, date_Paid.CurrentValue, ref date_Paid.ViewValue, date_Paid.ViewAttrs, date_Paid.CellAttrs, ref date_Paid.HrefValue, date_Paid.LinkAttrs);

                // str_ApprovalCode
                CellRendered(str_ApprovalCode, str_ApprovalCode.CurrentValue, ref str_ApprovalCode.ViewValue, str_ApprovalCode.ViewAttrs, str_ApprovalCode.CellAttrs, ref str_ApprovalCode.HrefValue, str_ApprovalCode.LinkAttrs);
        ...
        public void SetupFieldCount()
        {
            ...
            if (str_Username.Visible)
                GroupColumnCount++;
            if (date_Paid.Visible) {
                GroupColumnCount++;
                SubGroupColumnCount++;
            }
            if (str_ApprovalCode.Visible) {
                GroupColumnCount++;
                SubGroupColumnCount++;
            }
            if (Price.Visible)
        ...
        public void SetupOtherOptions()
        {
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fBilling_Statussrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fBilling_Statussrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = false;
