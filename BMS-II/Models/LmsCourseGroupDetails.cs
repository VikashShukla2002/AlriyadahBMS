...
public partial class JUN26 {
    /// <summary>
    /// lmsCourseGroupDetails
    /// </summary>
    [MaybeNull]
    public static LmsCourseGroupDetails lmsCourseGroupDetails
    {
        get => HttpData.Resolve<LmsCourseGroupDetails>("LMS_Course_Group_Details");
        set => HttpData["LMS_Course_Group_Details"] = value;
    }

    /// <summary>
    /// Table class for LMS_Course_Group_Details
    /// </summary>
    public class LmsCourseGroupDetails : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public LmsCourseGroupDetails()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "LMS_Course_Group_Details";
            Name = "LMS_Course_Group_Details";
            Type = "VIEW";
            UpdateTable = "dbo.LMS_Course_Group_Details"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            id = new (this, "x_id", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Group_Details", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            fullname = new (this, "x_fullname", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("LMS_Course_Group_Details", "fullname", "CustomMsg"),
                IsUpload = false
            };
            ...
            shortname = new (this, "x_shortname", 202, SqlDbType.NVarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Group_Details", "shortname", "CustomMsg"),
                IsUpload = false
            };
            ...
            idnumber = new (this, "x_idnumber", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Group_Details", "idnumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            _name = new (this, "x__name", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("LMS_Course_Group_Details", "_name", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.LMS_Course_Group_Details";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "LmsCourseGroupDetailsList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "LmsCourseGroupDetailsView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "LmsCourseGroupDetailsEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "LmsCourseGroupDetailsAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "LmsCourseGroupDetailsView",
                Config.ApiAddAction => "LmsCourseGroupDetailsAdd",
                Config.ApiEditAction => "LmsCourseGroupDetailsEdit",
                Config.ApiDeleteAction => "LmsCourseGroupDetailsDelete",
                Config.ApiListAction => "LmsCourseGroupDetailsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "LmsCourseGroupDetailsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("LmsCourseGroupDetailsView", parm);
            else
                url = KeyUrl("LmsCourseGroupDetailsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "LmsCourseGroupDetailsAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "LmsCourseGroupDetailsAdd?" + parm;
            else
                url = "LmsCourseGroupDetailsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("LmsCourseGroupDetailsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsCourseGroupDetailsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("LmsCourseGroupDetailsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("LmsCourseGroupDetailsList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("LmsCourseGroupDetailsDelete")); // DN
        ...
        {
            string pageName = "LmsCourseGroupDetailsList";
