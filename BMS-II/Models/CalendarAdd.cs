...
public partial class JUN26 {
    ...
    /// calendarAdd
    /// </summary>
    public static CalendarAdd calendarAdd
    {
        get => HttpData.Get<CalendarAdd>("calendarAdd")!;
        set => HttpData["calendarAdd"] = value;
    }

    /// <summary>
    /// Page class for Calendar
    /// </summary>
    public class CalendarAdd : CalendarAddBase
    {
        // Constructor
        public CalendarAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CalendarAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CalendarAddBase : Calendar
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "calendarAdd";
        ...
        // Page name
        public string PageName => "CalendarAdd";
        ...
        // Constructor
        public CalendarAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("CalendarList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "CalendarView")
        ...
        protected async Task<JsonBoolResult> AddRow(Dictionary<string, object>? rsold = null) { // DN
            ...
            try {
                ...
                // BackgroundColor
                BackgroundColor.SetDbValue(rsnew, BackgroundColor.CurrentValue);
            } catch (Exception e) {
                if (Config.Debug)
                    throw;
