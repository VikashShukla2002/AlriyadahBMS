...
public partial class JUN26 {
    ...
    public class PersonalDataBase : AspNetMakerPage
    {
        ...
        protected async Task<IActionResult> PersonalDataResult() {
            ...
            var fldNames = new string[] {"str_First_Name", "str_Middle_Name", "str_Last_Name", "str_Cell_Phone", "str_Email", "str_Password", "Hijri_Year", "Hijri_Month", "Hijri_Day", "str_Emergency_Contact_Name", "str_Emergency_Contact_Phone", "str_Emergency_Contact_Relation", "str_NationalID_Iqama", "IsDrivingexperience", "intDrivinglicenseType", "AbsherApptNbr", "Absherphoto"};
