...
public partial class JUN26 {
    /// <summary>
    /// tblAssessmentPreview
    /// </summary>
    public static TblAssessmentPreview tblAssessmentPreview
    {
        get => HttpData.Get<TblAssessmentPreview>("tblAssessmentPreview")!;
        set => HttpData["tblAssessmentPreview"] = value;
    }

    /// <summary>
    /// Page class for tblAssessment
    /// </summary>
    public class TblAssessmentPreview : TblAssessmentPreviewBase
    {
        // Constructor
        public TblAssessmentPreview(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblAssessmentPreview() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TblAssessmentPreviewBase : TblAssessment
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblAssessmentPreview";
        ...
        // Constructor
        public TblAssessmentPreviewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TblAssessmentPreview";
        ...
        // Constructor
        public TblAssessmentPreviewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void HideFieldsForAddEdit() {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                tblAssessmentPreview?.PageRender();
            }
                return PageResult();
            }
            ...
            protected string MasterKeyUrl() {
                ...
                if (masterTblVar == "tblStudents") {
                    url = "" + Config.TableShowMaster + "=tblStudents&" + ForeignKeyUrl("fk_str_Username", str_Username.QueryValue) + "";
                }
                return url;
            }
            ...
            protected void SetupForeignKeys(string[] keys) {
                ...
                if (masterTblVar == "tblStudents") {
         		        str_Username.QueryValue = keys.ElementAtOrDefault(0);
                }
            }
