...
public partial class JUN26 {
    ...
    /// calendar2View
    /// </summary>
    public static Calendar2View calendar2View
    {
        get => HttpData.Get<Calendar2View>("calendar2View")!;
        set => HttpData["calendar2View"] = value;
    }

    /// <summary>
    /// Page class for Calendar2
    /// </summary>
    public class Calendar2View : Calendar2ViewBase
    {
        // Constructor
        public Calendar2View(Controller controller) : base(controller)
        {
        }

        // Constructor
        public Calendar2View() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class Calendar2ViewBase : Calendar2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "calendar2View";
        ...
        // Page name
        public string PageName => "Calendar2View";
        ...
        // Constructor
        public Calendar2ViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("Id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "Calendar2List"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("Calendar2List"); // Return to list page
                            }
                        }
                    break;
            }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fCalendar2view\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
