...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static TblEvaluationMb tblEvaluationMb
    {
        get => HttpData.Resolve<TblEvaluationMb>("tblEvaluationMB");
        set => HttpData["tblEvaluationMB"] = value;
    }

    /// <summary>
    /// Table class for tblEvaluationMB
    /// </summary>
    public class TblEvaluationMb : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public TblEvaluationMb()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "tblEvaluationMB";
            Name = "tblEvaluationMB";
            Type = "TABLE";
            UpdateTable = "dbo.tblEvaluationMB"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Eval_ID = new (this, "x_Eval_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Eval_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Student_ID = new (this, "x_int_Student_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "int_Student_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            AssessmentID = new (this, "x_AssessmentID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "AssessmentID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Full_Name_Hdr = new (this, "x_str_Full_Name_Hdr", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "str_Full_Name_Hdr", "CustomMsg"),
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Cell_Phone = new (this, "x_str_Cell_Phone", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "str_Cell_Phone", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            intDrivinglicenseType = new (this, "x_intDrivinglicenseType", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "intDrivinglicenseType", "CustomMsg"),
                IsUpload = false
            };
            ...
            Date_Entered = new (this, "x_Date_Entered", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Date_Entered", "CustomMsg"),
                IsUpload = false
            };
            ...
            Examination_Number = new (this, "x_Examination_Number", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Examination_Number", "CustomMsg"),
                IsUpload = false
            };
            ...
            Retake = new (this, "x_Retake", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Retake", "CustomMsg"),
                IsUpload = false
            };
            Retake.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Retake, "tblEvaluationMB", true, "Retake", new List<string> {"Retake", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Retake, "tblEvaluationMB", true, "Retake", new List<string> {"Retake", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Retake, "tblEvaluationMB", true, "Retake", new List<string> {"Retake", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Section_1 = new (this, "x_Section_1", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_1", "CustomMsg"),
                IsUpload = false
            };
            ...
            Q1 = new (this, "x_Q1", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q1", "CustomMsg"),
                IsUpload = false
            };
            Q1.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q1, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q1, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q1, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q1", Q1);
            ...
            Q2 = new (this, "x_Q2", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q2", "CustomMsg"),
                IsUpload = false
            };
            Q2.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q2, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q2, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q2, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q2", Q2);
            ...
            Q3 = new (this, "x_Q3", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q3", "CustomMsg"),
                IsUpload = false
            };
            Q3.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q3, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q3, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q3, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q3", Q3);
            ...
            Q4 = new (this, "x_Q4", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q4", "CustomMsg"),
                IsUpload = false
            };
            Q4.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q4, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q4, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q4, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q4", Q4);
            ...
            Q5 = new (this, "x_Q5", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q5", "CustomMsg"),
                IsUpload = false
            };
            Q5.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q5, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q5, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q5, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q5", Q5);
            ...
            Section_2 = new (this, "x_Section_2", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_2", "CustomMsg"),
                IsUpload = false
            };
            Section_2.GetDefault = () => "(Performance Criteria) Position (Parallel - Reverse 90)";
            ...
            Q6 = new (this, "x_Q6", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q6", "CustomMsg"),
                IsUpload = false
            };
            Q6.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q6, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q6, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q6, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q6", Q6);
            ...
            Q7 = new (this, "x_Q7", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q7", "CustomMsg"),
                IsUpload = false
            };
            Q7.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q7, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q7, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q7, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q7", Q7);
            ...
            Q8 = new (this, "x_Q8", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q8", "CustomMsg"),
                IsUpload = false
            };
            Q8.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q8, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q8, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q8, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q8", Q8);
            ...
            Q9 = new (this, "x_Q9", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q9", "CustomMsg"),
                IsUpload = false
            };
            Q9.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q9, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q9, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q9, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q9", Q9);
            ...
            Q10 = new (this, "x_Q10", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q10", "CustomMsg"),
                IsUpload = false
            };
            Q10.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q10, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q10, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q10, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q10", Q10);
            ...
            Q11 = new (this, "x_Q11", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q11", "CustomMsg"),
                IsUpload = false
            };
            Q11.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q11, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q11, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q11, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q11", Q11);
            ...
            Q12 = new (this, "x_Q12", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q12", "CustomMsg"),
                IsUpload = false
            };
            Q12.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q12, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q12, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q12, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q12", Q12);
            ...
            Q13 = new (this, "x_Q13", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q13", "CustomMsg"),
                IsUpload = false
            };
            Q13.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q13, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q13, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q13, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q13", Q13);
            ...
            Q14 = new (this, "x_Q14", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q14", "CustomMsg"),
                IsUpload = false
            };
            Q14.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q14, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q14, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q14, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q14", Q14);
            ...
            Q15 = new (this, "x_Q15", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q15", "CustomMsg"),
                IsUpload = false
            };
            Q15.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q15, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q15, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q15, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q15", Q15);
            ...
            Section_3 = new (this, "x_Section_3", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_3", "CustomMsg"),
                IsUpload = false
            };
            Section_3.GetDefault = () => "(Performance criteria) Motion and stop";
            ...
            Q16 = new (this, "x_Q16", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q16", "CustomMsg"),
                IsUpload = false
            };
            Q16.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q16, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q16, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q16, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q16", Q16);
            ...
            Q17 = new (this, "x_Q17", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q17", "CustomMsg"),
                IsUpload = false
            };
            Q17.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q17, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q17, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q17, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q17", Q17);
            ...
            Q18 = new (this, "x_Q18", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q18", "CustomMsg"),
                IsUpload = false
            };
            Q18.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q18, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q18, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q18, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q18", Q18);
            ...
            Q19 = new (this, "x_Q19", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q19", "CustomMsg"),
                IsUpload = false
            };
            Q19.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q19, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q19, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q19, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q19", Q19);
            ...
            Q20 = new (this, "x_Q20", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q20", "CustomMsg"),
                IsUpload = false
            };
            Q20.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q20, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q20, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q20, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q20", Q20);
            ...
            Q21 = new (this, "x_Q21", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q21", "CustomMsg"),
                IsUpload = false
            };
            Q21.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q21, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q21, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q21, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q21", Q21);
            ...
            Section_4 = new (this, "x_Section_4", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_4", "CustomMsg"),
                IsUpload = false
            };
            Section_4.GetDefault = () => "(Performance Standards) Use of Controls";
            ...
            Q22 = new (this, "x_Q22", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q22", "CustomMsg"),
                IsUpload = false
            };
            Q22.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q22, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q22, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q22, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q22", Q22);
            ...
            Q23 = new (this, "x_Q23", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q23", "CustomMsg"),
                IsUpload = false
            };
            Q23.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q23, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q23, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q23, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q23", Q23);
            ...
            Q24 = new (this, "x_Q24", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q24", "CustomMsg"),
                IsUpload = false
            };
            Q24.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q24, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q24, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q24, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q24", Q24);
            ...
            Q25 = new (this, "x_Q25", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q25", "CustomMsg"),
                IsUpload = false
            };
            Q25.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q25, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q25, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q25, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q25", Q25);
            ...
            Q26 = new (this, "x_Q26", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q26", "CustomMsg"),
                IsUpload = false
            };
            Q26.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q26, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q26, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q26, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q26", Q26);
            ...
            Section_5 = new (this, "x_Section_5", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_5", "CustomMsg"),
                IsUpload = false
            };
            Section_5.GetDefault = () => "(Performance Standards) Approaches/turning";
            ...
            Q27 = new (this, "x_Q27", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q27", "CustomMsg"),
                IsUpload = false
            };
            Q27.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q27, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q27, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q27, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q27", Q27);
            ...
            Q28 = new (this, "x_Q28", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q28", "CustomMsg"),
                IsUpload = false
            };
            Q28.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q28, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q28, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q28, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q28", Q28);
            ...
            Q29 = new (this, "x_Q29", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q29", "CustomMsg"),
                IsUpload = false
            };
            Q29.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q29, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q29, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q29, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q29", Q29);
            ...
            Q30 = new (this, "x_Q30", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q30", "CustomMsg"),
                IsUpload = false
            };
            Q30.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q30, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q30, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q30, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q30", Q30);
            ...
            Q31 = new (this, "x_Q31", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q31", "CustomMsg"),
                IsUpload = false
            };
            Q31.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q31, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q31, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q31, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q31", Q31);
            ...
            Q32 = new (this, "x_Q32", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q32", "CustomMsg"),
                IsUpload = false
            };
            Q32.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q32, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q32, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q32, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q32", Q32);
            ...
            Q33 = new (this, "x_Q33", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q33", "CustomMsg"),
                IsUpload = false
            };
            Q33.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q33, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q33, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q33, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q33", Q33);
            ...
            Q34 = new (this, "x_Q34", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q34", "CustomMsg"),
                IsUpload = false
            };
            Q34.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q34, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q34, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q34, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q34", Q34);
            ...
            Q35 = new (this, "x_Q35", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q35", "CustomMsg"),
                IsUpload = false
            };
            Q35.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q35, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q35, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q35, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q35", Q35);
            ...
            Section_6 = new (this, "x_Section_6", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_6", "CustomMsg"),
                IsUpload = false
            };
            Section_6.GetDefault = () => "(Performance Standards) Rotors/Signals";
            ...
            Q36 = new (this, "x_Q36", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q36", "CustomMsg"),
                IsUpload = false
            };
            Q36.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q36, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q36, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q36, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q36", Q36);
            ...
            Q37 = new (this, "x_Q37", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q37", "CustomMsg"),
                IsUpload = false
            };
            Q37.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q37, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q37, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q37, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q37", Q37);
            ...
            Q38 = new (this, "x_Q38", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q38", "CustomMsg"),
                IsUpload = false
            };
            Q38.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q38, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q38, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q38, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q38", Q38);
            ...
            Q39 = new (this, "x_Q39", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q39", "CustomMsg"),
                IsUpload = false
            };
            Q39.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q39, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q39, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q39, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q39", Q39);
            ...
            Q40 = new (this, "x_Q40", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q40", "CustomMsg"),
                IsUpload = false
            };
            Q40.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q40, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q40, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q40, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q40", Q40);
            ...
            Q41 = new (this, "x_Q41", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q41", "CustomMsg"),
                IsUpload = false
            };
            Q41.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q41, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q41, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q41, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q41", Q41);
            ...
            Q42 = new (this, "x_Q42", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q42", "CustomMsg"),
                IsUpload = false
            };
            Q42.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q42, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q42, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q42, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q42", Q42);
            ...
            Q43 = new (this, "x_Q43", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q43", "CustomMsg"),
                IsUpload = false
            };
            Q43.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q43, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q43, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q43, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q43", Q43);
            ...
            Section_7 = new (this, "x_Section_7", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_7", "CustomMsg"),
                IsUpload = false
            };
            Section_7.GetDefault = () => "(Performance Standards) Change course";
            ...
            Q44 = new (this, "x_Q44", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q44", "CustomMsg"),
                IsUpload = false
            };
            Q44.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q44, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q44, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q44, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q44", Q44);
            ...
            Q45 = new (this, "x_Q45", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q45", "CustomMsg"),
                IsUpload = false
            };
            Q45.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q45, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q45, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q45, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q45", Q45);
            ...
            Q46 = new (this, "x_Q46", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q46", "CustomMsg"),
                IsUpload = false
            };
            Q46.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q46, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q46, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q46, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q46", Q46);
            ...
            Q47 = new (this, "x_Q47", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q47", "CustomMsg"),
                IsUpload = false
            };
            Q47.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q47, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q47, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q47, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q47", Q47);
            ...
            Q48 = new (this, "x_Q48", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q48", "CustomMsg"),
                IsUpload = false
            };
            Q48.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q48, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q48, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q48, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q48", Q48);
            ...
            Q49 = new (this, "x_Q49", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q49", "CustomMsg"),
                IsUpload = false
            };
            Q49.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q49, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q49, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q49, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q49", Q49);
            ...
            Q50 = new (this, "x_Q50", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q50", "CustomMsg"),
                IsUpload = false
            };
            Q50.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q50, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q50, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q50, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q50", Q50);
            ...
            Section_8 = new (this, "x_Section_8", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_8", "CustomMsg"),
                IsUpload = false
            };
            Section_8.GetDefault = () => "(Performance Criteria) Overtaking (after lane change...)";
            ...
            Q51 = new (this, "x_Q51", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q51", "CustomMsg"),
                IsUpload = false
            };
            Q51.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q51, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q51, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q51, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q51", Q51);
            ...
            Q52 = new (this, "x_Q52", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q52", "CustomMsg"),
                IsUpload = false
            };
            Q52.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q52, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q52, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q52, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q52", Q52);
            ...
            Q53 = new (this, "x_Q53", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q53", "CustomMsg"),
                IsUpload = false
            };
            Q53.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q53, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q53, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q53, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q53", Q53);
            ...
            Q54 = new (this, "x_Q54", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q54", "CustomMsg"),
                IsUpload = false
            };
            Q54.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q54, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q54, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q54, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q54", Q54);
            ...
            Q55 = new (this, "x_Q55", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q55", "CustomMsg"),
                IsUpload = false
            };
            Q55.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q55, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q55, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q55, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q55", Q55);
            ...
            Section_9 = new (this, "x_Section_9", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_9", "CustomMsg"),
                IsUpload = false
            };
            Section_9.GetDefault = () => "(Performance Standards) Safe distance";
            ...
            Q56 = new (this, "x_Q56", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q56", "CustomMsg"),
                IsUpload = false
            };
            Q56.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q56, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q56, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q56, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q56", Q56);
            ...
            Q57 = new (this, "x_Q57", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q57", "CustomMsg"),
                IsUpload = false
            };
            Q57.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q57, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q57, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q57, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q57", Q57);
            ...
            Q58 = new (this, "x_Q58", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q58", "CustomMsg"),
                IsUpload = false
            };
            Q58.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q58, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q58, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q58, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q58", Q58);
            ...
            Q59 = new (this, "x_Q59", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q59", "CustomMsg"),
                IsUpload = false
            };
            Q59.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q59, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q59, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q59, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q59", Q59);
            ...
            Section_10 = new (this, "x_Section_10", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_10", "CustomMsg"),
                IsUpload = false
            };
            Section_10.GetDefault = () => "(Performance Standards) General leadership behavior";
            ...
            Q60 = new (this, "x_Q60", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q60", "CustomMsg"),
                IsUpload = false
            };
            Q60.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q60, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q60, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q60, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q60", Q60);
            ...
            Q61 = new (this, "x_Q61", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q61", "CustomMsg"),
                IsUpload = false
            };
            Q61.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q61, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q61, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q61, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q61", Q61);
            ...
            Q62 = new (this, "x_Q62", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q62", "CustomMsg"),
                IsUpload = false
            };
            Q62.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q62, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q62, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q62, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q62", Q62);
            ...
            Q63 = new (this, "x_Q63", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q63", "CustomMsg"),
                IsUpload = false
            };
            Q63.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q63, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q63, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q63, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q63", Q63);
            ...
            Q64 = new (this, "x_Q64", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q64", "CustomMsg"),
                IsUpload = false
            };
            Q64.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q64, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q64, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q64, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q64", Q64);
            ...
            Q65 = new (this, "x_Q65", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q65", "CustomMsg"),
                IsUpload = false
            };
            Q65.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q65, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q65, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q65, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q65", Q65);
            ...
            Section_11 = new (this, "x_Section_11", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Section_11", "CustomMsg"),
                IsUpload = false
            };
            Section_11.GetDefault = () => "(Performance Standards) Serious Errors (Immediate Failure)";
            ...
            Q66 = new (this, "x_Q66", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q66", "CustomMsg"),
                IsUpload = false
            };
            Q66.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q66, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q66, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q66, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q66", Q66);
            ...
            Q67 = new (this, "x_Q67", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q67", "CustomMsg"),
                IsUpload = false
            };
            Q67.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q67, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q67, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q67, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q67", Q67);
            ...
            Q68 = new (this, "x_Q68", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q68", "CustomMsg"),
                IsUpload = false
            };
            Q68.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q68, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q68, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q68, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q68", Q68);
            ...
            Q69 = new (this, "x_Q69", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q69", "CustomMsg"),
                IsUpload = false
            };
            Q69.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q69, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q69, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q69, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q69", Q69);
            ...
            Q70 = new (this, "x_Q70", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Q70", "CustomMsg"),
                IsUpload = false
            };
            Q70.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(Q70, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(Q70, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(Q70, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("Q70", Q70);
            ...
            Notes_3 = new (this, "x_Notes_3", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Notes_3", "CustomMsg"),
                IsUpload = false
            };
            ...
            Examiner_Signature = new (this, "x_Examiner_Signature", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Examiner_Signature", "CustomMsg"),
                IsUpload = false
            };
            ...
            Student_Signature = new (this, "x_Student_Signature", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Student_Signature", "CustomMsg"),
                IsUpload = false
            };
            ...
            AbsherApptNbr = new (this, "x_AbsherApptNbr", 202, SqlDbType.NVarChar) {
                ...
                UseFilter = true, // Table header filter
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "AbsherApptNbr", "CustomMsg"),
                IsUpload = false
            };
            AbsherApptNbr.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(AbsherApptNbr, "tblEvaluationMB", true, "AbsherApptNbr", new List<string> {"AbsherApptNbr", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(AbsherApptNbr, "tblEvaluationMB", true, "AbsherApptNbr", new List<string> {"AbsherApptNbr", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(AbsherApptNbr, "tblEvaluationMB", true, "AbsherApptNbr", new List<string> {"AbsherApptNbr", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            IsDrivingexperience = new (this, "x_IsDrivingexperience", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "IsDrivingexperience", "CustomMsg"),
                IsUpload = false
            };
            IsDrivingexperience.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(IsDrivingexperience, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(IsDrivingexperience, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(IsDrivingexperience, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            date_Birth_Hijri = new (this, "x_date_Birth_Hijri", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "date_Birth_Hijri", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Birth = new (this, "x_date_Birth", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "date_Birth", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Email = new (this, "x_str_Email", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "str_Email", "CustomMsg"),
                IsUpload = false
            };
            ...
            UserlevelID = new (this, "x_UserlevelID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "UserlevelID", "CustomMsg"),
                IsUpload = false
            };
            ...
            DriveTypelink = new (this, "x_DriveTypelink", 203, SqlDbType.NText) {
                ...
                Sortable = false, // Allow sort
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "DriveTypelink", "CustomMsg"),
                IsUpload = false
            };
            ...
            intEvaluationType = new (this, "x_intEvaluationType", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "intEvaluationType", "CustomMsg"),
                IsUpload = false
            };
            ...
            Institution = new (this, "x_Institution", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Institution", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Institution", Institution);

            // Scores_S1
            Scores_S1 = new (this, "x_Scores_S1", 202, SqlDbType.NVarChar) {
                Name = "Scores_S1",
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S1", "CustomMsg"),
                IsUpload = false
            };
            ...
            S1 = new (this, "x_S1", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S1", "CustomMsg"),
                IsUpload = false
            };
            S1.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S1, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S1, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S1, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S1", S1);
            ...
            S2 = new (this, "x_S2", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S2", "CustomMsg"),
                IsUpload = false
            };
            S2.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S2, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S2, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S2, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S2", S2);
            ...
            S3 = new (this, "x_S3", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S3", "CustomMsg"),
                IsUpload = false
            };
            S3.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S3, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S3, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S3, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S3", S3);
            ...
            S4 = new (this, "x_S4", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S4", "CustomMsg"),
                IsUpload = false
            };
            S4.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S4, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S4, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S4, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S4", S4);
            ...
            S5 = new (this, "x_S5", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S5", "CustomMsg"),
                IsUpload = false
            };
            S5.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S5, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S5, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S5, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S5", S5);
            ...
            Scores_S2 = new (this, "x_Scores_S2", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S2", "CustomMsg"),
                IsUpload = false
            };
            ...
            S6 = new (this, "x_S6", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S6", "CustomMsg"),
                IsUpload = false
            };
            S6.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S6, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S6, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S6, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S6", S6);
            ...
            S7 = new (this, "x_S7", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S7", "CustomMsg"),
                IsUpload = false
            };
            S7.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S7, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S7, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S7, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S7", S7);
            ...
            S8 = new (this, "x_S8", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S8", "CustomMsg"),
                IsUpload = false
            };
            S8.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S8, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S8, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S8, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S8", S8);
            ...
            S9 = new (this, "x_S9", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S9", "CustomMsg"),
                IsUpload = false
            };
            S9.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S9, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S9, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S9, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S9", S9);
            ...
            S10 = new (this, "x_S10", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S10", "CustomMsg"),
                IsUpload = false
            };
            S10.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S10, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S10, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S10, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S10", S10);
            ...
            S11 = new (this, "x_S11", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S11", "CustomMsg"),
                IsUpload = false
            };
            S11.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S11, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S11, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S11, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S11", S11);
            ...
            S12 = new (this, "x_S12", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S12", "CustomMsg"),
                IsUpload = false
            };
            S12.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S12, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S12, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S12, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S12", S12);
            ...
            S13 = new (this, "x_S13", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S13", "CustomMsg"),
                IsUpload = false
            };
            S13.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S13, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S13, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S13, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S13", S13);
            ...
            S14 = new (this, "x_S14", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S14", "CustomMsg"),
                IsUpload = false
            };
            S14.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S14, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S14, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S14, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S14", S14);
            ...
            S15 = new (this, "x_S15", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S15", "CustomMsg"),
                IsUpload = false
            };
            S15.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S15, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S15, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S15, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S15", S15);
            ...
            Scores_S3 = new (this, "x_Scores_S3", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S3", "CustomMsg"),
                IsUpload = false
            };
            ...
            S16 = new (this, "x_S16", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S16", "CustomMsg"),
                IsUpload = false
            };
            S16.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S16, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S16, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S16, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S16", S16);
            ...
            S17 = new (this, "x_S17", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S17", "CustomMsg"),
                IsUpload = false
            };
            S17.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S17, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S17, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S17, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S17", S17);
            ...
            S18 = new (this, "x_S18", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S18", "CustomMsg"),
                IsUpload = false
            };
            S18.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S18, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S18, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S18, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S18", S18);
            ...
            S19 = new (this, "x_S19", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S19", "CustomMsg"),
                IsUpload = false
            };
            S19.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S19, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S19, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S19, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S19", S19);
            ...
            S20 = new (this, "x_S20", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S20", "CustomMsg"),
                IsUpload = false
            };
            S20.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S20, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S20, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S20, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S20", S20);
            ...
            S21 = new (this, "x_S21", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S21", "CustomMsg"),
                IsUpload = false
            };
            S21.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S21, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S21, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S21, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S21", S21);
            ...
            Scores_S4 = new (this, "x_Scores_S4", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S4", "CustomMsg"),
                IsUpload = false
            };
            Scores_S4.GetDefault = () => "(Performance Standards) Use of Controls";
            ...
            S22 = new (this, "x_S22", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S22", "CustomMsg"),
                IsUpload = false
            };
            S22.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S22, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S22, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S22, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S22", S22);
            ...
            S23 = new (this, "x_S23", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S23", "CustomMsg"),
                IsUpload = false
            };
            S23.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S23, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S23, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S23, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S23", S23);
            ...
            S24 = new (this, "x_S24", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S24", "CustomMsg"),
                IsUpload = false
            };
            S24.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S24, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S24, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S24, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S24", S24);
            ...
            S25 = new (this, "x_S25", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S25", "CustomMsg"),
                IsUpload = false
            };
            S25.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S25, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S25, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S25, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S25", S25);
            ...
            S26 = new (this, "x_S26", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S26", "CustomMsg"),
                IsUpload = false
            };
            S26.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S26, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S26, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S26, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S26", S26);
            ...
            Scores_S5 = new (this, "x_Scores_S5", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S5", "CustomMsg"),
                IsUpload = false
            };
            Scores_S5.GetDefault = () => "(Performance Standards) Approaches/turning";
            ...
            S27 = new (this, "x_S27", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S27", "CustomMsg"),
                IsUpload = false
            };
            S27.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S27, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S27, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S27, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S27", S27);
            ...
            S28 = new (this, "x_S28", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S28", "CustomMsg"),
                IsUpload = false
            };
            S28.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S28, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S28, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S28, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S28", S28);
            ...
            S29 = new (this, "x_S29", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S29", "CustomMsg"),
                IsUpload = false
            };
            S29.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S29, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S29, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S29, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S29", S29);
            ...
            S30 = new (this, "x_S30", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S30", "CustomMsg"),
                IsUpload = false
            };
            S30.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S30, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S30, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S30, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S30", S30);
            ...
            S31 = new (this, "x_S31", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S31", "CustomMsg"),
                IsUpload = false
            };
            S31.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S31, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S31, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S31, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S31", S31);
            ...
            S32 = new (this, "x_S32", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S32", "CustomMsg"),
                IsUpload = false
            };
            S32.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S32, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S32, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S32, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S32", S32);
            ...
            S33 = new (this, "x_S33", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S33", "CustomMsg"),
                IsUpload = false
            };
            S33.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S33, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S33, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S33, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S33", S33);
            ...
            S34 = new (this, "x_S34", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S34", "CustomMsg"),
                IsUpload = false
            };
            S34.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S34, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S34, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S34, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S34", S34);
            ...
            S35 = new (this, "x_S35", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S35", "CustomMsg"),
                IsUpload = false
            };
            S35.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S35, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S35, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S35, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S35", S35);
            ...
            Scores_S6 = new (this, "x_Scores_S6", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S6", "CustomMsg"),
                IsUpload = false
            };
            ...
            S36 = new (this, "x_S36", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S36", "CustomMsg"),
                IsUpload = false
            };
            S36.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S36, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S36, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S36, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S36", S36);
            ...
            S37 = new (this, "x_S37", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S37", "CustomMsg"),
                IsUpload = false
            };
            S37.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S37, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S37, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S37, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S37", S37);
            ...
            S38 = new (this, "x_S38", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S38", "CustomMsg"),
                IsUpload = false
            };
            S38.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S38, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S38, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S38, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S38", S38);
            ...
            S39 = new (this, "x_S39", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S39", "CustomMsg"),
                IsUpload = false
            };
            S39.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S39, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S39, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S39, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S39", S39);
            ...
            S40 = new (this, "x_S40", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S40", "CustomMsg"),
                IsUpload = false
            };
            S40.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S40, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S40, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S40, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S40", S40);
            ...
            S41 = new (this, "x_S41", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S41", "CustomMsg"),
                IsUpload = false
            };
            S41.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S41, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S41, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S41, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S41", S41);
            ...
            S42 = new (this, "x_S42", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S42", "CustomMsg"),
                IsUpload = false
            };
            S42.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S42, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S42, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S42, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S42", S42);
            ...
            S43 = new (this, "x_S43", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S43", "CustomMsg"),
                IsUpload = false
            };
            S43.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S43, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S43, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S43, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S43", S43);
            ...
            Scores_S7 = new (this, "x_Scores_S7", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S7", "CustomMsg"),
                IsUpload = false
            };
            ...
            S44 = new (this, "x_S44", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S44", "CustomMsg"),
                IsUpload = false
            };
            S44.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S44, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S44, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S44, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S44", S44);
            ...
            S45 = new (this, "x_S45", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S45", "CustomMsg"),
                IsUpload = false
            };
            S45.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S45, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S45, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S45, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S45", S45);
            ...
            S46 = new (this, "x_S46", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S46", "CustomMsg"),
                IsUpload = false
            };
            S46.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S46, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S46, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S46, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S46", S46);
            ...
            S47 = new (this, "x_S47", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S47", "CustomMsg"),
                IsUpload = false
            };
            S47.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S47, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S47, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S47, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S47", S47);
            ...
            S48 = new (this, "x_S48", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S48", "CustomMsg"),
                IsUpload = false
            };
            S48.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S48, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S48, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S48, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S48", S48);
            ...
            S49 = new (this, "x_S49", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S49", "CustomMsg"),
                IsUpload = false
            };
            S49.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S49, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S49, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S49, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S49", S49);
            ...
            S50 = new (this, "x_S50", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S50", "CustomMsg"),
                IsUpload = false
            };
            S50.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S50, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S50, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S50, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S50", S50);
            ...
            Scores_S8 = new (this, "x_Scores_S8", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S8", "CustomMsg"),
                IsUpload = false
            };
            ...
            S51 = new (this, "x_S51", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S51", "CustomMsg"),
                IsUpload = false
            };
            S51.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S51, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S51, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S51, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S51", S51);
            ...
            S52 = new (this, "x_S52", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S52", "CustomMsg"),
                IsUpload = false
            };
            S52.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S52, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S52, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S52, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S52", S52);
            ...
            S53 = new (this, "x_S53", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S53", "CustomMsg"),
                IsUpload = false
            };
            S53.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S53, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S53, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S53, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S53", S53);
            ...
            S54 = new (this, "x_S54", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S54", "CustomMsg"),
                IsUpload = false
            };
            S54.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S54, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S54, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S54, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S54", S54);
            ...
            S55 = new (this, "x_S55", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S55", "CustomMsg"),
                IsUpload = false
            };
            S55.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S55, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S55, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S55, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S55", S55);
            ...
            Scores_S9 = new (this, "x_Scores_S9", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S9", "CustomMsg"),
                IsUpload = false
            };
            ...
            S56 = new (this, "x_S56", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S56", "CustomMsg"),
                IsUpload = false
            };
            S56.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S56, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S56, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S56, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S56", S56);
            ...
            S57 = new (this, "x_S57", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S57", "CustomMsg"),
                IsUpload = false
            };
            S57.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S57, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S57, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S57, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S57", S57);
            ...
            S58 = new (this, "x_S58", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S58", "CustomMsg"),
                IsUpload = false
            };
            S58.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S58, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S58, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S58, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S58", S58);
            ...
            S59 = new (this, "x_S59", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S59", "CustomMsg"),
                IsUpload = false
            };
            S59.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S59, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S59, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S59, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S59", S59);
            ...
            Scores_S10 = new (this, "x_Scores_S10", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S10", "CustomMsg"),
                IsUpload = false
            };
            ...
            S60 = new (this, "x_S60", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S60", "CustomMsg"),
                IsUpload = false
            };
            S60.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S60, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S60, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S60, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S60", S60);
            ...
            S61 = new (this, "x_S61", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S61", "CustomMsg"),
                IsUpload = false
            };
            S61.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S61, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S61, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S61, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S61", S61);
            ...
            S62 = new (this, "x_S62", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S62", "CustomMsg"),
                IsUpload = false
            };
            S62.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S62, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S62, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S62, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S62", S62);
            ...
            S63 = new (this, "x_S63", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S63", "CustomMsg"),
                IsUpload = false
            };
            S63.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S63, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S63, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S63, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S63", S63);
            ...
            S64 = new (this, "x_S64", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S64", "CustomMsg"),
                IsUpload = false
            };
            S64.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S64, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S64, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S64, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S64", S64);
            ...
            S65 = new (this, "x_S65", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S65", "CustomMsg"),
                IsUpload = false
            };
            S65.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S65, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S65, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S65, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S65", S65);
            ...
            Scores_S11 = new (this, "x_Scores_S11", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Scores_S11", "CustomMsg"),
                IsUpload = false
            };
            ...
            S66 = new (this, "x_S66", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S66", "CustomMsg"),
                IsUpload = false
            };
            S66.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S66, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S66, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S66, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S66", S66);
            ...
            S67 = new (this, "x_S67", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S67", "CustomMsg"),
                IsUpload = false
            };
            S67.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S67, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S67, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S67, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S67", S67);
            ...
            S68 = new (this, "x_S68", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S68", "CustomMsg"),
                IsUpload = false
            };
            S68.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S68, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S68, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S68, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S68", S68);
            ...
            S69 = new (this, "x_S69", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S69", "CustomMsg"),
                IsUpload = false
            };
            S69.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S69, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S69, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S69, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S69", S69);
            ...
            S70 = new (this, "x_S70", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "S70", "CustomMsg"),
                IsUpload = false
            };
            S70.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(S70, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(S70, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(S70, "tblEvaluationMB", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("S70", S70);
            ...
            Evaluation_Score = new (this, "x_Evaluation_Score", 5, SqlDbType.Float) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Evaluation_Score", "CustomMsg"),
                IsUpload = false
            };
            ...
            Immediate_Failure_Score = new (this, "x_Immediate_Failure_Score", 5, SqlDbType.Float) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Immediate_Failure_Score", "CustomMsg"),
                IsUpload = false
            };
            ...
            Required_Program = new (this, "x_Required_Program", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Required_Program", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblEvaluationMB", "Price", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.tblEvaluationMB";
            set => _sqlFrom = value;
        }
        ...
        {
            if (SameString(pageName, "TblEvaluationMbView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TblEvaluationMbEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TblEvaluationMbAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TblEvaluationMbView",
                Config.ApiAddAction => "TblEvaluationMbAdd",
                Config.ApiEditAction => "TblEvaluationMbEdit",
                Config.ApiDeleteAction => "TblEvaluationMbDelete",
                Config.ApiListAction => "TblEvaluationMbList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TblEvaluationMbList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TblEvaluationMbView", parm);
            else
                url = KeyUrl("TblEvaluationMbView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TblEvaluationMbAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TblEvaluationMbAdd?" + parm;
            else
                url = "TblEvaluationMbAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TblEvaluationMbEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TblEvaluationMbList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TblEvaluationMbAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TblEvaluationMbList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("TblEvaluationMbDelete")); // DN
        ...
        {
            string pageName = "TblEvaluationMbList";
        ...
        public async Task RenderListRow()
        {
            ...
            if (!IsExport()) {
                ...
                intDrivinglicenseType.LinkAttrs["data-tooltip-id"] = "tt_tblEvaluationMB_x" + ((RowType != RowType.Master && RowCount > 0) ? ConvertToString(RowCount) : "") + "_intDrivinglicenseType";
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM dbo.tblEvaluationMB";
        ...
        public async Task WriteAuditTrailLog(string log) => await WriteAuditTrailAsync(CurrentUser(), log, "tblEvaluationMB");
