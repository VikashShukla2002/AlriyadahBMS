...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static ClassroomCalendar classroomCalendar
    {
        get => HttpData.Resolve<ClassroomCalendar>("Classroom_Calendar");
        set => HttpData["Classroom_Calendar"] = value;
    }

    /// <summary>
    /// Table class for Classroom_Calendar
    /// </summary>
    public class ClassroomCalendar : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public ClassroomCalendar()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "Classroom_Calendar";
            Name = "Classroom_Calendar";
            Type = "REPORT";
            UpdateTable = "Calendar2"; // Calendar update table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new (this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "Id", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            Fields.Add("Id", Id);
            ...
            _Title = new (this, "x__Title", 203, SqlDbType.NText) {
                ...
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "_Title", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            ...
            Start = new (this, "x_Start", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "Start", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            ...
            End = new (this, "x_End", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "End", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            Fields.Add("End", End);
            ...
            AllDay = new (this, "x_AllDay", 11, SqlDbType.Bit) {
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>" },
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "AllDay", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            AllDay.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(AllDay, "Classroom_Calendar", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(AllDay, "Classroom_Calendar", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(AllDay, "Classroom_Calendar", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Notes = new (this, "x_Notes", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "Notes", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "str_Username", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            ...
            _Url = new (this, "x__Url", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "_Url", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            Fields.Add("Url", _Url);
            ...
            ClassNames = new (this, "x_ClassNames", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "ClassNames", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            ...
            Display = new (this, "x_Display", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "Display", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            ...
            BackgroundColor = new (this, "x_BackgroundColor", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "BackgroundColor", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
            ...
            CRSS_ID = new (this, "x_CRSS_ID", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Classroom_Calendar", "CRSS_ID", "CustomMsg"),
                SourceTableVar = "Calendar2",
                IsUpload = false
            };
