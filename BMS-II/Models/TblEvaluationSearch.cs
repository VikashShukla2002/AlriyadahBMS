...
public partial class JUN26 {
    ...
    /// tblEvaluationSearch
    /// </summary>
    public static TblEvaluationSearch tblEvaluationSearch
    {
        get => HttpData.Get<TblEvaluationSearch>("tblEvaluationSearch")!;
        set => HttpData["tblEvaluationSearch"] = value;
    }

    /// <summary>
    /// Page class for tblEvaluation
    /// </summary>
    public class TblEvaluationSearch : TblEvaluationSearchBase
    {
        // Constructor
        public TblEvaluationSearch(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblEvaluationSearch() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TblEvaluationSearchBase : TblEvaluation
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblEvaluationSearch";
        ...
        // Constructor
        public TblEvaluationSearchBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TblEvaluationSearch";
        ...
        // Constructor
        public TblEvaluationSearchBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsSearch) {
                ...
                if (!Empty(srchStr)) {
                    srchStr = "TblEvaluationList?" + srchStr;
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                tblEvaluationSearch?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string BuildAdvancedSearch() {
            ...
            BuildSearchUrl(ref srchUrl, Assigned_int_Package_Id); // Assigned_int_Package_Id
        ...
        protected void LoadSearchValues() {
            ...
            if (!IsAddOrEdit)
                if (Form.ContainsKey("x_Assigned_int_Package_Id"))
                    Assigned_int_Package_Id.AdvancedSearch.SearchValue = CurrentForm.GetValue("x_Assigned_int_Package_Id");
            if (Form.ContainsKey("z_Assigned_int_Package_Id"))
                Assigned_int_Package_Id.AdvancedSearch.SearchOperator = CurrentForm.GetValue("z_Assigned_int_Package_Id");
        ...
        public async Task RenderRow()
        {
            ...
            if (RowType == RowType.View) {
                ...
                Assigned_int_Package_Id.EditValue = Assigned_int_Package_Id.AdvancedSearch.SearchValue; // DN
        ...
        protected bool ValidateSearch() {
            ...
            if (!CheckInteger(ConvertToString(Assigned_int_Package_Id.AdvancedSearch.SearchValue))) {
                Assigned_int_Package_Id.AddErrorMessage(Assigned_int_Package_Id.GetErrorMessage(false));
            }
