...
public partial class JUN26 {
    ...
    /// appointmentCldrAdd
    /// </summary>
    public static AppointmentCldrAdd appointmentCldrAdd
    {
        get => HttpData.Get<AppointmentCldrAdd>("appointmentCldrAdd")!;
        set => HttpData["appointmentCldrAdd"] = value;
    }

    /// <summary>
    /// Page class for Appointment_Cldr
    /// </summary>
    public class AppointmentCldrAdd : AppointmentCldrAddBase
    {
        // Constructor
        public AppointmentCldrAdd(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AppointmentCldrAdd() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AppointmentCldrAddBase : AppointmentCldr
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "appointmentCldrAdd";
        ...
        // Page name
        public string PageName => "AppointmentCldrAdd";
        ...
        public void SetVisibility()
        {
            ...
            str_AppointmentType.Visible = false;
            str_AppointmentStatus.Visible = false;
            str_Username.Visible = false;
            str_CRSS_IDUSER.Visible = false;
        }

        // Constructor
        public AppointmentCldrAddBase(Controller? controller = null): this() { // DN
            if (controller != null)
            ...
            switch (CurrentAction) {
                case "copy": // Copy an existing record
                    if (rsold == null) { // Record not loaded
                        ...
                        return Terminate("AppointmentCldrList"); // No matching record, return to List page // DN
                    }
                    break;
                case "insert": // Add new record // DN
                    ...
                    if (res) { // Add successful
                        ...
                        else if (GetPageName(returnUrl) == "AppointmentCldrView")
        ...
        protected void LoadDefaultValues() {
            AllDay.DefaultValue = AllDay.GetDefault(); // DN
            AllDay.OldValue = AllDay.DefaultValue;
        }
