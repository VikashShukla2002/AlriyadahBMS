...
public partial class JUN26 {
    /// <summary>
    /// tblRptMgrInvoicesView
    /// </summary>
    public static TblRptMgrInvoicesView tblRptMgrInvoicesView
    {
        get => HttpData.Get<TblRptMgrInvoicesView>("tblRptMgrInvoicesView")!;
        set => HttpData["tblRptMgrInvoicesView"] = value;
    }

    /// <summary>
    /// Page class for tblRptMgrInvoices
    /// </summary>
    public class TblRptMgrInvoicesView : TblRptMgrInvoicesViewBase
    {
        // Constructor
        public TblRptMgrInvoicesView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblRptMgrInvoicesView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TblRptMgrInvoicesViewBase : TblRptMgrInvoices
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblRptMgrInvoicesView";
        ...
        // Constructor
        public TblRptMgrInvoicesViewBase()
        {
            // Initialize
            CurrentPage = this;
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["RptMgr_ID"] = keys[0];
            } else {
                RecordKeys["RptMgr_ID"] = RouteValues.TryGetValue("RptMgr_ID", out obj) && obj != null ? UrlDecode(obj) : Get("RptMgr_ID"); // DN
            }
        ...
        // Page name
        public string PageName => "TblRptMgrInvoicesView";
        ...
        // Constructor
        public TblRptMgrInvoicesViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("RptMgr_ID", out v) && !Empty(v)) { // DN
                RptMgr_ID.QueryValue = UrlDecode(v); // DN
                RecordKeys["RptMgr_ID"] = RptMgr_ID.QueryValue;
            } else if (Get("RptMgr_ID", out sv)) {
                RptMgr_ID.QueryValue = sv.ToString();
                RecordKeys["RptMgr_ID"] = RptMgr_ID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                RptMgr_ID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["RptMgr_ID"] = RptMgr_ID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "TblRptMgrInvoicesList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("TblRptMgrInvoicesList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                tblRptMgrInvoicesView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"ftblRptMgrInvoicesview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
