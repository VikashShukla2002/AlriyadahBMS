...
public partial class JUN26 {
    ...
    /// calendarDelete
    /// </summary>
    public static CalendarDelete calendarDelete
    {
        get => HttpData.Get<CalendarDelete>("calendarDelete")!;
        set => HttpData["calendarDelete"] = value;
    }

    /// <summary>
    /// Page class for Calendar
    /// </summary>
    public class CalendarDelete : CalendarDeleteBase
    {
        // Constructor
        public CalendarDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public CalendarDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class CalendarDeleteBase : Calendar
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "calendarDelete";
        ...
        // Page name
        public string PageName => "CalendarDelete";
        ...
        // Constructor
        public CalendarDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("CalendarList"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("CalendarList"); // Return to list
                }
            }
