...
public partial class JUN26 {
    /// <summary>
    /// qryStudentJourneyTitle
    /// </summary>
    [MaybeNull]
    public static QryStudentJourneyTitle qryStudentJourneyTitle
    {
        get => HttpData.Resolve<QryStudentJourneyTitle>("qryStudentJourneyTitle");
        set => HttpData["qryStudentJourneyTitle"] = value;
    }

    /// <summary>
    /// Table class for qryStudentJourneyTitle
    /// </summary>
    public class QryStudentJourneyTitle : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public QryStudentJourneyTitle()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryStudentJourneyTitle";
            Name = "qryStudentJourneyTitle";
            Type = "VIEW";
            UpdateTable = "dbo.qryStudentJourneyTitle"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            int_Package_Id = new (this, "x_int_Package_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "int_Package_Id", "CustomMsg"),
                IsUpload = false
            };
            ...
            Package_Name = new (this, "x_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "Package_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Full_Name = new (this, "x_str_Full_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "str_Full_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            Item_No = new (this, "x_Item_No", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "Item_No", "CustomMsg"),
                IsUpload = false
            };
            ...
            Service_Description = new (this, "x_Service_Description", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "Service_Description", "CustomMsg"),
                IsUpload = false
            };
            ...
            Journey = new (this, "x_Journey", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "Journey", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "Price", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Title = new (this, "x__Title", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "_Title", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Enrollement_Id = new (this, "x_int_Enrollement_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryStudentJourneyTitle", "int_Enrollement_Id", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryStudentJourneyTitle";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "QryStudentJourneyTitleList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "QryStudentJourneyTitleView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryStudentJourneyTitleEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryStudentJourneyTitleAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryStudentJourneyTitleView",
                Config.ApiAddAction => "QryStudentJourneyTitleAdd",
                Config.ApiEditAction => "QryStudentJourneyTitleEdit",
                Config.ApiDeleteAction => "QryStudentJourneyTitleDelete",
                Config.ApiListAction => "QryStudentJourneyTitleList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryStudentJourneyTitleList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryStudentJourneyTitleView", parm);
            else
                url = KeyUrl("QryStudentJourneyTitleView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryStudentJourneyTitleAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryStudentJourneyTitleAdd?" + parm;
            else
                url = "QryStudentJourneyTitleAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryStudentJourneyTitleEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryStudentJourneyTitleList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryStudentJourneyTitleAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryStudentJourneyTitleList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryStudentJourneyTitleDelete")); // DN
        ...
        {
            string pageName = "QryStudentJourneyTitleList";
