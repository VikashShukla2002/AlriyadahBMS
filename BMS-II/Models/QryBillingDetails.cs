...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static QryBillingDetails qryBillingDetails
    {
        get => HttpData.Resolve<QryBillingDetails>("qryBillingDetails");
        set => HttpData["qryBillingDetails"] = value;
    }

    /// <summary>
    /// Table class for qryBillingDetails
    /// </summary>
    public class QryBillingDetails : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> RunningBalance;
        ...
        // Constructor
        public QryBillingDetails()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryBillingDetails";
            Name = "qryBillingDetails";
            Type = "VIEW";
            UpdateTable = "dbo.qryBillingDetails"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            int_Bill_ID = new (this, "x_int_Bill_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "int_Bill_ID", "CustomMsg"),
                IsUpload = false
            };
            ...
            Payment_Number = new (this, "x_Payment_Number", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "Payment_Number", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Paid = new (this, "x_date_Paid", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "date_Paid", "CustomMsg"),
                IsUpload = false
            };
            ...
            Amount_Paid = new (this, "x_Amount_Paid", 6, SqlDbType.Money) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "Amount_Paid", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Amount_Paid", Amount_Paid);

            // Running Balance
            RunningBalance = new (this, "x_RunningBalance", 6, SqlDbType.Money) {
                Name = "Running Balance",
                Expression = "[Running Balance]",
                BasicSearchExpression = "CAST([Running Balance] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[Running Balance]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "RunningBalance", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Running Balance", RunningBalance);
            ...
            date_Created = new (this, "x_date_Created", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "date_Created", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Modified = new (this, "x_date_Modified", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "date_Modified", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_ApprovalCode = new (this, "x_str_ApprovalCode", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "str_ApprovalCode", "CustomMsg"),
                IsUpload = false
            };
            ...
            Package_Name = new (this, "x_Package_Name", 200, SqlDbType.VarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "Package_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "Price", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Package_ID = new (this, "x_int_Package_ID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("qryBillingDetails", "int_Package_ID", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.qryBillingDetails";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                RunningBalance.DbValue = row["Running Balance"]; // Set DB value only
        ...
        {
            if (SameString(pageName, "QryBillingDetailsView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryBillingDetailsEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryBillingDetailsAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryBillingDetailsView",
                Config.ApiAddAction => "QryBillingDetailsAdd",
                Config.ApiEditAction => "QryBillingDetailsEdit",
                Config.ApiDeleteAction => "QryBillingDetailsDelete",
                Config.ApiListAction => "QryBillingDetailsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryBillingDetailsList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryBillingDetailsView", parm);
            else
                url = KeyUrl("QryBillingDetailsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryBillingDetailsAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryBillingDetailsAdd?" + parm;
            else
                url = "QryBillingDetailsAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryBillingDetailsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryBillingDetailsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryBillingDetailsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryBillingDetailsList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryBillingDetailsDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            RunningBalance.SetDbValue(dr["Running Balance"]);
        ...
        {
            string pageName = "QryBillingDetailsList";
        ...
        public async Task RenderListRow()
        {
            ...
            // Running Balance
            RunningBalance.ViewValue = RunningBalance.CurrentValue;
            RunningBalance.ViewValue = FormatNumber(RunningBalance.ViewValue, RunningBalance.FormatPattern);
            RunningBalance.ViewCustomAttributes = "";
            ...
            // Running Balance
            RunningBalance.HrefValue = "";
            RunningBalance.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Running Balance
            RunningBalance.SetupEditAttributes();
            RunningBalance.EditValue = RunningBalance.CurrentValue; // DN
            RunningBalance.PlaceHolder = RemoveHtml(RunningBalance.Caption);
            if (!Empty(RunningBalance.EditValue) && IsNumeric(RunningBalance.EditValue))
                RunningBalance.EditValue = FormatNumber(RunningBalance.EditValue, null);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(RunningBalance);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(RunningBalance);
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM dbo.qryBillingDetails";
