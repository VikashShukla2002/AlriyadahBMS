...
public partial class JUN26 {
    /// <summary>
    /// rptqryInvoiceItemPrices
    /// </summary>
    [MaybeNull]
    public static RptqryInvoiceItemPrices rptqryInvoiceItemPrices
    {
        get => HttpData.Resolve<RptqryInvoiceItemPrices>("rptqryInvoiceItemPrices");
        set => HttpData["rptqryInvoiceItemPrices"] = value;
    }

    /// <summary>
    /// Table class for rptqryInvoiceItemPrices
    /// </summary>
    public class RptqryInvoiceItemPrices : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public RptqryInvoiceItemPrices()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "rptqryInvoiceItemPrices";
            Name = "rptqryInvoiceItemPrices";
            Type = "VIEW";
            UpdateTable = "dbo.rptqryInvoiceItemPrices"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Package_No = new (this, "x_Package_No", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("rptqryInvoiceItemPrices", "Package_No", "CustomMsg"),
                IsUpload = false
            };
            ...
            Package_Name = new (this, "x_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("rptqryInvoiceItemPrices", "Package_Name", "CustomMsg"),
                IsUpload = false
            };
            ...
            Item_No = new (this, "x_Item_No", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("rptqryInvoiceItemPrices", "Item_No", "CustomMsg"),
                IsUpload = false
            };
            ...
            Service_Description = new (this, "x_Service_Description", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("rptqryInvoiceItemPrices", "Service_Description", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("rptqryInvoiceItemPrices", "Price", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.rptqryInvoiceItemPrices";
            set => _sqlFrom = value;
        }
        ...
        public string ReturnUrl
        {
            get {
                ...
                if (!Empty(Session[name])) {
                    ...
                    return "RptqryInvoiceItemPricesList";
                }
            }
            set {
        ...
        {
            if (SameString(pageName, "RptqryInvoiceItemPricesView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "RptqryInvoiceItemPricesEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "RptqryInvoiceItemPricesAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "RptqryInvoiceItemPricesView",
                Config.ApiAddAction => "RptqryInvoiceItemPricesAdd",
                Config.ApiEditAction => "RptqryInvoiceItemPricesEdit",
                Config.ApiDeleteAction => "RptqryInvoiceItemPricesDelete",
                Config.ApiListAction => "RptqryInvoiceItemPricesList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "RptqryInvoiceItemPricesList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("RptqryInvoiceItemPricesView", parm);
            else
                url = KeyUrl("RptqryInvoiceItemPricesView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "RptqryInvoiceItemPricesAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "RptqryInvoiceItemPricesAdd?" + parm;
            else
                url = "RptqryInvoiceItemPricesAdd";
        ...
        {
            string url = "";
            url = KeyUrl("RptqryInvoiceItemPricesEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("RptqryInvoiceItemPricesList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("RptqryInvoiceItemPricesAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("RptqryInvoiceItemPricesList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("RptqryInvoiceItemPricesDelete")); // DN
        ...
        {
            string pageName = "RptqryInvoiceItemPricesList";
