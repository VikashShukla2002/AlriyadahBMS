...
public partial class JUN26 {
    ...
    /// appointmentCldrView
    /// </summary>
    public static AppointmentCldrView appointmentCldrView
    {
        get => HttpData.Get<AppointmentCldrView>("appointmentCldrView")!;
        set => HttpData["appointmentCldrView"] = value;
    }

    /// <summary>
    /// Page class for Appointment_Cldr
    /// </summary>
    public class AppointmentCldrView : AppointmentCldrViewBase
    {
        // Constructor
        public AppointmentCldrView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AppointmentCldrView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AppointmentCldrViewBase : AppointmentCldr
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "appointmentCldrView";
        ...
        // Constructor
        public AppointmentCldrViewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "AppointmentCldrView";
        ...
        public void SetVisibility()
        {
            ...
            str_CRSS_IDUSER.SetVisibility();
        }

        // Constructor
        public AppointmentCldrViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("Id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "AppointmentCldrList"; // Return to list
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                appointmentCldrView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"fAppointment_Cldrview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
