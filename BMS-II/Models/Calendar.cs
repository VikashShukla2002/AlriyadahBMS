...
public partial class JUN26 {
    ...
    {
        get => HttpData.Resolve<Calendar>("Calendar");
        set => HttpData["Calendar"] = value;
    }

    /// <summary>
    /// Table class for Calendar
    /// </summary>
    public class Calendar : DbTable, IQueryFactory
    {
        ...
        public Calendar()
        {
            ...
            Name = "Calendar";
            Type = "TABLE";
            UpdateTable = "dbo.Calendar"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            Id = new (this, "x_Id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar", "Id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Id", Id);
            ...
            _Title = new (this, "x__Title", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar", "_Title", "CustomMsg"),
                IsUpload = false
            };
            ...
            Start = new (this, "x_Start", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar", "Start", "CustomMsg"),
                IsUpload = false
            };
            ...
            End = new (this, "x_End", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar", "End", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("End", End);
            ...
            AllDay = new (this, "x_AllDay", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar", "AllDay", "CustomMsg"),
                IsUpload = false
            };
            AllDay.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(AllDay, "Calendar", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(AllDay, "Calendar", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(AllDay, "Calendar", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            ...
            Description = new (this, "x_Description", 203, SqlDbType.NText) {
                ...
                CustomMessage = Language.FieldPhrase("Calendar", "Description", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            _Url = new (this, "x__Url", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar", "_Url", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Url", _Url);
            ...
            ClassNames = new (this, "x_ClassNames", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar", "ClassNames", "CustomMsg"),
                IsUpload = false
            };
            ...
            Display = new (this, "x_Display", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar", "Display", "CustomMsg"),
                IsUpload = false
            };
            ...
            BackgroundColor = new (this, "x_BackgroundColor", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Calendar", "BackgroundColor", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            if (SameString(pageName, "CalendarView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "CalendarEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "CalendarAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "CalendarView",
                Config.ApiAddAction => "CalendarAdd",
                Config.ApiEditAction => "CalendarEdit",
                Config.ApiDeleteAction => "CalendarDelete",
                Config.ApiListAction => "CalendarList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "CalendarList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("CalendarView", parm);
            else
                url = KeyUrl("CalendarView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "CalendarAdd";
        ...
        {
            string url = "";
            url = KeyUrl("CalendarEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("CalendarList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("CalendarAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("CalendarList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("CalendarDelete")); // DN
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM dbo.Calendar";
