...
public partial class JUN26 {
    ...
    {
        get => HttpData.Resolve<UserLevels>("UserLevels");
    ...
    /// </summary>
    public class UserLevels : DbTable, IQueryFactory
    {
        ...
        public UserLevels()
        {
            ...
            Name = "UserLevels";
            Type = "TABLE";
            UpdateTable = "dbo.UserLevels"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            UserLevelID = new (this, "x_UserLevelID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("UserLevels", "UserLevelID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("UserLevelID", UserLevelID);

            // UserLevelName
            UserLevelName = new (this, "x_UserLevelName", 202, SqlDbType.NVarChar) {
                Name = "UserLevelName",
                ...
                CustomMessage = Language.FieldPhrase("UserLevels", "UserLevelName", "CustomMsg"),
                IsUpload = false
            };
        ...
        public async Task<int> UpdateAsync(object data, object? where, Dictionary<string, object>? rsold)
        {
            ...
            if (result > 0 && AuditTrailOnEdit && rsold != null) {
                ...
                if (!rsaudit.ContainsKey("UserLevelID"))
                    rsaudit.Add("UserLevelID", rsold["UserLevelID"]);
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                UserLevelName.DbValue = row["UserLevelName"]; // Set DB value only
            } catch {}
        }
        ...
        public string GetRecordFilter(Dictionary<string, object>? row = null, bool current = false)
        {
            ...
            val = row?.TryGetValue("UserLevelID", out result) ?? false
                ? result
                : !Empty(UserLevelID.OldValue) && !current ? UserLevelID.OldValue : UserLevelID.CurrentValue;
            if (!IsNumeric(val))
        ...
        public Dictionary<string, object>? GetRowFilterAsDictionary(IDictionary<string, object>? row = null)
        {
            ...
            val = row?.TryGetValue("UserLevelID", out result) ?? false
                ? result
                : !Empty(UserLevelID.OldValue) ? UserLevelID.OldValue : UserLevelID.CurrentValue;
            if (!IsNumeric(val))
                return null; // Invalid key
            if (Empty(val))
                return null; // Invalid key
            keyFilter.Add("UserLevelID", val); // Add key value
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "UserLevelsView",
                Config.ApiAddAction => "UserLevelsAdd",
                Config.ApiEditAction => "UserLevelsEdit",
                Config.ApiDeleteAction => "UserLevelsDelete",
                Config.ApiListAction => "UserLevelsList",
                _ => String.Empty
            };
        }
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("UserLevelsView", parm);
            else
                url = KeyUrl("UserLevelsView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }
        ...
        {
            string url = "";
            url = KeyUrl("UserLevelsEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("UserLevelsList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("UserLevelsAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("UserLevelsList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("UserLevelsDelete")); // DN
        ...
        public string GetKey(bool current = false)
        {
            ...
            string val;
            val = current ? ConvertToString(UserLevelID.CurrentValue) ?? "" : ConvertToString(UserLevelID.OldValue) ?? "";
            if (Empty(val))
                return String.Empty;
            keys.Add(val);
        ...
        public string GetKey(IDictionary<string, object> row)
        {
            List<string> keys = new ();
            object? val = null, result;
            val = row?.TryGetValue("UserLevelID", out result) ?? false ? ConvertToString(result) : null;
            if (Empty(val))
        ...
        public void SetKey(string key, bool current = false)
        {
            ...
            if (keys.Length == 1) {
                if (current) {
                    UserLevelID.CurrentValue = keys[0];
                } else {
                    UserLevelID.OldValue = keys[0];
                }
            }
        }
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            UserLevelName.SetDbValue(dr["UserLevelName"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "UserLevelsList";
        ...
        public async Task WriteAuditTrailLog(string log) => await WriteAuditTrailAsync(CurrentUser(), log, "UserLevels");
