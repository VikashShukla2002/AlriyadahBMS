...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static ClassStatus classStatus
    {
        get => HttpData.Resolve<ClassStatus>("Class_Status");
        set => HttpData["Class_Status"] = value;
    }

    /// <summary>
    /// Table class for Class Status
    /// </summary>
    public class ClassStatus : ReportTable, IQueryFactory
    {
        ...
        public readonly ReportField<SqlDbType> ClassStatus2;

        public readonly ReportField<SqlDbType> str_Package_Name;

        public readonly ReportField<SqlDbType> Numberofopenclasses;
        ...
        public ClassStatus()
        {
            ...
            Name = "Class Status";
            Type = "REPORT";
            ReportSourceTable = "dshbdClasses"; // Report source table
            ReportSourceTableName = "dshbdClasses"; // Report source table name
            ...
            // Class Status
            ClassStatus2 = new (this, "x_ClassStatus2", 200, SqlDbType.VarChar) {
                Name = "Class Status",
                ...
                CustomMessage = Language.FieldPhrase("Class_Status", "ClassStatus2", "CustomMsg"),
                SourceTableVar = "dshbdClasses",
                IsUpload = false
            };
            Fields.Add("Class Status", ClassStatus2);
            ...
            str_Package_Name = new (this, "x_str_Package_Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Class_Status", "str_Package_Name", "CustomMsg"),
                SourceTableVar = "dshbdClasses",
                IsUpload = false
            };
            ...
            Numberofopenclasses = new (this, "x_Numberofopenclasses", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("Class_Status", "Numberofopenclasses", "CustomMsg"),
                SourceTableVar = "dshbdClasses",
                IsUpload = false
            };
        ...
        {
            get => !Empty(_sqlSelectAggregate) ? _sqlSelectAggregate : "SELECT COUNT(*) AS cnt_numberofopenclasses FROM " + SqlFrom;
        ...
        public string SqlSelect { // Select
            get {
                if (!Empty(_sqlSelect))
                    return _sqlSelect;
                string select = "*";
                if (!Empty(ClassStatus2.GroupSql)) {
                    string expr = ClassStatus2.GroupSql.Replace("%s", ClassStatus2.Expression) + " AS " + QuotedName(ClassStatus2.GroupName, DbId);
                    select += ", " + expr;
                }
                if (!Empty(str_Package_Name.GroupSql)) {
                    string expr = str_Package_Name.GroupSql.Replace("%s", str_Package_Name.Expression) + " AS " + QuotedName(str_Package_Name.GroupName, DbId);
                    select += ", " + expr;
                }
