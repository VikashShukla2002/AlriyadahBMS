...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static DshbdRegistered dshbdRegistered
    {
        get => HttpData.Resolve<DshbdRegistered>("dshbdRegistered");
        set => HttpData["dshbdRegistered"] = value;
    }

    /// <summary>
    /// Table class for dshbdRegistered
    /// </summary>
    public class DshbdRegistered : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> RegistrationDate;

        public readonly DbField<SqlDbType> NationalID;

        public readonly DbField<SqlDbType> str_Username;

        public readonly DbField<SqlDbType> DrivingExperience;

        // Constructor
        public DshbdRegistered()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "dshbdRegistered";
            Name = "dshbdRegistered";
            Type = "VIEW";
            UpdateTable = "dbo.dshbdRegistered"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            str_Full_Name = new (this, "x_str_Full_Name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdRegistered", "str_Full_Name", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("str_Full_Name", str_Full_Name);

            // Registration Date
            RegistrationDate = new (this, "x_RegistrationDate", 135, SqlDbType.DateTime) {
                Name = "Registration Date",
                Expression = "[Registration Date]",
                BasicSearchExpression = CastDateFieldForLike("[Registration Date]", 0, "DB"),
                DateTimeFormat = 0,
                VirtualExpression = "[Registration Date]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("dshbdRegistered", "RegistrationDate", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Registration Date", RegistrationDate);
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdRegistered", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdRegistered", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("str_Username", str_Username);

            // Driving Experience
            DrivingExperience = new (this, "x_DrivingExperience", 200, SqlDbType.VarChar) {
                Name = "Driving Experience",
                Expression = "[Driving Experience]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Driving Experience]",
                DateTimeFormat = -1,
                VirtualExpression = "[Driving Experience]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("dshbdRegistered", "DrivingExperience", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Driving Experience", DrivingExperience);
        ...
        {
            get => _sqlFrom ?? "dbo.dshbdRegistered";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                RegistrationDate.DbValue = row["Registration Date"]; // Set DB value only
                NationalID.DbValue = row["NationalID"]; // Set DB value only
                str_Username.DbValue = row["str_Username"]; // Set DB value only
                DrivingExperience.DbValue = row["Driving Experience"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "DshbdRegisteredView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "DshbdRegisteredEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "DshbdRegisteredAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "DshbdRegisteredView",
                Config.ApiAddAction => "DshbdRegisteredAdd",
                Config.ApiEditAction => "DshbdRegisteredEdit",
                Config.ApiDeleteAction => "DshbdRegisteredDelete",
                Config.ApiListAction => "DshbdRegisteredList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "DshbdRegisteredList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("DshbdRegisteredView", parm);
            else
                url = KeyUrl("DshbdRegisteredView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "DshbdRegisteredAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "DshbdRegisteredAdd?" + parm;
            else
                url = "DshbdRegisteredAdd";
        ...
        {
            string url = "";
            url = KeyUrl("DshbdRegisteredEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("DshbdRegisteredList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("DshbdRegisteredAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("DshbdRegisteredList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("DshbdRegisteredDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            RegistrationDate.SetDbValue(dr["Registration Date"]);
            NationalID.SetDbValue(dr["NationalID"]);
            str_Username.SetDbValue(dr["str_Username"]);
            DrivingExperience.SetDbValue(dr["Driving Experience"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "DshbdRegisteredList";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Registration Date
            RegistrationDate.SetupEditAttributes();
            RegistrationDate.EditValue = FormatDateTime(RegistrationDate.CurrentValue, RegistrationDate.FormatPattern); // DN
            RegistrationDate.PlaceHolder = RemoveHtml(RegistrationDate.Caption);
            ...
            // Driving Experience
            DrivingExperience.SetupEditAttributes();
            if (!DrivingExperience.Raw)
                DrivingExperience.CurrentValue = HtmlDecode(DrivingExperience.CurrentValue);
            DrivingExperience.EditValue = HtmlEncode(DrivingExperience.CurrentValue);
            DrivingExperience.PlaceHolder = RemoveHtml(DrivingExperience.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(RegistrationDate);
                        doc.ExportCaption(NationalID);
                        doc.ExportCaption(str_Username);
                        doc.ExportCaption(DrivingExperience);
                    } else {
                        doc.ExportCaption(str_Full_Name);
                        doc.ExportCaption(RegistrationDate);
                        doc.ExportCaption(NationalID);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(RegistrationDate);
                            await doc.ExportField(NationalID);
                            await doc.ExportField(str_Username);
                            await doc.ExportField(DrivingExperience);
                        } else {
                            await doc.ExportField(str_Full_Name);
                            await doc.ExportField(RegistrationDate);
                            await doc.ExportField(NationalID);
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM dbo.dshbdRegistered";
