...
public partial class JUN26 {
    /// <summary>
    /// qryEvalCalcWshtResultsList
    /// </summary>
    public static QryEvalCalcWshtResultsList qryEvalCalcWshtResultsList
    {
        get => HttpData.Get<QryEvalCalcWshtResultsList>("qryEvalCalcWshtResultsList")!;
        set => HttpData["qryEvalCalcWshtResultsList"] = value;
    }

    /// <summary>
    /// Page class for qryEvalCalcWsht_Results
    /// </summary>
    public class QryEvalCalcWshtResultsList : QryEvalCalcWshtResultsListBase
    {
        // Constructor
        public QryEvalCalcWshtResultsList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public QryEvalCalcWshtResultsList() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class QryEvalCalcWshtResultsListBase : QryEvalCalcWshtResults
    {
        // Page ID
        ...
        // Table name
        public string TableName { get; set; } = "qryEvalCalcWsht_Results";

        // Page object name
        public string PageObjName = "qryEvalCalcWshtResultsList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "fqryEvalCalcWsht_Resultslist";
        ...
        // Constructor
        public QryEvalCalcWshtResultsListBase()
        {
            ...
            // Table object (qryEvalCalcWshtResults)
            if (qryEvalCalcWshtResults == null || qryEvalCalcWshtResults is QryEvalCalcWshtResults)
                qryEvalCalcWshtResults = this;

            // Initialize URLs
            AddUrl = "QryEvalCalcWshtResultsAdd";
            ...
            MultiDeleteUrl = "QryEvalCalcWshtResultsDelete";
            MultiUpdateUrl = "QryEvalCalcWshtResultsUpdate";
        ...
        // Page name
        public string PageName => "QryEvalCalcWshtResultsList";
        ...
        // Constructor
        public QryEvalCalcWshtResultsListBase(Controller? controller = null): this() { // DN
            if (controller != null)
                ...
                if (Response != null && !Response.HasStarted) {
                    ...
                    if (IsModal) { // Show as modal
                        ...
                        if (pageName != ListUrl) { // Not List page
                            ...
                            result.Add("view", pageName == "QryEvalCalcWshtResultsView" ? "1" : "0"); // If View page, no primary button
                        } else { // List page
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (IsModal)
                FormName = "fqryEvalCalcWsht_Resultsgrid";
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                qryEvalCalcWshtResultsList?.PageRender();
            }
            return PageResult();
        }
        #pragma warning restore 219
        ...
        public async Task<string> GetFilterList()
        {
            ...
            if (Config.SearchFilterOption == "Server")
                savedFilterList = await Profile.GetSearchFilters(CurrentUserName(), "fqryEvalCalcWsht_Resultssrch");
        ...
        protected async Task<object?> ProcessFilterList() {
            if (Post("ajax") == "savefilters") {
                ...
                await Profile.SetSearchFilters(CurrentUserName(), "fqryEvalCalcWsht_Resultssrch", filters);
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fqryEvalCalcWsht_Resultslist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"fqryEvalCalcWsht_Resultslist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<div class=\"btn-group\"><div class=\"form-check\"><input type=\"checkbox\" name=\"key\" id=\"key\" class=\"form-check-input\" data-ew-action=\"select-all-keys\" form=\"fqryEvalCalcWsht_Resultslist\"><label class=\"form-check-label\" for=\"key\">" + Language.Phrase("SelectAll") + "</label></div></div>";
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"fqryEvalCalcWsht_Resultssrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"fqryEvalCalcWsht_Resultssrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"fqryEvalCalcWsht_Resultslist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_qryEvalCalcWsht_Results");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(qryEvalCalcWshtResultsList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(qryEvalCalcWshtResultsList.RowCount) + "_qryEvalCalcWsht_Results");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(qryEvalCalcWshtResultsList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && qryEvalCalcWshtResultsList.RowType == RowType.Add || IsEdit && qryEvalCalcWshtResultsList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"fqryEvalCalcWsht_Resultssrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
