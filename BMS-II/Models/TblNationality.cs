...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static TblNationality tblNationality
    {
        get => HttpData.Resolve<TblNationality>("tblNationality");
        set => HttpData["tblNationality"] = value;
    }

    /// <summary>
    /// Table class for tblNationality
    /// </summary>
    public class TblNationality : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> Nationality_en;

        public readonly DbField<SqlDbType> Nationality_arabic;

        public readonly DbField<SqlDbType> IsActive;

        public readonly DbField<SqlDbType> IsDeleted;
        ...
        public TblNationality()
        {
            ...
            Name = "tblNationality";
            Type = "TABLE";
            UpdateTable = "dbo.tblNationality"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            ID = new (this, "x_ID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("tblNationality", "ID", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("ID", ID);

            // Nationality_en
            Nationality_en = new (this, "x_Nationality_en", 202, SqlDbType.NVarChar) {
                Name = "Nationality_en",
                Expression = "[Nationality_en]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Nationality_en]",
                DateTimeFormat = -1,
                VirtualExpression = "[Nationality_en]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("tblNationality", "Nationality_en", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Nationality_en", Nationality_en);

            // Nationality_arabic
            Nationality_arabic = new (this, "x_Nationality_arabic", 202, SqlDbType.NVarChar) {
                Name = "Nationality_arabic",
                Expression = "[Nationality_arabic]",
                UseBasicSearch = true,
                BasicSearchExpression = "[Nationality_arabic]",
                DateTimeFormat = -1,
                VirtualExpression = "[Nationality_arabic]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblNationality", "Nationality_arabic", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Nationality_arabic", Nationality_arabic);
            ...
            IsActive = new (this, "x_IsActive", 11, SqlDbType.Bit) {
                ...
                CustomMessage = Language.FieldPhrase("tblNationality", "IsActive", "CustomMsg"),
                IsUpload = false
            };
            IsActive.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(IsActive, "tblNationality", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(IsActive, "tblNationality", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(IsActive, "tblNationality", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("IsActive", IsActive);

            // IsDeleted
            IsDeleted = new (this, "x_IsDeleted", 11, SqlDbType.Bit) {
                Name = "IsDeleted",
                Expression = "[IsDeleted]",
                BasicSearchExpression = "[IsDeleted]",
                DateTimeFormat = -1,
                VirtualExpression = "[IsDeleted]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                OptionCount = 2,
                SearchOperators = new () { "=", "<>", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblNationality", "IsDeleted", "CustomMsg"),
                IsUpload = false
            };
            IsDeleted.Lookup = CurrentLanguage switch {
                "ar-SA" => new Lookup<DbField>(IsDeleted, "tblNationality", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                "en-US" => new Lookup<DbField>(IsDeleted, "tblNationality", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", ""),
                _ => new Lookup<DbField>(IsDeleted, "tblNationality", false, "", new List<string> {"", "", "", ""}, "", "", new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, new List<string> {}, "", "", "")
            };
            Fields.Add("IsDeleted", IsDeleted);
            ...
            int_Status = new (this, "x_int_Status", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("tblNationality", "int_Status", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Created_By = new (this, "x_int_Created_By", 131, SqlDbType.Decimal) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblNationality", "int_Created_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Modified_By = new (this, "x_int_Modified_By", 131, SqlDbType.Decimal) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectFloat"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblNationality", "int_Modified_By", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Created = new (this, "x_date_Created", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblNationality", "date_Created", "CustomMsg"),
                IsUpload = false
            };
            ...
            date_Modified = new (this, "x_date_Modified", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", CurrentDateTimeFormat.ShortDatePattern),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("tblNationality", "date_Modified", "CustomMsg"),
                IsUpload = false
            };
        ...
        {
            get => _sqlFrom ?? "dbo.tblNationality";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                Nationality_en.DbValue = row["Nationality_en"]; // Set DB value only
                Nationality_arabic.DbValue = row["Nationality_arabic"]; // Set DB value only
                IsActive.DbValue = (ConvertToBool(row["IsActive"]) ? "1" : "0"); // Set DB value only
                IsDeleted.DbValue = (ConvertToBool(row["IsDeleted"]) ? "1" : "0"); // Set DB value only
        ...
        {
            if (SameString(pageName, "TblNationalityView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "TblNationalityEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "TblNationalityAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "TblNationalityView",
                Config.ApiAddAction => "TblNationalityAdd",
                Config.ApiEditAction => "TblNationalityEdit",
                Config.ApiDeleteAction => "TblNationalityDelete",
                Config.ApiListAction => "TblNationalityList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "TblNationalityList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("TblNationalityView", parm);
            else
                url = KeyUrl("TblNationalityView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "TblNationalityAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "TblNationalityAdd?" + parm;
            else
                url = "TblNationalityAdd";
        ...
        {
            string url = "";
            url = KeyUrl("TblNationalityEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("TblNationalityList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("TblNationalityAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("TblNationalityList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("TblNationalityDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            if (dr == null)
                return;
            ID.SetDbValue(dr["ID"]);
            Nationality_en.SetDbValue(dr["Nationality_en"]);
            Nationality_arabic.SetDbValue(dr["Nationality_arabic"]);
            IsActive.SetDbValue(ConvertToBool(dr["IsActive"]) ? "1" : "0");
            IsDeleted.SetDbValue(ConvertToBool(dr["IsDeleted"]) ? "1" : "0");
        ...
        {
            string pageName = "TblNationalityList";
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(Nationality_en);
                        doc.ExportCaption(Nationality_arabic);
                        doc.ExportCaption(IsActive);
                        doc.ExportCaption(IsDeleted);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(Nationality_en);
                            await doc.ExportField(Nationality_arabic);
                            await doc.ExportField(IsActive);
                            await doc.ExportField(IsDeleted);
