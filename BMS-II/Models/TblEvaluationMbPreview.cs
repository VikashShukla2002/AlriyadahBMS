...
public partial class JUN26 {
    /// <summary>
    /// tblEvaluationMbPreview
    /// </summary>
    public static TblEvaluationMbPreview tblEvaluationMbPreview
    {
        get => HttpData.Get<TblEvaluationMbPreview>("tblEvaluationMbPreview")!;
        set => HttpData["tblEvaluationMbPreview"] = value;
    }

    /// <summary>
    /// Page class for tblEvaluationMB
    /// </summary>
    public class TblEvaluationMbPreview : TblEvaluationMbPreviewBase
    {
        // Constructor
        public TblEvaluationMbPreview(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblEvaluationMbPreview() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TblEvaluationMbPreviewBase : TblEvaluationMb
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblEvaluationMbPreview";
        ...
        // Constructor
        public TblEvaluationMbPreviewBase()
        {
            // Initialize
            CurrentPage = this;
        ...
        // Page name
        public string PageName => "TblEvaluationMbPreview";
        ...
        // Constructor
        public TblEvaluationMbPreviewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        protected void HideFieldsForAddEdit() {
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                tblEvaluationMbPreview?.PageRender();
            }
                return PageResult();
            }
