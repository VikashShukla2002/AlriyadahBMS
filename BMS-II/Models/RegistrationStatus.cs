...
public partial class JUN26 {
    ...
    {
        get => HttpData.Resolve<RegistrationStatus>("Registration_Status");
        set => HttpData["Registration_Status"] = value;
    }

    /// <summary>
    /// Table class for Registration Status
    /// </summary>
    public class RegistrationStatus : ReportTable, IQueryFactory
    {
        ...
        public readonly ReportField<SqlDbType> RegistrationDate;

        public readonly ReportField<SqlDbType> NationalID;

        public readonly ReportField<SqlDbType> DrivingExperience;
        ...
        public RegistrationStatus()
        {
            ...
            Type = "REPORT";
            ReportSourceTable = "dshbdRegistered"; // Report source table
            ReportSourceTableName = "dshbdRegistered"; // Report source table name
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Registration_Status", "str_Username", "CustomMsg"),
                SourceTableVar = "dshbdRegistered",
                IsUpload = false
            };
            ...
            str_Full_Name = new (this, "x_str_Full_Name", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Registration_Status", "str_Full_Name", "CustomMsg"),
                SourceTableVar = "dshbdRegistered",
                IsUpload = false
            };
            ...
            RegistrationDate = new (this, "x_RegistrationDate", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("Registration_Status", "RegistrationDate", "CustomMsg"),
                SourceTableVar = "dshbdRegistered",
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("Registration_Status", "NationalID", "CustomMsg"),
                SourceTableVar = "dshbdRegistered",
                IsUpload = false
            };
            ...
            DrivingExperience = new (this, "x_DrivingExperience", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("Registration_Status", "DrivingExperience", "CustomMsg"),
                SourceTableVar = "dshbdRegistered",
                IsUpload = false
            };
        ...
        {
            get => !Empty(_sqlSelectAggregate) ? _sqlSelectAggregate : "SELECT COUNT(*) AS cnt_nationalid FROM " + SqlFrom;
        ...
        public string SqlSelect { // Select
            get {
                ...
                if (!Empty(RegistrationDate.GroupSql)) {
                    string expr = RegistrationDate.GroupSql.Replace("%s", RegistrationDate.Expression) + " AS " + QuotedName(RegistrationDate.GroupName, DbId);
                    select += ", " + expr;
                }
                if (!Empty(DrivingExperience.GroupSql)) {
                    string expr = DrivingExperience.GroupSql.Replace("%s", DrivingExperience.Expression) + " AS " + QuotedName(DrivingExperience.GroupName, DbId);
                    select += ", " + expr;
                }
