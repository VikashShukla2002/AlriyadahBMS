...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static QryLmsStudEnrolTot qryLmsStudEnrolTot
    {
        get => HttpData.Resolve<QryLmsStudEnrolTot>("qryLMS_Stud_Enrol_Tot");
        set => HttpData["qryLMS_Stud_Enrol_Tot"] = value;
    }

    /// <summary>
    /// Table class for qryLMS_Stud_Enrol_Tot
    /// </summary>
    public class QryLmsStudEnrolTot : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> TotalStudentsEnrolled;

        // Constructor
        public QryLmsStudEnrolTot()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "qryLMS_Stud_Enrol_Tot";
            Name = "qryLMS_Stud_Enrol_Tot";
            Type = "VIEW";
            UpdateTable = "dbo.qryLMS_Stud_Enrol_Tot"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            idnumber = new (this, "x_idnumber", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("qryLMS_Stud_Enrol_Tot", "idnumber", "CustomMsg"),
                IsUpload = false
            };
            ...
            groupid = new (this, "x_groupid", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("qryLMS_Stud_Enrol_Tot", "groupid", "CustomMsg"),
                IsUpload = false
            };
            ...
            _name = new (this, "x__name", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryLMS_Stud_Enrol_Tot", "_name", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("name", _name);

            // Gender
            Gender = new (this, "x_Gender", 200, SqlDbType.VarChar) {
                Name = "Gender",
                Expression = "[Gender]",
                UseBasicSearch = true,
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("qryLMS_Stud_Enrol_Tot", "Gender", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Gender", Gender);

            // Total Students Enrolled
            TotalStudentsEnrolled = new (this, "x_TotalStudentsEnrolled", 3, SqlDbType.Int) {
                Name = "Total Students Enrolled",
                Expression = "[Total Students Enrolled]",
                BasicSearchExpression = "CAST([Total Students Enrolled] AS NVARCHAR)",
                DateTimeFormat = -1,
                VirtualExpression = "[Total Students Enrolled]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                CustomMessage = Language.FieldPhrase("qryLMS_Stud_Enrol_Tot", "TotalStudentsEnrolled", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("Total Students Enrolled", TotalStudentsEnrolled);
        ...
        {
            get => _sqlFrom ?? "dbo.qryLMS_Stud_Enrol_Tot";
            set => _sqlFrom = value;
        }
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                TotalStudentsEnrolled.DbValue = row["Total Students Enrolled"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "QryLmsStudEnrolTotView"))
                return Language.Phrase("View");
            else if (SameString(pageName, "QryLmsStudEnrolTotEdit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "QryLmsStudEnrolTotAdd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "QryLmsStudEnrolTotView",
                Config.ApiAddAction => "QryLmsStudEnrolTotAdd",
                Config.ApiEditAction => "QryLmsStudEnrolTotEdit",
                Config.ApiDeleteAction => "QryLmsStudEnrolTotDelete",
                Config.ApiListAction => "QryLmsStudEnrolTotList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "QryLmsStudEnrolTotList";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("QryLmsStudEnrolTotView", parm);
            else
                url = KeyUrl("QryLmsStudEnrolTotView", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "QryLmsStudEnrolTotAdd";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "QryLmsStudEnrolTotAdd?" + parm;
            else
                url = "QryLmsStudEnrolTotAdd";
        ...
        {
            string url = "";
            url = KeyUrl("QryLmsStudEnrolTotEdit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryLmsStudEnrolTotList", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("QryLmsStudEnrolTotAdd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("QryLmsStudEnrolTotList", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("QryLmsStudEnrolTotDelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            TotalStudentsEnrolled.SetDbValue(dr["Total Students Enrolled"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "QryLmsStudEnrolTotList";
        ...
        public async Task RenderListRow()
        {
            ...
            // Total Students Enrolled
            TotalStudentsEnrolled.ViewValue = TotalStudentsEnrolled.CurrentValue;
            TotalStudentsEnrolled.ViewValue = FormatNumber(TotalStudentsEnrolled.ViewValue, TotalStudentsEnrolled.FormatPattern);
            TotalStudentsEnrolled.ViewCustomAttributes = "";
            ...
            // Total Students Enrolled
            TotalStudentsEnrolled.HrefValue = "";
            TotalStudentsEnrolled.TooltipValue = "";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Total Students Enrolled
            TotalStudentsEnrolled.SetupEditAttributes();
            TotalStudentsEnrolled.EditValue = TotalStudentsEnrolled.CurrentValue; // DN
            TotalStudentsEnrolled.PlaceHolder = RemoveHtml(TotalStudentsEnrolled.Caption);
            if (!Empty(TotalStudentsEnrolled.EditValue) && IsNumeric(TotalStudentsEnrolled.EditValue))
                TotalStudentsEnrolled.EditValue = FormatNumber(TotalStudentsEnrolled.EditValue, null);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(TotalStudentsEnrolled);
                    } else {
                        doc.ExportCaption(idnumber);
                        doc.ExportCaption(groupid);
                        doc.ExportCaption(_name);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(TotalStudentsEnrolled);
                        } else {
                            await doc.ExportField(idnumber);
                            await doc.ExportField(groupid);
                            await doc.ExportField(_name);
