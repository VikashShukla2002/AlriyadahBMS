...
public partial class JUN26 {
    ...
    /// tblEvaluationList
    /// </summary>
    public static TblEvaluationList tblEvaluationList
    {
        get => HttpData.Get<TblEvaluationList>("tblEvaluationList")!;
        set => HttpData["tblEvaluationList"] = value;
    }

    /// <summary>
    /// Page class for tblEvaluation
    /// </summary>
    public class TblEvaluationList : TblEvaluationListBase
    {
        // Constructor
        public TblEvaluationList(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblEvaluationList() : base()
        {
        }
    ...
    /// Page base class
    /// </summary>
    public class TblEvaluationListBase : TblEvaluation
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblEvaluationList";

        // Title
        public string? Title = null; // Title for <title> tag

        // Grid form hidden field names
        public string FormName = "ftblEvaluationlist";
        ...
        public TblEvaluationListBase()
        {
            ...
            MultiDeleteUrl = "TblEvaluationDelete";
            MultiUpdateUrl = "TblEvaluationUpdate";
        ...
        // Page name
        public string PageName => "TblEvaluationList";
        ...
        // Constructor
        public TblEvaluationListBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public async Task<string> GetFilterList()
        {
            ...
            if (Config.SearchFilterOption == "Server")
                savedFilterList = await Profile.GetSearchFilters(CurrentUserName(), "ftblEvaluationsrch");
            ...
            filters.Merge(JObject.Parse(Assigned_int_Package_Id.AdvancedSearch.ToJson())); // Field Assigned_int_Package_Id
        ...
        protected async Task<object?> ProcessFilterList() {
            if (Post("ajax") == "savefilters") {
                ...
                await Profile.SetSearchFilters(CurrentUserName(), "ftblEvaluationsrch", filters);
        ...
        protected bool RestoreFilterList() {
            ...
            // Field Assigned_int_Package_Id
            if (filter?.TryGetValue("x_Assigned_int_Package_Id", out sv) ?? false) {
                Assigned_int_Package_Id.AdvancedSearch.SearchValue = sv;
                Assigned_int_Package_Id.AdvancedSearch.SearchOperator = filter["z_Assigned_int_Package_Id"];
                Assigned_int_Package_Id.AdvancedSearch.SearchCondition = filter["v_Assigned_int_Package_Id"];
                Assigned_int_Package_Id.AdvancedSearch.SearchValue2 = filter["y_Assigned_int_Package_Id"];
                Assigned_int_Package_Id.AdvancedSearch.SearchOperator2 = filter["w_Assigned_int_Package_Id"];
                Assigned_int_Package_Id.AdvancedSearch.Save();
            }
        ...
        public string AdvancedSearchWhere(bool def = false) {
            ...
            BuildSearchSql(ref where, Retake, def, false); // Retake
            ...
            BuildSearchSql(ref where, Assigned_int_Package_Id, def, false); // Assigned_int_Package_Id
            ...
            if (!def && Command == "search") {
                ...
                Assigned_int_Package_Id.AdvancedSearch.Save(); // Assigned_int_Package_Id
        ...
        public void ShowFilterList()
        {
            ...
            if (Empty(filter))
                BuildSearchSql(ref filter, Retake, false, false);
            if (!Empty(filter))
        ...
        public string BasicSearchWhere(bool def = false) {
            ...
            searchFlds.Add(Date_Entered);
            searchFlds.Add(Examination_Number);
            searchFlds.Add(Section_1);
        ...
        protected bool CheckSearchParms() {
            ...
            if (UserlevelID.AdvancedSearch.IssetSession)
                return true;
            if (Assigned_int_Package_Id.AdvancedSearch.IssetSession)
                return true;
        ...
        protected void ResetAdvancedSearchParms() {
            ...
            Assigned_int_Package_Id.AdvancedSearch.UnsetSession();
        ...
        protected void RestoreSearchParms() {
            ...
            Assigned_int_Package_Id.AdvancedSearch.Load();
        ...
        public async Task RenderListOptions()
        {
            ...
            if (isVisible) {
                if (ModalView && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-view"" title=""{viewcaption}"" data-table=""tblEvaluation"" data-caption=""{viewcaption}"" data-ew-action=""modal"" data-action=""view"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(ViewUrl)) + "\" data-btn=\"null\">" + Language.Phrase("ViewLink") + "</a>");
                else
            ...
            if (isVisible) {
                if (ModalEdit && !IsMobile())
                    listOption?.SetBody($@"<a class=""ew-row-link ew-edit"" title=""{editcaption}"" data-table=""tblEvaluation"" data-caption=""{editcaption}"" data-ew-action=""modal"" data-action=""edit"" data-ajax=""" + (UseAjaxActions ? "true" : "false") + "\" data-url=\"" + HtmlEncode(AppPath(EditUrl)) + "\" data-btn=\"SaveBtn\">" + Language.Phrase("EditLink") + "</a>");
                else
            ...
            if (listOption != null && !IsExport() && CurrentAction == "") {
                ...
                foreach (var (key, act) in ListActions.Items) {
                    if (act.Select == Config.ActionSingle && act.Allowed) {
                        ...
                        string link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"ftblEvaluationlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + " " + caption + "</button></li>";
                        if (!Empty(link)) {
                            links.Add(link);
                            if (Empty(body)) // Setup first button
                                body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlTitle(caption) + "\" data-caption=\"" + HtmlTitle(caption) + "\" data-ew-action=\"submit\" form=\"ftblEvaluationlist\" data-key=\"" + KeyToJson(true) + "\"" + act.ToDataAttrs() + ">" + icon + caption + "</button>";
                        }
                    }
                }
        ...
        protected void SetupOtherOptions() {
            ...
            item.Body = "<div class=\"btn-group\"><div class=\"form-check\"><input type=\"checkbox\" name=\"key\" id=\"key\" class=\"form-check-input\" data-ew-action=\"select-all-keys\" form=\"ftblEvaluationlist\"><label class=\"form-check-label\" for=\"key\">" + Language.Phrase("SelectAll") + "</label></div></div>";
            ...
            item.Body = "<a class=\"ew-save-filter\" data-form=\"ftblEvaluationsrch\" data-ew-action=\"none\">" + Language.Phrase("SaveCurrentFilter") + "</a>";
            item.Visible = true;
            item = FilterOptions.Add("deletefilter");
            item.Body = "<a class=\"ew-delete-filter\" data-form=\"ftblEvaluationsrch\" data-ew-action=\"none\">" + Language.Phrase("DeleteFilter") + "</a>";
            item.Visible = true;
        ...
        public void RenderOtherOptions()
        {
            ...
            var options = OtherOptions;
                ...
                foreach (var (key, act) in ListActions.Items.Where(kvp => kvp.Value.Select == Config.ActionMultiple)) {
                    ...
                    item.Body = "<<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" + HtmlEncode(caption) + "\" data-caption=\"" + HtmlEncode(caption) + "\" data-ew-action=\"submit\" form=\"ftblEvaluationlist\"" + act.ToDataAttrs() + ">" + icon + "</button>";
        ...
        public async Task SetupRow()
        {
            if (IsGridAdd || IsGridEdit) {
                if (SameString(RowIndex, "$rowindex$")) { // Render template row first
                    ...
                    RowAttrs.Add("id", "r0_tblEvaluation");
            ...
            RowAttrs.Add("data-rowindex", ConvertToString(tblEvaluationList.RowCount));
            RowAttrs.Add("data-key", GetKey(true));
            RowAttrs.Add("id", "r" + ConvertToString(tblEvaluationList.RowCount) + "_tblEvaluation");
            RowAttrs.Add("data-rowtype", ConvertToString((int)RowType));
            RowAttrs.AppendClass(tblEvaluationList.RowCount % 2 != 1 ? "ew-table-alt-row" : "");
            if (IsAdd && tblEvaluationList.RowType == RowType.Add || IsEdit && tblEvaluationList.RowType == RowType.Edit) // Inline-Add/Edit row
        ...
        protected void LoadSearchValues() {
            ...
            if (!IsAddOrEdit)
                if (Query.ContainsKey("x_Assigned_int_Package_Id"))
                    Assigned_int_Package_Id.AdvancedSearch.SearchValue = Get("x_Assigned_int_Package_Id");
                else
                    Assigned_int_Package_Id.AdvancedSearch.SearchValue = Get("Assigned_int_Package_Id"); // Default Value // DN
            if (!Empty(Assigned_int_Package_Id.AdvancedSearch.SearchValue) && Command == "")
                Command = "search";
            if (Query.ContainsKey("z_Assigned_int_Package_Id"))
                Assigned_int_Package_Id.AdvancedSearch.SearchOperator = Get("z_Assigned_int_Package_Id");
        ...
        protected void SetupSearchOptions() {
            ...
            item.Body = "<a class=\"btn btn-default ew-search-toggle" + searchToggleClass + "\" role=\"button\" title=\"" + Language.Phrase("SearchPanel") + "\" data-caption=\"" + Language.Phrase("SearchPanel") + "\" data-ew-action=\"search-toggle\" data-form=\"ftblEvaluationsrch\" aria-pressed=\"" + (searchToggleClass == " active" ? "true" : "false") + "\">" + Language.Phrase("SearchLink") + "</a>";
            item.Visible = true;
            ...
            if (ModalSearch && !IsMobile())
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-table=\"tblEvaluation\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-ew-action=\"modal\" data-url=\"" + AppPath("TblEvaluationSearch") + "\" data-btn=\"SearchBtn\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            else
                item.Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" + Language.Phrase("AdvancedSearch", true) + "\" data-caption=\"" + Language.Phrase("AdvancedSearch", true) + "\" href=\"" + AppPath("TblEvaluationSearch") + "\">" + Language.Phrase("AdvancedSearch", false) + "</a>";
            item.Visible = true;
