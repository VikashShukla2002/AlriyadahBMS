...
public partial class JUN26 {
    ...
    /// </summary>
    [MaybeNull]
    public static DshbdAssessmentv1 dshbdAssessmentv1
    {
        get => HttpData.Resolve<DshbdAssessmentv1>("dshbdAssessmentv1");
        set => HttpData["dshbdAssessmentv1"] = value;
    }

    /// <summary>
    /// Table class for dshbdAssessmentv1
    /// </summary>
    public class DshbdAssessmentv1 : DbTable, IQueryFactory
    {
        ...
        // Constructor
        public DshbdAssessmentv1()
        {
            // Language object // DN
            Language = ResolveLanguage();
            TableVar = "dshbdAssessmentv1";
            Name = "dshbdAssessmentv1";
            Type = "VIEW";
            UpdateTable = "dbo.dshbdAssessmentv1"; // Update Table
            DbId = "DB"; // DN
            ExportAll = true;
            ...
            str_Full_Name_Hdr = new (this, "x_str_Full_Name_Hdr", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "str_Full_Name_Hdr", "CustomMsg"),
                IsUpload = false
            };
            ...
            AssessmentID = new (this, "x_AssessmentID", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "AssessmentID", "CustomMsg"),
                IsUpload = false
            };
            ...
            NationalID = new (this, "x_NationalID", 20, SqlDbType.BigInt) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "NationalID", "CustomMsg"),
                IsUpload = false
            };
            ...
            AssessmentDate = new (this, "x_AssessmentDate", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "AssessmentDate", "CustomMsg"),
                IsUpload = false
            };
            ...
            AssessmentDone = new (this, "x_AssessmentDone", 200, SqlDbType.VarChar) {
                ...
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "AssessmentDone", "CustomMsg"),
                IsUpload = false
            };
            ...
            str_Username = new (this, "x_str_Username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "str_Username", "CustomMsg"),
                IsUpload = false
            };
            ...
            AbsherApptNbr = new (this, "x_AbsherApptNbr", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "AbsherApptNbr", "CustomMsg"),
                IsUpload = false
            };
            ...
            DLType = new (this, "x_DLType", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "DLType", "CustomMsg"),
                IsUpload = false
            };
            ...
            AssessmentScore = new (this, "x_AssessmentScore", 200, SqlDbType.VarChar) {
                ...
                Required = true, // Required field
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "AssessmentScore", "CustomMsg"),
                IsUpload = false
            };
            ...
            Price = new (this, "x_Price", 6, SqlDbType.Money) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "Price", "CustomMsg"),
                IsUpload = false
            };
            ...
            int_Student_ID = new (this, "x_int_Student_ID", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("dshbdAssessmentv1", "int_Student_ID", "CustomMsg"),
                IsUpload = false
            };
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                AssessmentDone.DbValue = row["Assessment Done"]; // Set DB value only
                str_Username.DbValue = row["str_Username"]; // Set DB value only
                AbsherApptNbr.DbValue = row["AbsherApptNbr"]; // Set DB value only
                DLType.DbValue = row["DL Type"]; // Set DB value only
                AssessmentScore.DbValue = row["Assessment Score"]; // Set DB value only
        ...
        {
            if (SameString(pageName, "DshbdAssessmentv1View"))
                return Language.Phrase("View");
            else if (SameString(pageName, "DshbdAssessmentv1Edit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "DshbdAssessmentv1Add"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "DshbdAssessmentv1View",
                Config.ApiAddAction => "DshbdAssessmentv1Add",
                Config.ApiEditAction => "DshbdAssessmentv1Edit",
                Config.ApiDeleteAction => "DshbdAssessmentv1Delete",
                Config.ApiListAction => "DshbdAssessmentv1List",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "DshbdAssessmentv1List";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("DshbdAssessmentv1View", parm);
            else
                url = KeyUrl("DshbdAssessmentv1View", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "DshbdAssessmentv1Add";
        ...
        public string GetAddUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = "DshbdAssessmentv1Add?" + parm;
            else
                url = "DshbdAssessmentv1Add";
        ...
        {
            string url = "";
            url = KeyUrl("DshbdAssessmentv1Edit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("DshbdAssessmentv1List", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("DshbdAssessmentv1Add", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("DshbdAssessmentv1List", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("DshbdAssessmentv1Delete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            AssessmentDone.SetDbValue(dr["Assessment Done"]);
            str_Username.SetDbValue(dr["str_Username"]);
            AbsherApptNbr.SetDbValue(dr["AbsherApptNbr"]);
            DLType.SetDbValue(dr["DL Type"]);
            AssessmentScore.SetDbValue(dr["Assessment Score"]);
        ...
        {
            string pageName = "DshbdAssessmentv1List";
        ...
        public async Task RenderEditRow()
        {
            ...
            // Assessment Done
            AssessmentDone.SetupEditAttributes();
            if (!AssessmentDone.Raw)
                AssessmentDone.CurrentValue = HtmlDecode(AssessmentDone.CurrentValue);
            AssessmentDone.EditValue = HtmlEncode(AssessmentDone.CurrentValue);
            AssessmentDone.PlaceHolder = RemoveHtml(AssessmentDone.Caption);
            ...
            // DL Type
            DLType.SetupEditAttributes();
            if (!DLType.Raw)
                DLType.CurrentValue = HtmlDecode(DLType.CurrentValue);
            DLType.EditValue = HtmlEncode(DLType.CurrentValue);
            DLType.PlaceHolder = RemoveHtml(DLType.Caption);
        ...
        {
            string wrk = "";
            string sql = "SELECT " + masterfld.Expression + " FROM dbo.dshbdAssessmentv1";
