...
public partial class JUN26 {
    /// <summary>
    /// tblStudentJourneyView
    /// </summary>
    public static TblStudentJourneyView tblStudentJourneyView
    {
        get => HttpData.Get<TblStudentJourneyView>("tblStudentJourneyView")!;
        set => HttpData["tblStudentJourneyView"] = value;
    }

    /// <summary>
    /// Page class for tblStudentJourney
    /// </summary>
    public class TblStudentJourneyView : TblStudentJourneyViewBase
    {
        // Constructor
        public TblStudentJourneyView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public TblStudentJourneyView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class TblStudentJourneyViewBase : TblStudentJourney
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "tblStudentJourneyView";
        ...
        // Constructor
        public TblStudentJourneyViewBase()
        {
            // Initialize
            CurrentPage = this;
            ...
            if (IsApi()) {
                ...
                if (keys.Length > 0)
                    RecordKeys["STDJ_ID"] = keys[0];
            } else {
                RecordKeys["STDJ_ID"] = RouteValues.TryGetValue("STDJ_ID", out obj) && obj != null ? UrlDecode(obj) : Get("STDJ_ID"); // DN
            }
        ...
        // Page name
        public string PageName => "TblStudentJourneyView";
        ...
        // Constructor
        public TblStudentJourneyViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("STDJ_ID", out v) && !Empty(v)) { // DN
                STDJ_ID.QueryValue = UrlDecode(v); // DN
                RecordKeys["STDJ_ID"] = STDJ_ID.QueryValue;
            } else if (Get("STDJ_ID", out sv)) {
                STDJ_ID.QueryValue = sv.ToString();
                RecordKeys["STDJ_ID"] = STDJ_ID.QueryValue;
            } else if (IsApi() && !Empty(keyValues)) {
                STDJ_ID.QueryValue = ConvertToString(keyValues[0]);
                RecordKeys["STDJ_ID"] = STDJ_ID.QueryValue;
            } else if (!loadCurrentRecord) {
                returnUrl = "TblStudentJourneyList"; // Return to list
            }
                ...
                case "show": // Get a record to display
                        ...
                        if (!res) { // Load record based on key
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("TblStudentJourneyList"); // Return to list page
                            }
                        }
                    break;
            }
            ...
            if (!IsApi() && !IsTerminated) {
                ...
                // Page Render event
                tblStudentJourneyView?.PageRender();
            }
            return PageResult();
        }
        ...
        protected string GetExportTag(string type, bool custom = false) {
            ...
            if (SameText(type, "excel")) {
                ...
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-email\" title=\"" + Language.Phrase("ExportToEmail", true) + "\" data-caption=\"" + Language.Phrase("ExportToEmail", true) + "\" form=\"ftblStudentJourneyview\" data-ew-action=\"email\" data-hdr=\"" + Language.Phrase("ExportToEmail", true) + "\" data-key='" + HtmlEncode(ConvertToJsonAttribute(RecordKeys)) + "' data-export-selected=\"false\"" + url + ">" + Language.Phrase("ExportToEmail") + "</button>";
