...
public partial class JUN26 {
    ...
    /// calendar2Edit
    /// </summary>
    public static Calendar2Edit calendar2Edit
    {
        get => HttpData.Get<Calendar2Edit>("calendar2Edit")!;
        set => HttpData["calendar2Edit"] = value;
    }

    /// <summary>
    /// Page class for Calendar2
    /// </summary>
    public class Calendar2Edit : Calendar2EditBase
    {
        // Constructor
        public Calendar2Edit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public Calendar2Edit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class Calendar2EditBase : Calendar2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "calendar2Edit";
        ...
        // Page name
        public string PageName => "Calendar2Edit";
        ...
        // Constructor
        public Calendar2EditBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        switch (CurrentAction) {
                case "show": // Get a record to display
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("Calendar2List"); // No matching record, return to list
                        }
                    break;
        ...
        protected async Task<JsonBoolResult> EditRow() { // DN
            ...
            // Notes
            Notes.SetDbValue(rsnew, Notes.CurrentValue, Notes.ReadOnly);
